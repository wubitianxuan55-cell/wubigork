...
// colorText / colorTextSecondary / colorPrimary / colorSuccess / colorWarning
...
const nightRoseL = (): Partial<ThemeTokens> => ({ surface:'#fff5f6',surfaceDim:'#fde8ec',surfaceBright:'#fff5f6',surfaceContainer:'#fbf0f2',surfaceContainerHigh:'#f5e4e8',surfaceContainerHighest:'#eed8de',surfaceVariant:'#f0e0e4',colorPrimary:'#be123c',onPrimary:'#fff',primaryContainer:'#ffe4e6',onPrimaryContainer:'#5c1024',onSurface:'#1f1215',onSurfaceVariant:'#5c3a40',colorText:'#1f1215',colorTextSecondary:'#5c3a40',outline:'rgba(225,29,72,0.25)',outlineVariant:'rgba(225,29,72,0.10)',colorBorder:'rgba(0,0,0,0.06)',colorSuccess:'#047857',colorWarning:'#92400e',colorBgContainer:'#fff',colorBgLayout:'#fff5f6',accentRgb:'190,18,60',glow:'#be123c',glassBg:'rgba(255,255,255,0.55)',auroraBg:'radial-gradient(1100px 700px at 12% -5%, rgba(251,113,133,0.16), transparent 60%), radial-gradient(900px 600px at 88% 110%, rgba(225,29,72,0.10), transparent 55%), linear-gradient(160deg, #fff5f6 0%, #fdeef0 50%, #fffafa 100%)',...lS })
const nightAmberL = (): Partial<ThemeTokens> => ({ surface:'#fffdf5',surfaceDim:'#fef3e0',surfaceBright:'#fffdf5',surfaceContainer:'#faf5e8',surfaceContainerHigh:'#f2e8d4',surfaceContainerHighest:'#e8dcc0',surfaceVariant:'#eedcc0',colorPrimary:'#b45309',onPrimary:'#fff',primaryContainer:'#fef3c7',onPrimaryContainer:'#5c3800',onSurface:'#1c1810',onSurfaceVariant:'#5c4c30',colorText:'#1c1810',colorTextSecondary:'#5c4c30',outline:'rgba(217,119,6,0.25)',outlineVariant:'rgba(217,119,6,0.10)',colorBorder:'rgba(0,0,0,0.06)',colorSuccess:'#047857',colorWarning:'#92400e',colorBgContainer:'#fff',colorBgLayout:'#fffdf5',accentRgb:'180,83,9',glow:'#b45309',glassBg:'rgba(255,255,255,0.55)',auroraBg:'radial-gradient(1100px 700px at 12% -5%, rgba(245,158,11,0.16), transparent 60%), radial-gradient(900px 600px at 88% 110%, rgba(217,119,6,0.10), transparent 55%), linear-gradient(160deg, #fffdf5 0%, #fcf6e3 50%, #fffffa 100%)',...lS })
const nightMossL = (): Partial<ThemeTokens> => ({ surface:'#f5fdf7',surfaceDim:'#ddf2e2',surfaceBright:'#f5fdf7',surfaceContainer:'#ebf8ef',surfaceContainerHigh:'#ddf2e4',surfaceContainerHighest:'#cde8d6',surfaceVariant:'#d8eadc',colorPrimary:'#4d7c0f',onPrimary:'#fff',primaryContainer:'#ecfccb',onPrimaryContainer:'#1a2e05',onSurface:'#101a15',onSurfaceVariant:'#3a4c3c',colorText:'#101a15',colorTextSecondary:'#3a4c3c',outline:'rgba(77,124,15,0.25)',outlineVariant:'rgba(77,124,15,0.10)',colorBorder:'rgba(0,0,0,0.06)',colorSuccess:'#4d7c0f',colorWarning:'#92400e',colorBgContainer:'#fff',colorBgLayout:'#f5fdf7',accentRgb:'77,124,15',glow:'#4d7c0f',glassBg:'rgba(255,255,255,0.55)',auroraBg:'radial-gradient(1100px 700px at 12% -5%, rgba(132,204,22,0.16), transparent 60%), radial-gradient(900px 600px at 88% 110%, rgba(77,124,15,0.10), transparent 55%), linear-gradient(160deg, #f5fdf7 0%, #ecf9ee 50%, #fbfefb 100%)',...lS })
const nightSlateL = (): Partial<ThemeTokens> => ({ surface:'#f8fafc',surfaceDim:'#e2e8f0',surfaceBright:'#f8fafc',surfaceContainer:'#f1f5f9',surfaceContainerHigh:'#e6ecf2',surfaceContainerHighest:'#d9e2ea',surfaceVariant:'#e0e6ec',colorPrimary:'#475569',onPrimary:'#fff',primaryContainer:'#e2e8f0',onPrimaryContainer:'#1e293b',onSurface:'#0f172a',onSurfaceVariant:'#475569',colorText:'#0f172a',colorTextSecondary:'#475569',outline:'rgba(71,85,105,0.25)',outlineVariant:'rgba(71,85,105,0.10)',colorBorder:'rgba(0,0,0,0.06)',colorSuccess:'#047857',colorWarning:'#92400e',colorBgContainer:'#fff',colorBgLayout:'#f8fafc',accentRgb:'71,85,105',glow:'#475569',glassBg:'rgba(255,255,255,0.55)',auroraBg:'radial-gradient(1100px 700px at 12% -5%, rgba(148,163,184,0.18), transparent 60%), radial-gradient(900px 600px at 88% 110%, rgba(100,116,139,0.12), transparent 55%), linear-gradient(160deg, #f8fafc 0%, #eef2f6 50%, #fcfdfe 100%)',...lS })
