...
import { AlertCircle, BarChart3, Check, ChevronDown, FileText, LineChart, Loader2, MessageSquare, PieChart, RefreshCw, Wand2, X } from "../icons";
...
import type { XlsxCell, XlsxChartResult, XlsxPlanResult, XlsxPreview } from "../lib/types";
// 瘦身 P3 拆分（v4.170 先例）：纯工具/常量 → xlsxpreview/numFmt，
// 公式栏/表格网格（行虚拟滚动）/SVG 迷你图 → xlsxpreview/ 子组件，行为逐位等价。
import { colToLetter, EDIT_PRESETS } from "./xlsxpreview/numFmt";
import { FormulaBar } from "./xlsxpreview/FormulaBar";
import { SheetGrid } from "./xlsxpreview/SheetGrid";
import { MiniChart } from "./xlsxpreview/MiniChart";
