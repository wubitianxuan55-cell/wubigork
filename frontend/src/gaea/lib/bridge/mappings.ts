...
export const gaeaToGaea = {
  ...
  // v4.377 建议制：待确认建议忽略 + 自动做梦直写清污。
  DismissMemorySuggestion: "GaeaDismissMemorySuggestion",
  DreamPurgePreview: "GaeaDreamPurgePreview",
  DreamPurge: "GaeaDreamPurge",
  ...
  DagNodeApprove: "GaeaDagNodeApprove",
