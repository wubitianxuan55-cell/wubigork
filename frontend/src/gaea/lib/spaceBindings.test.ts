...
// 批次记录：7.3-1 任务收件箱 +4（GaeaTaskInboxList/Save/SetStatus/Delete，双空间
// 首页挂点+四入口接线，shared——隔离由 space 参数承担）→ 数量锁 517。
