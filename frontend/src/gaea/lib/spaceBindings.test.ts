...
// 批次记录：平台质量评审 +2（NovelReviewPlatforms/NovelChapterReview，v4.282 oh-story 蒸馏 T1，
// NovelB 门面，play 数据面）→ 数量锁 472。
