...
export const zh: Record<DictKey, string> = {
  ...
  "shell.launcher.statResource": "资源占用",
  "shell.launcher.statResourceValue": "CPU {cpu}",
  "shell.launcher.statResourceSub": "内存 {mem}% · GPU {gpu}%",
  ...
  "shell.launcher.voiceOrb": "语音晶核 · {persona}",
  ...
  "shell.launcher.sysMeta": "内存 {mem}% · GPU {gpu}%",
  "shell.launcher.sysComfy": " · ComfyUI 运行中",
  ...
  "shell.launcher.homeTitle": "你的 AI 助手，工作与灵感一室之隔",
  "shell.launcher.homeSub": "左边专心干活，右边自在放空；中间随时开口，gaea 都在。",
  "shell.launcher.studyHint": "办公 · 造价 · 记忆",
  "shell.launcher.gardenHint": "轻语 · 小说 · 绘梦",
  "shell.launcher.noModules": "暂无可用模块",
  "shell.launcher.progEntry": "打开 {name}（独立窗口）",
  "shell.launcher.openSettings": "打开设置",
  "shell.launcher.settings": "设置",
  "shell.launcher.settingsDesc": "应用偏好与主题外观",
  "shell.launcher.courtyardPlaceholder": "对 gaea 说点什么，或按住麦克风…",
  "shell.launcher.courtyardSend": "发送",
  "shell.launcher.voiceKernel": "AI 内核 · {state}",
  "shell.launcher.localModel": "本地模型",
  "shell.launcher.voiceStartTip": "启动麦克风，开始语音交互",
  ...
  "home.title": "从灵光乍现，到星河成篇",
  "home.sub": "本地优先的多功能 AI 平台：写作、绘图、办公、编程、记忆 —— 一座驾驶舱，全部抵达。",
  "home.placeholder": "对 gaea 说点什么，或直达下方能力…",
  "home.cmdk": "全局搜索",
  "home.suggestNovel": "写一章小说",
  "home.suggestImage": "生成插画",
  "home.suggestChat": "和 gaea 聊聊",
  "home.suggestCode": "开始编程",
  "home.capTitle": "能力矩阵",
  "home.capSub": "一座驾驶舱，抵达你的全部创作",
  "home.featured": "旗舰工作台",
