...
export const zh: Record<DictKey, string> = {
  ...
  "shell.hero.work.eyebrow": "GAEA 工位已就绪 · 本地 AI 办公中枢",
  "shell.hero.work.title": "把活儿交给我，我来干",
  "shell.hero.work.sub": "工位 = 任务工作台：办公、造价、记忆，都在一个工作台里。",
  ...
  "shell.hero.work.section": "工位模块",
  "shell.hero.work.sectionHint": "办公 / 造价 / 记忆 / 编程",
  "shell.hero.play.eyebrow": "GAEA 乐园已就绪 · 本地 AI 创作乐园",
  "shell.hero.play.title": "从灵光乍现，到星河成篇",
  "shell.hero.play.sub": "乐园 = 会客厅与创作间：轻语、小说、绘梦，沉浸不打扰。",
