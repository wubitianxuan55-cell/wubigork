...
export const en = {
  ...
  "shell.launcher.homeTitle": "Your AI assistant — work and inspiration, one wall apart",
  "shell.launcher.homeSub": "Focus on the left, unwind on the right; speak up anytime, gaea is here.",
  "shell.launcher.studyHint": "Office · Cost · Memory",
  "shell.launcher.gardenHint": "Companion · Novel · Imagegen",
  ...
  "home.title": "From a flash of insight, to a galaxy of stories",
  "home.sub": "A local-first, all-in-one AI platform: writing, art, office, coding, memory — one cockpit, everything within reach.",
  "home.placeholder": "Say something to gaea, or jump straight to a capability…",
  "home.cmdk": "Global search",
  "home.suggestNovel": "Write a chapter",
  "home.suggestImage": "Generate art",
  "home.suggestChat": "Chat with gaea",
  "home.suggestCode": "Start coding",
  "home.capTitle": "Capability Matrix",
  "home.capSub": "One cockpit, all your creation within reach",
