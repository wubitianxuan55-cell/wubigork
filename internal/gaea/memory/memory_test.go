...
func TestComposeAppendsAfterBase(t *testing.T) {
	base := "BASE PROMPT"
	set := &Set{Docs: []Source{{Path: "/p/TIANXUAN.md", Scope: ScopeProject, Body: "Use tabs."}}}
	got := Compose(base, set)
...
func TestDiscoverPrecedenceOrder(t *testing.T) {
	...
	mustWrite(t, filepath.Join(user, "TIANXUAN.md"), "USER LEVEL")
	mustWrite(t, filepath.Join(proj, "TIANXUAN.md"), "PROJECT LEVEL")
	mustWrite(t, filepath.Join(proj, "TIANXUAN.local.md"), "LOCAL LEVEL")
...
func TestImportResolution(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "TIANXUAN.md"), "Top line\n@shared.md\nBottom line")
...
func TestImportCycleDoesNotHang(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "TIANXUAN.md"), "@a.md")
