// Package memory implements gaea's persistent memory. It mirrors Claude
// Code's two-layer model while honoring gaea's cache-first architecture:
//
...
const (
	ScopeUser     Scope = "user"     // ~/.config/gaea/TIANXUAN.md
