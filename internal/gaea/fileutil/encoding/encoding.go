...
// UTF-8) keeps CJK Windows files editable without silently mangling their bytes.
// Ported from Reasonix V1.15 (MIT).
package encoding
...
// suitable for wrapping an io.Reader via transform.NewReader. Returns nil for
// UTF-8 and LossyUTF8 (no transformation needed).
