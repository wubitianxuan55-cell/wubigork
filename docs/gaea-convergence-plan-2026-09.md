...
| 项 | 选项 | 建议 |
|---|---|---|
| 性质路线 | A=终极个人工具 / B=个人工具→产品 | **A 为主、B 为期权**：所有决策按自用标准，每季度清一项产品化门槛 |
| LICENSE | MIT（保留开源期权）/ 私有 All Rights Reserved | 若倾向未来开源核心（进度/造价引擎），MIT；纯自用则私有 |
...
3. **个人路径清洗**：`D:\博耐特工作250606\...` 类路径移出设计文档，样例说明改指
   fixtures/占位。
