...
> 状态：**已随 v3.8.0 落地收官**（S1.1 空间维度：`5c24d16`/`0722aeb`/`76f565e`/`5c9fc4e`，
> 见 `releases/v3.8.0.md`）。本文件由「实现权威」转为已收官历史设计；双空间现行口径以
> `docs/gaea-nextgen-roadmap-2026.md` 与现行代码为准。因前后端代码注释仍多处引用本文件
> 为设计出处（docs/README.md「活跃设计」在列），留 docs/ 原位未移入 archive/。
