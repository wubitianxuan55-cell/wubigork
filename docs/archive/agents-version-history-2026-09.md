...
> 迁入记录：2026-09-09 首迁（v4.49.0 及更早的旧「版本状态（历史存档）」段）；2026-09-10 二迁（v4.173.0–v4.146.0）——因 `.gaea/AGENTS.md` 曾达 104 KB 超工作区指令预算（65536 B），其版本段只留最近 14 版速览，尾部纪律/规划段一度被截断不可见；2026-09-12 三迁（v4.226.0–v4.222.0，速览水位 58000 B 触顶，恢复「只留最近 14 版」口径）；2026-09-12 四迁（v4.232.0–v4.227.0，v4.246 发布后水位 58156 B 再触 WARN 线）。2026-09-12 五迁（v4.244.0–v4.236.0，v4.254 发布后水位 58126 B 触 WARN 线，恢复 14 版）；2026-09-12 六迁（v4.233.0，v4.255 发布后恢复 14 版水位）；2026-09-12 七迁（v4.235.0–v4.234.0，v4.260 发布后 sin 线四长目入档致水位触 WARN，恢复预算内）；2026-09-13 八迁（v4.261.0–v4.255.0 六条，v4.274 发布后水位 59926 B 触 WARN，恢复 14 版）；2026-09-13 九迁（v4.266.0–v4.265.0 两条，v4.276 发布后恢复 14 版口径）；2026-09-13 十迁（v4.267.0，v4.278 发布后恢复 14 版口径）；2026-09-13 十一迁（v4.268.0，v4.279 发布后恢复 14 版口径）；2026-09-13 十二迁（v4.269.0，v4.280 发布后恢复 14 版口径）；2026-09-13 十三迁（v4.271.0，v4.281 发布后恢复 14 版口径）；2026-09-13 十四迁（v4.272.0，v4.282 发布后恢复 14 版口径）。；2026-09-14 十五迁（v4.279.0~v4.273.0 五条，v4.293 发布后恢复 14 版口径并补齐 v4.291/v4.292 漏登两条）；2026-09-14 十六迁（v4.283.0~v4.280.0 四条，v4.297 发布后恢复 14 版口径）；2026-09-14 十七迁（v4.284.0，v4.298 发布后恢复 14 版口径）；2026-09-14 十八迁（v4.285.0，v4.299 发布后恢复 14 版口径）；2026-09-14 十九迁（v4.286.0，v4.300 发布后恢复 14 版口径）；2026-09-14 二十迁（v4.287.0，v4.301 发布后恢复 14 版口径）；2026-09-15 二十一迁（v4.288.0，v4.302 发布后恢复 14 版口径）；2026-09-15 二十二迁（v4.289.0，v4.303 发布后恢复 14 版口径）；2026-09-15 二十三迁（v4.290.0，v4.304 发布后恢复 14 版口径）；2026-09-15 二十四迁（v4.291.0，v4.305 发布后恢复 14 版口径）；2026-09-15 二十五迁（v4.292.0，v4.306 发布后恢复 14 版口径）；2026-09-15 二十六迁（v4.293.0，v4.307 发布后恢复 14 版口径）；2026-09-15 二十七迁（v4.309.0，v4.312 发布后按 3 版口径迁入）；2026-09-15 二十八迁（v4.310.0，v4.313 发布后按 3 版口径迁入）；2026-09-15 二十九迁（v4.311.0，v4.314 发布后按 3 版口径迁入）；2026-09-15 三十迁（v4.312.0，v4.315 发布后按 3 版口径迁入）；2026-09-15 三十一迁（v4.313.0，v4.316 发布后按 3 版口径迁入）；2026-09-15 三十二迁（v4.314.0，v4.317 发布后按 3 版口径迁入）；2026-09-16 三十三迁（v4.315.0，v4.318 发布后按 3 版口径迁入）；2026-09-16 三十四迁（v4.316.0，v4.319 发布后按 3 版口径迁入）；2026-09-16 三十五迁（v4.317.0，v4.320 发布后按 3 版口径迁入）；2026-09-16 三十六迁（v4.318.0，v4.321 发布后按 3 版口径迁入）；2026-09-16 三十七迁（v4.319.0，v4.322 发布后按 3 版口径迁入）；2026-09-16 三十八迁（v4.320.0，v4.323 发布后迁入，案行漏记此处补记）；2026-09-16 三十九迁（v4.321.0，v4.324 发布后按 3 版口径迁入）；2026-09-16 四十迁（v4.322.0，v4.325 发布后按 3 版口径迁入）；2026-09-16 四十一迁（v4.323.0，v4.326 发布后按 3 版口径迁入）；2026-09-17 四十二迁（v4.324.0，v4.327 发布后按 3 版口径迁入）；2026-09-17 四十三迁（v4.325.0，v4.328 发布后按 3 版口径迁入）；2026-09-17 四十四迁（v4.326.0，v4.329 发布后按 3 版口径迁入）；2026-09-17 四十五迁（v4.327.0，v4.330 发布后按 3 版口径迁入）；2026-09-17 四十六迁（v4.328.0，v4.331 发布后按 3 版口径迁入）；2026-09-17 四十七迁（v4.329.0，v4.332 发布后按 3 版口径迁入）；2026-09-17 四十八迁（v4.330.0，v4.333 发布后按 3 版口径迁入）；2026-09-17 四十九迁（v4.331.0，v4.334 发布后按 3 版口径迁入）；2026-09-17 五十迁（v4.332.0，v4.335 发布后按 3 版口径迁入）；2026-09-18 五十一迁（v4.333.0，v4.336 发布后按 3 版口径迁入）；2026-09-18 五十二迁（v4.334.0，v4.337 发布后按 3 版口径迁入）；2026-09-19 五十三迁（v4.335.0，v4.338 发布后按 3 版口径迁入）；2026-09-19 五十四迁（v4.336.0，v4.339 发布后按 3 版口径迁入）；2026-09-19 五十五迁（v4.337.0，v4.340 发布后按 3 版口径迁入）；2026-09-19 五十六迁（v4.338.0，v4.341 发布后按 3 版口径迁入）；2026-09-19 五十七迁（v4.339.0，v4.342 发布后按 3 版口径迁入）；2026-09-19 五十八迁（v4.340.0，v4.343 发布后按 3 版口径迁入）；2026-09-19 五十九迁（v4.341.0，v4.344 发布后按 3 版口径迁入）；2026-09-19 六十迁（v4.342.0，v4.345 发布后按 3 版口径迁入）；2026-09-19 六十一迁（v4.343.0，v4.346 发布后按 3 版口径迁入）；2026-09-19 六十二迁（v4.344.0，v4.347 发布后按 3 版口径迁入）。；2026-09-19 六十三迁（v4.345.0，v4.348 发布后按 3 版口径迁入）；2026-09-19 六十四迁（v4.346.0，v4.349 发布后按 3 版口径迁入）；2026-09-19 六十五迁（v4.347.0，v4.350 发布后按 3 版口径迁入）；2026-09-19 六十六迁（v4.348.0，v4.351 发布后按 3 版口径迁入）；2026-09-19 六十七迁（v4.349.0，v4.352 发布后按 3 版口径迁入）；2026-09-19 六十八迁（v4.350.0，v4.353 发布后按 3 版口径迁入）；2026-09-19 六十九迁（v4.351.0，v4.354 发布后按 3 版口径迁入）；2026-09-19 七十迁（v4.352.0，v4.355 发布后按 3 版口径迁入）；2026-09-19 七十一迁（v4.353.0，v4.356 发布后按 3 版口径迁入）；2026-09-20 七十二迁（v4.354.0，v4.357 发布后按 3 版口径迁入，案行漏记此处补记）；2026-09-20 七十三迁（v4.355.0，v4.358 发布后按 3 版口径迁入）；2026-09-20 七十四迁（v4.356.0，v4.359 发布后按 3 版口径迁入）；2026-09-20 七十五迁（v4.357.0，v4.360 发布后按 3 版口径迁入）；2026-09-20 七十六迁（v4.358.0，v4.361 发布后按 3 版口径迁入）；2026-09-21 七十七迁（v4.359.0，v4.362 发布后按 3 版口径迁入）；2026-09-21 七十八迁（v4.360.0，v4.363 发布后按 3 版口径迁入）；2026-09-21 七十九迁（v4.361.0，v4.364 发布后按 3 版口径迁入）；2026-09-21 八十迁（v4.362.0，v4.365 发布后按 3 版口径迁入）；2026-09-21 八十一迁（v4.363.0，v4.366 发布后按 3 版口径迁入）；2026-09-21 八十二迁（v4.364.0，v4.367 发布后按 3 版口径迁入）；2026-09-21 八十三迁（v4.365.0，v4.368 发布后按 3 版口径迁入）；2026-09-21 八十四迁（v4.366.0，v4.369 发布后按 3 版口径迁入）；2026-09-21 八十五迁（v4.367.0，v4.370 发布后按 3 版口径迁入）；2026-09-21 八十六迁（v4.368.0，v4.371 发布后按 3 版口径迁入）；2026-09-21 八十七迁（v4.369.0，v4.372 发布后按 3 版口径迁入）；2026-09-21 八十八迁（v4.370.0，v4.373 发布后按 3 版口径迁入）；2026-09-21 八十九迁（v4.371.0，v4.374 发布后按 3 版口径迁入）；2026-09-21 九十迁（v4.372.0，v4.375 发布后按 3 版口径迁入）；2026-09-21 九十一迁（v4.373.0，v4.376 发布后按 3 版口径迁入）；2026-09-21 九十二迁（v4.374.0，v4.377 发布后按 3 版口径迁入，案行漏记此处补记）；2026-09-21 九十三迁（v4.375.0，v4.378 发布后按 3 版口径迁入）；2026-09-21 九十四迁（v4.376.0，v4.379 发布后按 3 版口径迁入）；2026-09-22 九十五迁（v4.377.0，v4.380 发布后按 3 版口径迁入）；2026-09-22 九十六迁（v4.378.0，v4.381 发布后按 3 版口径迁入）；2026-09-22 九十七迁（v4.379.0，v4.382 发布后按 3 版口径迁入）；2026-09-22 九十八迁（v4.380.0，v4.383 发布后按 3 版口径迁入）；2026-09-22 九十九迁（v4.381.0，v4.384 发布后按 3 版口径迁入）；2026-09-22 一百迁（v4.382.0，v4.385 发布后按 3 版口径迁入）；2026-09-22 一百零一迁（v4.383.0，v4.386 发布后按 3 版口径迁入）；2026-09-22 一百零二迁（v4.384.0，v4.387 发布后按 3 版口径迁入）；2026-09-22 一百零三迁（v4.385.0，v4.388 发布后按 3 版口径迁入）；2026-09-22 一百零四迁（v4.386.0，v4.389 发布后按 3 版口径迁入）；2026-09-23 案行补记（一百零五~一百一十五迁：v4.387.0~v4.395.0，v4.390~v4.400 发布后按 3 版口径迁入，头部记录行漏登）；2026-09-23 一百一十六迁（v4.396.0，v4.401 发布后按 3 版口径迁入）；2026-09-23 一百一十七迁（v4.397.0，v4.402 发布后按 3 版口径迁入）；2026-09-23 一百一十八迁（v4.398.0，v4.403 发布后按 3 版口径迁入）；2026-09-23 一百一十九迁（v4.399.0，v4.404 发布后按 3 版口径迁入）；2026-09-23 一百二十迁（v4.400.0，v4.404.1 发布后按 3 版口径迁入）；2026-09-23 一百二十一迁（v4.401.0，v4.405 发布后按 3 版口径迁入）；2026-09-23 一百二十二迁（v4.402.0，v4.405.1 发布后按 3 版口径迁入）；2026-09-23 一百二十三迁（v4.403.0，v4.406 发布后按 3 版口径迁入）；2026-09-24 一百二十四迁（v4.404.0，v4.407 发布后按 3 版口径迁入）；2026-09-25 一百二十五迁（v4.404.1，v4.408 发布后按 3 版口径迁入）；2026-09-25 一百二十六迁（v4.405.0，v4.409 发布后按 3 版口径迁入）；2026-09-25 一百二十七迁（v4.405.1，v4.410 发布后按 3 版口径迁入）；2026-09-25 一百二十八迁（v4.406.0，v4.411 发布后按 3 版口径迁入）；2026-09-25 一百二十九迁（v4.407.0，v4.412 发布后按 3 版口径迁入）；2026-09-26 头部补记（一百三十~一百三十二迁：v4.408.0/v4.409.0/v4.410.0，v4.413~v4.414.1 发布后迁入，条目已在案头部流水漏登）；2026-09-26 一百三十三迁（v4.411.0，v4.415 发布后按现势 5 版口径迁入）；2026-09-26 一百三十四迁（v4.412.0，v4.416 发布后按现势 5 版口径迁入）；2026-09-26 一百三十五迁（v4.413.0，v4.417 发布后按现势 5 版口径迁入）；2026-09-26 一百三十六迁（v4.414.0，v4.418 发布后按现势 5 版口径迁入）；2026-09-26 一百三十七迁（v4.414.1，v4.419 发布后按现势 5 版口径迁入）
...
- **最新发布：v4.414.1（2026-09-26）「桌面 Send 斜杠派发根修 + GaeaNewSession 诚实报错（真机走查实录）」**——v4.414 plan-mode 真机走查拽出双缺陷根修（v4.405.1 先例）。绑定面 720 零变更。**根修一（长期缺口）**：桌面 Send 绕过全部斜杠动词——桥接 Submit→GaeaSend→Controller.Send 而动词面（/plan /compact /dream /memories /goal /perm /distill /new+#快记+/mcp__+自定义命令+unknown）只活在 Controller.Submit；桌面打任何斜杠动词都被当文本发给模型。根修=dispatchSlash 抽出共用，两路对齐。**根修二**：GaeaNewSession 引擎未初始化静默 no-op（假成功）→诚实报错（走查回合曾因此全落用户旧会话酿污染事故，已根治复原=离线手术按 RewindLog 同口径+重启验证 39 条零走查痕迹+四源备份；教训=走查会话隔离必须落盘双确认）。**plan-mode 实弹全通**：/plan 派发 Notice 上 wire→只读研究→真调 exit_plan_mode→ask 计划审批→批准→叙事落历史→status=关，console 0。**观察池**=审批卡路由漂移下未可视确认/pre-turn 动词 Notice 不可见。**测试**=TestSendDispatchesSlashVerbs+control 回归；全量 ci 绿。**产物**=见 SHA256SUMS-v4.414.1.txt（冒烟 200 过）；保留策略删 v4.410.0.exe。**文档**=releases/v4.414.1.md+CHANGELOG/README+releases/README（438→439+裁 v4.383）+AGENTS 迁 1 插 1（一百三十二迁：v4.410.0 入 archive）+progress/todos。
- **最新发布：v4.414.0（2026-09-26）「Plan mode 计划审批门（dsh plan-mode 蒸馏）」**——DSH 留池⑦（实质头名，①子代理控制面等上游稳定）。蒸馏=取道不取器（471 行上游 → 内核 1 新文件+2 挂点+1 斜杠动词）。绑定面 720 零变更，前端零改动。**落地**：①exit_plan_mode 工具恒注册（目录跨模式切换稳定）：计划模式下 markdown 计划（# 标题强制）提交 ask 通道审批——批准=闸翻转 off+叙事落历史/继续计划=错误带回反馈/headless 无 Asker=诚实拒绝（执行闸必须人来开，不仿 ask 自选降级）②PlanGate 窄接口经 callContext 盖章（asker 同位同纪律）+SubagentMetaTools 排除子代理③/plan 斜杠动词（on 政策注入/off 退出叙事/status 回落，running 拒绝）④与上游两偏离：系统前缀冻结→政策走 user 消息注入；状态 v1 内存态（事件日志持久化+恢复折叠留二刀，最敏感面零碰）；沙箱/权限独立不做硬工具门。**测试**=Go plan_mode_test 六例+agent/control/boot 三包回归；全量 ci 绿。**门禁**=漂移闸 OK@4.414.0。**产物**=见 SHA256SUMS-v4.414.0.txt（冒烟 200 过）；保留策略删 v4.409.0.exe。**文档**=规格 进度计划/gaea-plan-mode-20260926.md+releases/v4.414.0.md+CHANGELOG/README+releases/README（437→438+裁 v4.382）+AGENTS 迁 1 插 1（一百三十一迁：v4.409.0 入 archive）+progress/todos（dsh 留池⑦清账）。
- **最新发布：v4.413.0（2026-09-26）「良性取消日志降级（前端错误观测通道降噪）」**——观察池项落地（v4.412 真机走查收官新挂：取消路径被全局前端错误钩记 ERROR 级）。Go 1 文件+1 测试，绑定面 720 零变更。**落地**：GaeaLogFrontendError 对 message 含 `context canceled`（取消钮链路经桥接统一入口上报的公共叶子）降级 slog.Info，其余照旧 slog.Error——UI 侧 v4.408 起已语义化 info，审计痕迹保留（INFO 在册）；剧照/设定卡/绘梦三条取消链路同时降噪；前端零改动（proxy.ts invoke 语义不变）。**测试**=Go TestGaeaLogFrontendError_CancelDowngrade（slog 捕获两例）；全量 ci 绿。**门禁**=漂移闸 OK@4.413.0。**产物**=见 SHA256SUMS-v4.413.0.txt（冒烟 200 过）；保留策略删 v4.408.0.exe。**文档**=releases/v4.413.0.md+CHANGELOG/README+releases/README（436→437+裁 v4.381）+AGENTS 迁 1 插 1（一百三十迁：v4.408.0 入 archive）+progress/todos+slim-masterplan §3 冷启动基线补采。
- **最新发布：v4.412.0（2026-09-25）「上下文标签页 UI 优化 + 原罪板块复用轨迹/上下文页签」**——用户两刀合一版。绑定面 717→720（sin 看板三只读口 SinTrajectory/SinContextView/SinContextNodeDetail，均 play），spaceBindings 锁 540→543。**落地**：①刀1 上下文页 UI 优化（功能零删减）：hero「当前上下文」行3→行1（进页即答「用了多少」，与空态头部一致）、趋势行2、三仪表行3、浏览器+事件行4、文件+Agent 网络行5（皆在时并排）、8 统计小卡（审计口径）下移行6；window=0 时 hero/汇总条百分比诚实「—」（i18n contextview.windowUnknown 三份）不伪造 0%；趋势柱 hover 可感知（delta 描边/堆叠提亮）②刀2：sin_insight.go 折叠落库消息+extra（reasoning/tools/illustrations）→与办公同构 Trajectory/ContextTimeline——轨迹 user 起轮+工具按 extra 还原在回复前+同秒耗时诚实 0；上下文逐请求累计（每轮=system+角色卡/底稿注入+截至该轮全部落库，对齐 buildSinUserPrompt 全量前情）+delta 逐类 signed+brief 锚点接浏览器+timing 工具排行；节点编址=消息 ID×10+槽位（0/1..8/9，system/注入=1/2/3 不可展开与办公同口径）；组件接缝=TrajectoryView.fetchTrajectory、ContextView.fetchNodeDetail/spaceOverride/showAgentNetwork（原罪关 Agent 网络防串台）、ChatTabs.tabs/labelOverrides（原罪主签「故事」）/className；dev mock 同规则折叠。**测试**=Go sin_insight 四例+前端 ChatTabs 两例+ContextView 五例+OriginalSinPage.tabs 四例；cards 钉旧「0 / 0 · 0%」按行为变更重写钉「0 / 0 · —」；全量 ci 绿。**坑**=①gen_bindings 重生成噪音（GetSinImageConfig ImageB→CoreB 挪窝+cost 手工格式压平）按 HEAD 还原只留 sin 增量②chat.store 秒级时间戳同秒→轮耗时诚实 0，测试勿断言恒 >0③新绑定三处同步（Go 门面/bindingNames.ts/GAEA_METHOD_FACETS+计数锁）。**产物**=见 SHA256SUMS-v4.412.0.txt（冒烟 200 过）；保留策略删 v4.407.0.exe。**文档**=releases/v4.412.0.md+CHANGELOG/README+releases/README（435→436+裁 v4.380）+AGENTS 迁 1 插 1（一百二十九迁：v4.407.0 入 archive）+progress/todos。
- **最新发布：v4.411.0（2026-09-25）「一致性评分写回元数据」**——编辑器评分历史池①（「继续」按 v4.359 先例推进挂池项）。绑定面 717 零变更，characterlib 迁移补 reference_scores 列。**落地**：①characters 表 reference_scores（JSON []int 与 referenceImages 索引对齐，0=未评分）幂等迁移；读写两路同索引维护——读侧 capImageList 剔超限时 capScores 按保留下标映射分数，越界补 0②编辑器评分成功写 form.referenceScores（保存时持久化），参考图缩略图分数徽标（≥80 绿/60-79 橙/<60 红），移除同下标裁剪③sin 追加参考图短分数表读侧补 0 不破坏对齐。**测试**=Go 往返/超限对齐/短分数表三例+前端徽标/持久化/移除对齐（35 例）；全量 ci 绿。**坑**=capScores 首版误取前 N 截断（对齐须保留下标驱动，测试当场抓）；超大 data URL 写侧落盘失败回退原值、读侧 cap 才剔——对齐须写读两路都验；wails models.ts 生成件手工同步防漂移。**产物**=exe 51303424B SHA256=5020b3762adcf12c979597484eaec2d15840dc07d6e57c143ea01f609d55dff6（SUMS-v4.411.0.txt；冒烟 200 过；桌面副本同哈希）；保留策略删 v4.406.0.exe。**文档**=releases/v4.411.0.md+CHANGELOG/README+releases/README（434→435+裁 v4.379）+AGENTS 迁 1 插 1（一百二十八迁：v4.406.0 入 archive）+progress/todos（评分历史池①清账）。
- **最新发布：v4.386.0（2026-09-22）「造价库分页绑定：成本条目列表/表格分页 + 检索下拉载荷降载」**——前端性能池⑥余项收口（聊天历史分页 v4.371 已落、造价库全表留池至今）：成本库「成本条目」每次搜索全表拉回全量渲染，用户真实库 1553 条时每次防抖击键=全量桥载荷+1553 行 DOM。Go 3 文件+前端 10 文件，绑定面 711→712（+1）。**三件**=①**GaeaCostSearchPage 分页绑定**（App 层实现，cost.Store 零改动）：检索管线（SQL→Go 关键词过滤→语义召回→精排）提为 costSearchAll 助手两绑定共用（分页与非分页口径一致，工具面 cost_search 零影响）；排序进服务端 title/price/updatedAt（空=管线序）**tie-break 恒定 name**（全序=跨页不漂移前提）；limit 钳 [1,200]（≤0→100）、offset 负归零、Total=过滤后总数；未知 sortKey 不排序（防前端传错）②**CostLibraryView 分页改造**：首屏 100+「加载更多（余 N 条）」100/批，计数如实「已载 X / 共 Y 条」，分类树计数用 total；客户端排序删除（只排已载子集是错的）改服务端排序重拉第 1 页；过期响应按 reqSeq 丢弃+追加页跨页 name 去重（偏移漂移兜底）③**EntryPicker 切分页**（测算项目单价下拉只要 top8，此前全表拉回客户端截断）。loadStats 仍用全量（聚合需要，开页一次非热路径）。**测试**=Go +5（切片连续+total/全序 tie-break+降序镜像/钳制四态/零命中空页/未知键管线序/过滤×排序组合）+前端 +1（150 条分页补齐）+迁移断言（7 参形态/排序异步等待）。**门禁**=全量 ci 绿 EXIT=0+版本漂移闸 OK@4.386.0+spaceBindings 锁 534→535。**坑**=①**App 层检索类测试必须断死语义通道**——NewManager 种子目录 herdsman 恒 Enabled+localhost:8080，本机 embedding 服务在跑时零命中查询（SQL 召回<3 触发语义补召回）走**真实**管线：Stale 按测试条目集清真实库 cost 向量行+Ensure 写假向量（本轮实际发生，已用 GaeaSemanticIndexBackfill 全量重建 1553/1553=24s，测试侧 SaveEngine 禁 herdsman 断通道）；hubCostStore/hubSemanticStore override 只护住一半，引擎目录在测试环境是活的②App 嵌 *core——裸 &App{} 的 a.engineMgr 字段访问即 nil-core panic，测试须 &App{core:&core{…}}③分页排序必须全序（name 收尾），客户端排序在分页时代必须删除④updated_at 落盘 RFC3339 秒级——同测试连发保存回读全同秒，确定时间序用 SQL 直铺。**产物**=exe 见 SHA256SUMS-v4.386.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.381.exe。**文档**=性能池⑥销号回填+releases/v4.386.0.md（含升级说明）+CHANGELOG/README+releases/README（计数 407→408+34 席插 v4.386 裁 v4.352）+AGENTS 迁 1 插 1（一百零一迁：v4.383 入 archive）+progress/todos。
- **最新发布：v4.385.0（2026-09-22）「工程健康轮 #2：excelize 防线扩面 + 死代码清欠 + 双扫描报告」**——距 v4.370 工程健康轮已 15 版，按惯例复扫三面。Go 2 文件+前端 4 文件，绑定面 711 零变更。**扫描报告**=govulncheck 1 项在案（GO-2026-6452 excelize 负 shared-string 下标 panic，上游 Fixed in N/A）/pnpm audit 0/knip 1+3+3+5。**两刀**=①**excelize 防线扩面**：v4.370 只防了 xlsxpreview 入口，本轮符号追踪多出三条未防御可达面——schedule.ImportXlsx（GetRows）/GaeaXlsxRowOps（InsertRows/RemoveRow）/GaeaXlsxColOps（InsertCols/RemoveCol）——同 v4.370 配方 named-return+defer recover 转可读错误，panic 不再外溢②**knip 死代码清欠 4 项**（tsc+引用 grep 双验证）：useModelCenter（v4.352 拆分后兼容口零消费，stale 注释同步更新）+桥接死类型 3 个；重复导出/配置提示为既有 KEEP 不动。**测试**=app/schedule 全量绿+tsc 0+modelcenter 112 例绿。**门禁**=全量 ci 绿 EXIT=0+版本漂移闸 OK@4.385.0。**坑**=①「已防御」≠「全防御」——符号追踪随代码演化增长（v4.370 后新增的 xlsx 编辑/导入引入新可达面），扫描要周期性复跑②Fixed in N/A 常驻项——新增 excelize 消费面必须同步配 recover 入口③knip 未用导出区分死代码与契约哨兵。**产物**=exe 见 SHA256SUMS-v4.385.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.380.exe。**文档**=releases/v4.385.0.md（含升级说明）+CHANGELOG/README+releases/README（计数 406→407+34 席插 v4.385 裁 v4.351）+AGENTS 迁 1 插 1（一百迁：v4.382 入 archive）+progress/todos。

- **最新发布：v4.384.0（2026-09-22）「dsh 蒸馏第五弹：session_query 会话检索（跨会话记忆首刀）」**——dsh 留池⑧首刀落地（余 3）。全 Go，绑定面 711 零变更。**两件套**=①**索引器**（新包 internal/gaea/sessionquery）：索引面=装配空间会话目录 *.gaea-log.jsonl 中 user_message/assistant_message 正文（system/工具结果/流式 delta 噪声面不入索引）；增量按 (size,mtime) 新鲜度指纹（session_index_meta）搜索时惰性刷新零 boot 成本；重索引=DELETE 该文件旧行再全量插（FTS5 标准表普通 DELETE 可用）；空间隔离由目录构造（Store 绑装配空间会话目录，双空间红线同构）②**session_search 工具**（只读）：query 必填+limit 默认 8 上限 32，newest-first 带 session id/role/时间/snippet 高亮；中文降级=FTS5 unicode61 不切 CJK 子串，MATCH 零命中回退 LIKE 子串扫描+手工裁窗（whisper 先例）；MATCH 短语引号化。**测试**=Go +5（FTS 命中+噪声面排除+ts 倒序/CJK 降级/增量新鲜度/目录隔离/工具面）。**门禁**=go build/vet 0+gofmt（触碰文件）+全量 ci 绿+版本漂移闸 OK@4.384.0。**坑**=①ReadLogRepaired torn-tail 修复截断未换行收尾的最后一行——手工构造日志必须换行收尾（真实 LogWriter 恒换行收尾）②FTS5 标准表（非 contentless）才支持普通 DELETE③LIKE 路径 snippet 手工裁窗——两路径 Scan 形状不同共用 Scan 助手会静默拿空原文。**产物**=exe 见 SHA256SUMS-v4.384.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.379.exe。**文档**=dsh 蒸馏文档⑧首刀销号（余 3）+releases/v4.384.0.md（含升级说明）+CHANGELOG/README+releases/README（计数 405→406+34 席插 v4.384 裁 v4.350）+AGENTS 迁 1 插 1（九十九迁：v4.381 入 archive）+progress/todos。

- **最新发布：v4.383.0（2026-09-22）「聊天虚拟化第二层：绘制层 content-visibility + 挂池考古销号一批」**——v4.365 池②收口（两形态分层）+ 一批过时挂池条目考古销号（零代码）。前端 2 文件+测试 +2，绑定面 711 零变更。**刀1 绘制层虚拟化**：聊天长历史成本分两层——渲染层尾部窗口 v4.370/371 已落，本刀补绘制层：超阈值会话根节点挂 chat-flow-cv，行级 content-visibility:auto 离屏行跳过 layout/paint，窗口扩载到全量历史后深滚动依旧顺滑；contain-intrinsic-size:auto 120px 浏览器记住行实际高度，滚动条估算与滚动锚定不受影响；≤阈值不挂类零影响；流式吸底不受影响（流式行恒在屏内）；菜单走 antd portal 不受 containment 影响；为什么不是 react-window（v4.370 侦察否决有案）=JS 窗口化与滚动宿主/动态行高/流式吸底三冲突，CSS 原生方案零结构改动兑现同目标。**挂池考古销号（零代码）**=v4.355②file:// 头像（v4.361 已清账）/v4.355③longtask 阈值（v4.361 已提 200ms）/v4.349⑤initRuntimePolyfill 同步成本（辨伪≈0）+vendor manualChunks（无新证据）。**测试**=前端 +2（类挂载即完整契约）；全量 vitest 389 文件 3322 例绿+tsc 0。**门禁**=全量 ci 绿 EXIT=0+版本漂移闸 OK@4.383.0。**坑**=①content-visibility 的行内 fixed/portal 子元素语义要先查——containment 裁剪 fixed 后代，聊天行菜单 portal 到 body 不受影响，novel selbar 不在作用面②「真虚拟化」不等于 react-window——三冲突场景下渲染层窗口+绘制层 CV 分层零结构风险达成同目标，池条目按目标销号不按实现手段。**产物**=exe 见 SHA256SUMS-v4.383.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.378.exe。**文档**=池②收口+三条考古销号回填+releases/v4.383.0.md（含升级说明）+CHANGELOG/README+releases/README（计数 404→405+34 席插 v4.383 裁 v4.349）+AGENTS 迁 1 插 1（九十八迁：v4.380 入 archive）+progress/todos。

- **最新发布：v4.382.0（2026-09-22）「前端挂池清欠：整店订阅清零 + 交付物缓存失效接线」**——两个小欠账一并清偿。前端 4 文件+测试，绑定面 711 零变更。**两刀**=①**无 selector 整店订阅清零**（v4.349 挂池④收口）：全仓扫描四家 store 仅剩 WorkspacePanel/FilePreviewModal 2 处无 selector 订阅全部 selector 化；审计对账=v4.349 审计「13 处」行号已过时（MainLayout/HomePage/AppearancePanel 已被中间轮次 selector 化），本轮清零后全仓归零；gaea useController 的 useShallow(s=>s) 整面订阅保留（App.tsx 消费近乎全量字段无法局部化，热字段 items 流式本就逐 chunk 变化 selector 化无收益）②**交付物缓存失效接线**（v4.354 记录欠账）：registryCache/dirListingsCache 的「轮完成/会话切换」失效时机从预留注释变实线——invalidateTurnCaches 接到 turn_done 事件消费点+loadSessionData；新轮交付物/新建文件不再被 TTL 内旧探测误标缺失；纯内存清空零桥接成本。**测试**=前端 +2（turn_done 后 ensureTurnRegistry 重拉打桥的调用计数断言/会话装载同语义）；全量 vitest 389 文件 3320 例绿+tsc 0。**门禁**=全量 ci 绿 EXIT=0+版本漂移闸 OK@4.382.0。**坑**=①挂池审计行号会过时——清欠前先全仓重扫，销号写清哪些本轮修哪些中间轮已修②恰好一次的事件绑定是模块级单例——从可观测面（bridge 调用计数）断言不 mock 内部③缓存失效时机在事件边界——reducer 保持纯函数，副作用接既存非纯区。**产物**=exe 见 SHA256SUMS-v4.382.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.377.exe。**文档**=挂池④/dirListingsCache 销号回填+releases/v4.382.0.md（含升级说明）+CHANGELOG/README+releases/README（计数 403→404+34 席插 v4.382 裁 v4.348）+AGENTS 迁 1 插 1（九十七迁：v4.379 入 archive）+progress/todos。

- **最新发布：v4.381.0（2026-09-22）「dsh 蒸馏第四弹：锚定式 token 计量」**——dsh 留池②单独一版精修（余 4），compression 域最后一块精度拼图。全 Go，绑定面 711 零变更。**病根**：mid-turn 压力=全量字符×全局比率，比率漂一点全表面跟着漂，压缩触发时机（high-water）漂移=早触发白砸缓存前缀/晚触发靠溢出自愈兜底。**落地**（agent/tokenmeter.go）：压力=上次真实 usage 锚点+表面有符号差值；per-message 估价 memo（FNV-64 与 msgChars 同记账面，ReasoningContent 不入账）让差值只统计新增/删除/改写——未变消息锚点估价逐项相消，剪枝/压缩重写后估计不再漂移；落锚点=maybeCompact 收到真实 usage 时（此刻会话表面恰=刚被 answered 的请求，assistant/tool 结果未入账，锚点无系统偏差；LastPrompt 回退不落锚）；估压有锚=锚点+差值（负差值钳非负），无锚=裸字符估算旧口径不变（midTurn 本就等首锚后才工作）；压缩重写性质=老消息被摘要替换时压力按「删锚点估价、加新估价」精确移动。恒装配无配置面，EstimateContextTokens 委托计量表（midTurn/compactIfOver/force 检查全过同一口径）。**测试**=Go +5（比率源漂移下未变消息不重算+新增移除精确移动+重复读取零漂移/压缩重写精确移动/负差值钳/无锚回退/maybeCompact 落锚而回退不落）。**门禁**=go build/vet 0+gofmt（触碰文件）+全量 ci 绿+版本漂移闸 OK@4.381.0。**坑**=①锚点时点对齐「刚被 answered 的请求面」——maybeCompact 在 session.Add(assistant) 前调用才无系统偏差，挪后差一整轮②新消息按当前比率估、老消息按锚点时点比率消是刻意的（memo 键只含内容不含比率）③sync.Mutex 不可重入——持锁调内部无锁变体。**产物**=exe 见 SHA256SUMS-v4.381.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.376.exe。**文档**=dsh 蒸馏文档②销号（余 4）+releases/v4.381.0.md（含升级说明）+CHANGELOG/README+releases/README（计数 402→403+34 席插 v4.381 裁 v4.347）+AGENTS 迁 1 插 1（九十六迁：v4.378 入 archive）+progress/todos。

- **最新发布：v4.380.0（2026-09-22）「dsh 蒸馏第三弹·子代理编排：Fork 型子代理 + 结构化输出补完 + V10.36 对齐复活」**——dsh 留池再进两刀（余 5）。全 Go，绑定面 711 零变更；顺带根修被测试当场抓出的既有缺陷。**两刀+一根修**=①**Fork 型子代理**（源 subagent-fork-in-process）：task 新增 fork——子代理以父会话完整历史做种子（带上下文委派，不再手工粘前文）；种子自带父 system 不注模板提示→子请求前缀与父逐字节一致=KV 缓存继承（fork 第一轮近乎免费）；TaskTool 实现 ContextualTool；组合禁忌=background/continue_from/retry_until；runSubSession 会话持有上移②**结构化输出补完**：原 output_schema 只在父级事后验（子代理不知道要产 JSON、不合法丢回父级整轮重跑）——补 schema 注入子代理 prompt+terminal guard（非 JSON 同会话纠偏重入，热前缀缓存成本极低，有界 2 次，耗尽诚实降级诊断前缀+原样）+stripJSONFences 剥围栏③**根修 V10.36 对齐复活**：P0-1 每轮重置 activeSchemas 无条件清 nil 把构造期注入的父对齐 schema 第一轮抹掉=对齐自重置加入起是死代码（fork 测试抓出子请求 schema 1 vs 父 2）；修法=New 存 baseSchemas 基线、回合重置恢复基线（主代理基线 nil 行为不变）；两个 V6.0 测试钉死形态按复活后设计改写双断言（请求目录=父全量缓存对齐+执行面过滤 buildSubReg 承担，一层委派红线不破）。**测试**=Go +6+改写 2。**门禁**=go build/vet 0+gofmt（触碰文件）+全量 ci 绿+版本漂移闸 OK@4.380.0。**坑**=①「每轮重置」类清理会把构造期注入配置一起抹掉——重置回基线不是零值，死代码靠端到端断言请求形状辨识②V6.0/V10.36 两代测试钉矛盾行为各活各的（对齐是死的两边都绿）——修复一处另一处断言爆开，改断言不是改实现③RunSubAgent 把会话藏在内部——需同会话二次进入/会话预置的功能都要把会话持有上移调用方④executeOne 把工具结果包信封——测试透信封断言。**产物**=exe 见 SHA256SUMS-v4.380.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.375.exe。**文档**=dsh 蒸馏文档 fork/结构化输出销号（余 5）+releases/v4.380.0.md（含升级说明）+CHANGELOG/README+releases/README（计数 401→402+34 席插 v4.380 裁 v4.346）+AGENTS 迁 1 插 1（九十五迁：v4.377 入 archive）+progress/todos。

- **最新发布：v4.379.0（2026-09-21）「dsh 蒸馏第二弹：spill 泄洪 + 中断流结构化块保全」**——dsh 留池再进两刀（余 7 项）。全 Go，绑定面 711 零变更（read_spill 是 agent 工具目录新增非 App 绑定）。**两刀**=①**spill 主动泄洪**（源 packages/spill/spill-policy）：成功工具结果 ≥24KB 全文先存会话泄洪库（新叶子包 internal/gaea/spill，runner 内存+单条 4MB/总量 64MB FIFO 驱逐，重启清零即天然会话级），内联文本前置 locator，新工具 read_spill(id,offset,max_bytes) 分页取回——大结果中段不再被截断销毁；**捕获在压缩前**（gaea 按工具压缩+全局 48KB 截断会先销毁中段，泄洪保原文、预览仍交既有压缩管线）；**locator 前置=截断生存性结论**（信封是单行紧凑 JSON，超帽时全行保留但首行被头部裁切——尾缀必死头部必活，测试当场抓出尾缀假绿）；豁免 read_file/read_spill/task；best-effort 纪律照单全收；[agent] tool_spill 配置门默认开，子代理随父各持独立库②**中断流结构化块保全**（源 agent-loop step catch）：终态流错误/预算阻断路径 assistant（含 calls）落库（此前只存文本，模型已声明的调用从历史消失）——persistInterruptedCalls 成对补结果行（预执行只读用真实，其余合成「received but not executed」占位走 WrapError 信封同约定），ToolResult 事件照发收口前端半开卡片；**恢复路径刻意不落 calls**（重试采样路径落了就是悬空 assistant(tool_calls) 非法历史形态），两路径分流是关键辨析。**测试**=Go +12（spill 包 4/agent 5/中断保全 3）。**门禁**=go build/vet 0+gofmt（触碰文件）+全量 ci 绿+版本漂移闸 OK@4.379.0。**坑**=①信封单行 JSON 截断按行选择按字节裁切——行数不超限时全行保留后首行头部裁切，要活的内容放头部②混合批执行序非调用序（v4.375 分区并行）——「先泄洪再取回」同批竞态假红，跨回合才有全序③agent 测试引 builtin + builtin 引 agent=测试期 import cycle（生产编译不报 go test 才炸）——共享类型下沉叶子包④preOutcomes 存已包信封 output——合成占位同信封约定。**产物**=exe 见 SHA256SUMS-v4.379.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.374.exe。**文档**=dsh 蒸馏文档①③销号回填+releases/v4.379.0.md（含升级说明）+CHANGELOG/README+releases/README（计数 400→401+34 席插 v4.379 裁 v4.345）+AGENTS 迁 1 插 1（九十四迁：v4.376 入 archive）+progress/todos。

- **最新发布：v4.378.0（2026-09-21）「Reasonix 真身蒸馏第四弹·留池收官：bash 会话状态锚定 + memory activation 二维 + subject keys」**——Reasonix 真身蒸馏第四弹收官版。全 Go，绑定面 711 零变更；蒸馏档留池 9 项全部销号（落地 8+辨伪并入既有），真身蒸馏线收官；dsh 池同日销 3（12→9）。**三刀**=①**bash 会话状态锚定**（留池⑤主值，源 persistentshell）：cd/export（含导出函数）跨调用存活——取道不取器**进程不持久状态持久**（PTY+marker+分帧与每调用新进程+Job Object 灭树+boundedOutput+超时硬杀相克且需 conpty）；漂移治理在观测不在推断：EXIT trap 采集终态（cwd 经 cygpath -w 转 host 形——MSYS $PWD 的 /c/... 形 exec.Cmd.Dir 不认；env 用 export -p 全量转储前置 eval 重放；显式 exit 照采、退出码 exit $__gaea_rc 原样传播），被杀/trap 被覆盖/exec 换身不采纳——缓存永不超前于现实；并行批次独立探针完成序采纳；目录消失自愈回落；豁免=PowerShell/WSL enforce/后台（起始目录仍锚定）；会话切换经新接口 tool.SessionStateResetter（controller NewSession/Resume）重置防跨会话泄漏②**memory activation 二维**（留池⑦之一）：activation 管触达与 scope 正交——pinned=正文随会话快照装配/relevant=仅检索可达；BuildPinnedFactsBlock 固化正文预算化注入稳定前缀（块 1200 rune/单条 400 截断留标），「固化」动作从此有功能后果；排序 Name 升序（touch 不翻动前缀）；门控仅记忆总开关，空集合零注入③**memory subject keys**（留池⑦之二）：remember 可选 subject_key 点名单值问题，同空间同键仅一条活跃值——撞键**拒绝并点名持有者**（修订走原条目重写非制造矛盾新记忆），同名=修订放行，置空=释放键；Store.Save 统一检查（dream 不带键零影响）；SchemaV23 facts.subject_key+双 SELECT 回填；文件后端 metadata.subject_key 往返（仅声明时写出=旧文件逐字节不变）。**辨伪销号**=PTY 进程持久残留（残余只剩 shell options/alias/未导出函数不值 conpty 全套）/freshness 三档+expiry（早已在册：decay.go 三态+CleanupArchived，领先上游）/dsh 三项（timeout-policy=工具超时是工具内错误串无外层 deadline 通道；skill digest 重发布=缓存稳定前缀同判；contextBreakdown=ContextView 构成视图已在）。**测试**=Go +15（shellstate 9/activation 3/subject keys 4）+装配 1（pinned 正文双空间各见各的+未固化不进+开关关零注入）；Git Bash 真机验证 trap 采集+eval 重放。**门禁**=go build/vet 0+gofmt（触碰文件）+全量 ci 绿+版本漂移闸 OK@4.378.0。**坑**=①bash printf 的 %s 是 Go Sprintf 动词——wrapper 模板写 %%s 否则 vet 拒编②MSYS 路径形态——探针必须 cygpath -w 转 host 形否则下次 cmd.Dir chdir 失败③事件日志列与 Event 结构一一对应——subject_key 真相归 facts 表（与 body 同待遇），不为审计单独开列④NormalizeSubjectKey 空白折叠与下划线不是一回事。**产物**=exe 见 SHA256SUMS-v4.378.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.373.exe。**文档**=蒸馏文档第四弹三刀+留池收官回填+dsh 档销号 3 项+releases/v4.378.0.md+CHANGELOG/README+releases/README（计数 399→400+34 席插 v4.378 裁 v4.344）+AGENTS 迁 1 插 1（九十三迁：v4.375 入 archive）+progress/todos（reasonix 行翻✅）。

- **最新发布：v4.377.0（2026-09-21）「办公记忆/成本库写入纠偏：自动做梦建议制 + 存量清污 + 成本劝写改口」**——用户反馈「不管什么都自己记入记忆和成本库，根本不询问，大量错误污染数据」。主源=auto-dream（每轮 TurnDone 后台 LLM 提炼**直写**长期记忆+项目文档，设计上豁免审批且记忆开关管不住）；次源=成本工具文案持续劝写。绑定面 707→711（+4）。**五刀**=①**自动做梦建议制**：[dream] mode（suggest 默认|auto 旧直写|off）——suggest 下提炼结果进待确认队列（dream-pending.json，FIFO 上限 30）记忆面板「建议」页逐条**接受才入库**（source=explicit）/忽略即丢弃；notes 同建议化（play notes 不入队同旧纪律）；旧决策「异步无法弹卡所以放行直写」改为「确认从写入时移到接受时」（DREAM_WRITE_POLICY §5 修订）；**记忆开关收口**（enabled=false 任何模式不整理）②**存量清污**：GaeaDreamPurgePreview=auto_dream 审计∩现存事实名（explicit 接受过与手工沉淀不在内），GaeaDreamPurge 仅删该交集（绑定面不可删任意记忆），dream_purge 审计留痕③**成本劝写改口**：cost_save 描述改「仅用户明确要求时调用」，cost_search/cost_compose 文案 4 处+compact 简述 2 行同步（work 审批卡保留，改的是发起频率）④**默认 system prompt 记忆段改口**：「只在用户明确要求记住时才调用 remember」；用户自定义提示词不受默认值影响需自查⑤**面板 UI**：自动做梦三态循环按钮+建议忽略按钮+清污两步确认入口+i18n 三语+mock 补 4 绑定。**测试**=Go +8（DreamMode 归一化/队列 FIFO 上限出队三态空间隔离/入队分流/视图转换/接受入库出队幂等+忽略不写库/清污交集圈定交集外跳过审计留痕）+前端 MemoryPanel +3（三态循环/忽略/清污两步）。**门禁**=go build/vet 0+全量 ci 绿+版本漂移闸 OK@4.377.0。**坑**=①bindingNames.ts 重生成必须保 as const（丢失则 BindingName 退化 string、drift 锁报 never 不指向真凶）②jsdom LocaleProvider 默认 en——i18n 断言须双语正则③出队失败不得静默落旧写入路径④清污按钮不能只在建议非空分支渲染。**产物**=exe+SHA256 见 SHA256SUMS-v4.377.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.372.exe。**文档**=DREAM_WRITE_POLICY §5+releases/v4.377.0.md（含升级说明：恢复旧行为/清污指引）+CHANGELOG/README+releases/README（计数 398→399+34 席插 v4.377 裁 v4.343）+AGENTS 迁 1 插 1（九十二迁：v4.374 入 archive）+progress/todos。

- **最新发布：v4.376.0（2026-09-21）「Reasonix 真身蒸馏第三弹：压缩救援阶梯 + 重复调用裁决 + 技能目录预算化」**——续 v4.375 真身留池第三弹。全 Go，绑定面 707 零变更。**三刀**=①**压缩救援阶梯**（源 fold_ladder/truncate/rescueOrFail）：1a slim 摘要档——折叠区大到来不及重放时（正是溢出场景）摘要请求自己会 400→退机械裸计数；估算超 window−预留−5% 边际即逐消息截头（下限 200 字符+标记、工具参数截 160）换有界转录，全量档被 provider 真实拒绝后重试也降半预算 slim；fits 时逐字重放不变（缓存对齐仍是首选档）。1b 投影截断终级 truncateRescue——剪枝+压缩无进展**或压缩后估算仍在窗口之上**（上游 at-or-above-ceiling）时：保护区收窄 target/4（planCompaction ≥2000 token 尾钳会把可救内容全划成圣地）→抹大工具结果（老→新，KeepErrors/KeepProtected 豁免）→整单元丢最老+装 marker；改动前先归档（archive 坏=整体拒绝 fail-closed）②**重复调用硬阻断降级 advisory**（上游裁决硬阻断误伤多于收益全量退役；gaea 观察期 v4.375→v4.376 满）：repeatedSuccessBlock 退役，同签名写工具第 3 次成功起批后注入一次性合成提醒（每签名每轮至多一条），真实结果不再被 blocked 替换，Success 语义更真实③**skill 目录预算化渲染**（二分压缩描述行）：目录超 4000 字符先二分收缩描述宽度保**全员可见**（尾部技能被截=模型永远用不到），压缩态尾注计入预算；纯名行仍超才退旧硬截断；fitting 目录逐字不变。**辨伪销号一批**=采样恢复状态机+预算学习（超限/thinking-400/预算学习无靶子——主链路不发 max_tokens、reasoning 不回放）、skill 引用按需分页+watcher 热重载、read_tasks 续读游标、会话私有临时目录 env 重定向、压缩状态跨重启保留；余池=Persistent bash PTY+memory 事实生命周期。**测试**=Go +13+2 处适配（summarize 加 forceSlim 形参）。**门禁**=go build/vet 0+全量 ci 绿 EXIT=0+版本三处 4.376.0。**坑**=①救援机制的可达带先算清再写测试——可达带=compact 尾钳与 rescue 尾钳间盲区，prune 够不到、compact 尾保护又留下的大块 assistant 正文才是构造素材，否则前置清场测试假绿②token 估算器 max(bytes/4, runes/2)——纯 ASCII 按 2 字符/token 计③破坏性截断 fail-closed 于归档。**产物**=exe 51030528 B SHA256=8c0febb6…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.371.exe。**文档**=蒸馏文档第三弹三刀+留池销号回填+releases/v4.376.0.md+CHANGELOG/README+releases/README（计数 397→398+34 席插 v4.376 裁 v4.342）+AGENTS 迁 1 插 1（九十一迁：v4.373 入 archive）+progress/todos。
- **最新发布：v4.375.0（2026-09-21）「Reasonix 真身蒸馏第二弹：执行序批次 + 文件观察 + 杂项加固」**——续 v4.374 真身留池第二弹。全 Go，绑定面 707 零变更。**四刀**=①**执行序批次修正**（源 v1.38 Harness-style scheduling）：批次分区冲突键 read:/file: 分家导致同批「先读 A 再改 A」并发竞态——统一 file:<path> 资源键同路径拆批保序；跨路径共存并行延迟收益保留（不取上游全序严格执行以免退 v4.63 并行子代理——取道不取器）+call/result 对应性守卫（双重 recover 间逃逸路径合成结构化错误）②**Live file observations**（源 fileops/observation.go）：会话级版本指纹（size+mtime 纳秒）——read_file 真实读后记录、写前比对、自身写后刷新；外部修改/删除 blocked:[stale version]、从未观察不拦、缓存命中不假装观察；与 V10.28 stale-anchor 并存（锚点新鲜度 vs 跨轮外部篡改——此前 write_file 静默覆盖外部修改）③**git 硬化基线**（源 gitcmd）：gitRun 注入 -c fsmonitor/maintenance 关闭+env GIT_TERMINAL_PROMPT=0/GIT_OPTIONAL_LOCKS=0/GIT_CONFIG_NOSYSTEM=1，GaeaGitDiff 强制 --no-ext-diff --no-textconv④**memory_search 低权威免责**（源 auto_recall）：检索结果前置免责声明防旧记忆覆盖新指令；路径抹除辨伪销号（gaea 记忆不含机器路径）。**测试**=Go +5（保序/共存回归锁成对/观察三态）+键名适配。**门禁**=go build/vet 0+全量 ci 绿+版本三处 4.375.0。**坑**=①批次分区改动必须带共存收益回归锁（只测拆批不测共存=延迟优化静默回退）②观察类机制防「假装观察过」——观察点必须绑真实 I/O 成功路径。**产物**=exe 51011072 B SHA256=88499e00…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.370.exe。**文档**=蒸馏文档留池四项销号/辨伪回填+releases/v4.375.0.md+CHANGELOG/README+releases/README（计数 396→397+34 席插 v4.375 裁 v4.341）+AGENTS 迁 1 插 1（九十迁：v4.372 入 archive）+progress/todos。
- **最新发布：v4.374.0（2026-09-21）「Reasonix 真身蒸馏：安全四刀 + 内核三刀」**——用户纠偏「蒸馏对象认错了（dsh 非 reasonix）」+「自己去 github 上搜索」：真身=GitHub esengine/DeepSeek-Reasonix（Go 单二进制终端 agent，gaea 注释 V1.12/V1.15 端口出处），本版蒸馏 v1.15→v1.38.11 增量（5227 提交，源码 clones/deepseek-reasonix）；v4.373 dsh 档勘误更名（五刀有效保留）。全 Go，绑定面 707 零变更。**安全四刀**=①Host 白名单（HTTP 421）挡 DNS-rebinding：httpbridge+诊断端口（/stack 栈倾倒）挂 Host 头名单（loopback+监听地址，通配豁免）②只读表修正：移除 env/awk/sed（间接执行/可执行 shell 程序体 fail-closed 交审批；上游 -f 例外依赖「已记忆规则」模型 gaea 无此前提不照抄）、cargo 仅留 search（check/doc 跑 build.rs）、find 补 -ok/-okdir、git 补 --ext-diff/--textconv/--filters/--open-files-in-pager③git clean-filter 中和：gaea_git 枚举 repo 本地 filter.* 注入 -c 置空三件套（.gitattributes 不可信，查看 diff 不得执行 clean 程序；恒等直通 diff 仍真实）④SSRF 共享件+booksource 补洞：netclient.BlockedSensitiveIP/BlockedInternalIP/GuardedClient（webfetch 委托语义不变），booksource 默认 client 从裸 DefaultClient 换守卫版。**内核三刀**=⑤收尾判定（v1.37 natural-turn completion）：reasoning-only 干净 stop=最终回答；真零内容=冻结请求重放不注合成消息（缓存前缀零污染）⑥bash 输出运行中封顶（head 1MiB+滚动尾 64KiB，`yes`/失控构建不再打爆内存）⑦compactStuck 新消息解锁（stuckAtMessages：新消息=新折叠边界自动解锁，旧熔断会话级永久）。**测试**=Go +10；行为变更适配 3 处。**门禁**=go build/vet 0+全量 ci 绿+版本三处 4.374.0。**坑**=①蒸馏判据带「上游机制前提本地是否成立」（-f 例外）②安全刀先 grep 假站/httptest 用例 client 来源（TestDownloadChaptersExplicitList 被守卫打碎补显式 client）。**产物**=exe 51004928 B SHA256=85149421…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.369.exe。**文档**=docs/gaea-reasonix-v138-distill-2026-09.md 新增+gaea-dsh-016 档勘误更名+releases/v4.374.0.md+CHANGELOG/README+releases/README（计数 395→396+34 席插 v4.374 裁 v4.340）+AGENTS 迁 1 插 1（八十九迁：v4.371 入 archive）+progress/todos。

- **最新发布：v4.373.0（2026-09-21）「Reasonix (dsh) 0.1.6 内核蒸馏：溢出自愈 + 缓存对齐摘要等五刀」**——用户口径「继续优化迭代 gaea，本次优化进行蒸馏最新版的 reasonix」：对 /c/AI/deepseek-harness（dsh v0.1.6-alpha.2，上游同步 2026-09-19）三域全量侦察（压缩/上下文、循环控制/护栏、子代理/计划/技能/记忆）后落地五刀。全 Go 内核，绑定面 707 零变更。**五刀**=①**上下文溢出自愈**（compaction-basic 蒸馏）：provider.IsContextOverflow 七措辞分类器（绝不误判输出侧 max_tokens）→剪枝→强制压缩→session rewrite version 验持久进展→有界重试同一轮；采样成功清零、连续上限 1、无进展如实放弃——「上下文超限」从回合死刑变可恢复路径②**缓存对齐摘要**（summarizer 蒸馏）：摘要请求=会话真实 system+被折叠区间逐字原样重放+压缩指令作末条 user 消息（动态注入只进末条），成上一真实请求真前缀命中热 KV 缓存按 cache-read 计价，不再全价重付；renderTranscript 平铺退役③**shrink 硬校验**（region.ts 蒸馏）：摘要估算必须小于被折叠区间否则退机械摘要——压缩永不膨胀④**force 多轮压缩**（compactionRetries 蒸馏）：强制水位压缩后重测仍超再压一轮，rewrite version 只计真实落地空转不计入 compactStuck 熔断⑤**repeat 分级提醒**（repeat-tool-reminder 蒸馏）：[3,5,8] 三档递进（3 通用/5 点名工具+参数预览 500 上限/8 终止指令），4/6/7/9+ 沉默，deny 也计数，用户插话重置链。**测试**=Go +7（IsContextOverflow 9 子例/溢出自愈四路/摘要请求前缀逐字稳定/shrink 两路/force 有界/repeat 三档）；行为变更适配 summaryInstruction 快照断言。**门禁**=go build/vet 0+agent/provider 全包绿+全量 ci 绿+drift OK@707+版本三处 4.373.0。**坑**=①折叠区含旧 digest（kept）时逐字重放到第一个 kept 消息即与上一请求分歧——system+tools 最贵前缀仍全命中，部分对齐可接受（完全对齐会重摘要旧 digest 破坏不可变设计，不取）②无进展判定必须看 session.RewriteVersion 而非 compact 返回值——compact 对无可折叠区返回 nil，按返回值判会把空转当成功。**产物**=exe 50995712 B SHA256=363b40e7…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.368.exe。**文档**=docs/gaea-dsh-016-distill-2026-09.md（侦察+五刀+留池 12 项：spill 泄洪/锚定计量/子代理控制面/plan mode/session-query 等）+releases/v4.373.0.md+CHANGELOG/README+releases/README（计数 394→395+34 席插 v4.373 裁 v4.339）+AGENTS 迁 1 插 1（八十八迁：v4.370 入 archive）+progress/todos。
- **最新发布：v4.372.0（2026-09-21）「Gantt 缩放性能：Ctrl+滚轮 rAF 合并」**——用户口径「继续」，性能留池「Gantt 行组件化」可安全子集落地。schedule 1 源文件+1 测试适配，绑定面 707 不动。**落地**=高分辨率触控板每秒 60~120 次 wheel 事件原各触发一次 setDayW 全三窗格重渲染；改 rAF 合并——帧内累积缩放因子 pendingW 每帧最多提交一次 setDayWAt；锚点以累积后目标日宽换算，滚动位置恢复与逐事件处理终态一致；清理路径补 cancelAnimationFrame。「GanttBars 行组件化+dayW 走 CSS transform」结构性改造留池（条形定位改 scale 变换涉及拖拽坐标换算重写，核心交互高风险区需专门拖拽真机回归）。**测试**=GanttView 33 例全绿（缩放断言等 rAF 帧提交——jsdom 下 rAF 为 16ms 模拟 setTimeout，fireEvent 后同步断言拿旧值）+drag.test 7 例绿。**门禁**=全量 ci 绿 EXIT=0（vitest 3315 例；首跑 BookHealthPanel 1 例 flaky 零足迹交叠单跑复绿后全量复跑 OK）+drift OK@707+版本三处 4.372.0。**坑**=①rAF 合并后同步断言失效——测试需等待帧提交②it 回调补 async 时连环括号错误——脚本化改写测试优先整段重写。**产物**=exe 50988032B SHA256=cf94c096…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.367.exe。**文档**=releases/v4.372.0.md+CHANGELOG/README+releases/README（计数 393→394+34 席插 v4.372 裁 v4.338）+AGENTS 迁 1 插 1（八十七迁：v4.369 入 archive）+progress/todos（Gantt 缩放 rAF 合并销号）。
- **最新发布：v4.371.0（2026-09-21）「聊天历史分页绑定（游标式，绑定面 706→707）」**——用户口径「继续」：性能留池「聊天历史分页绑定」设计落地：大话题切会话不再全量拉取，首屏最新 200 条+向上翻页游标续拉。Go 3 源文件+1 测试+前端 6 源文件。**契约**=store ListMessagesPage(topicID, limit, beforeSeq)（beforeSeq<=0 从最新向前取；返回升序+hasMore 取 limit+1 探测）/App ChatMessagesPage 返回 {messages, hasMore, oldestSeq}/ChatB 门面+gen_bindings 再生（合计 707 方法→11 门面）+bindingNames/spaceBindings(shared) 手工同步+spaceBindings.test 数量 529→530。**前端**=loadTopic 首屏 ChatMessagesPage(id,200,0) 记录 hasMore/oldestSeq+loadOlder（120 条/批 prepend 头部）/MessageList 接 hasOlder·loadingOlder·onLoadOlder·prepend 四 props——头部追加用 prepend 通知扩大窗口而非重置（anchor 重置逻辑区分「分页追加」与「切话题替换」，防用户被弹回尾部）；全量 ChatMessagesList 保留（导出场景）。**测试**=定向 +1（Go TestListMessagesPage：首屏截断/hasMore/游标续拉/拉到底四场景）+ChatPage.test mock 接线 15 例全绿。**门禁**=go build/vet 0+internal/chat 全量绿+tsc/eslint 0+全量 ci 绿（vitest 3315 例）+drift OK@707+版本三处 4.371.0。**坑**=①头部追加 vs 整体替换窗口语义——anchor 重置不区分会把用户弹回尾部②mock 契约跟随签名演进——数组 vs page 对象，page?.messages 提取静默空。**产物**=exe 50987520B SHA256=59cfc300…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.366.exe。**文档**=releases/v4.371.0.md+CHANGELOG/README+releases/README（计数 392→393+34 席插 v4.371 裁 v4.337）+AGENTS 迁 1 插 1（八十六迁：v4.368 入 archive）+progress/todos（性能八项消一项：分页绑定收官）。
- **最新发布：v4.370.0（2026-09-21）「工程健康轮：依赖漏洞清零 + Go 工具链升级 + 构建管线修正」**——用户口径「继续」，十轮快跑后工程健康整固：govulncheck+npm audit 双扫描按发现修复。Go 1 源文件+依赖升级+构建脚本修正，绑定面 706 不动。**扫描与处置**=①Go 标准库 5 处（net url 二次复杂度/tls 握手/http ReadHeaderTimeout/xml·asn1 递归）→工具链 1.26.5→1.26.6（go.mod toolchain 指令，exe 实测 go1.26.6）②x/image v0.40→v0.46（webp/bmp 解码 panic 4 处，用户可控输入面）③excelize GO-2026-6452 恶意 xlsx panic（上游 Fixed in N/A）→应用层防线：xlsxpreview Render/NeedsRecalc 入口 defer recover 转「预览失败（文档结构异常）」，govulncheck 复扫 11→1 仅剩此条（上游未修，防线已兜，修复后可移除）④npm @vitest/mocker 2 moderate（dev-only）→vitest 4.1.11 audit 归零⑤**新增 pnpm-lock.yaml**（前端依赖历史上从未锁定，vitest 4.1.11 锁定 CI 实测兼容）。**构建管线修正**=build.bat wails 命令未带 -s，隐式 npm install 在 lockfile 缺失+peer 冲突（eslint-plugin-prettier ^4.2.5）时爆炸（vitest 升级触碰 package.json 即暴露）——按在册坑配方改先 npm.cmd run build 再 wails build -s。**门禁**=govulncheck 复扫 11→1+audit 归零+go build/vet 0+office 全量绿+全量 ci 绿（vitest 388 文件 3315 例，4.1.11 兼容）+drift OK@706+版本三处 4.370.0。**坑**=①pnpm 项目 npm install 生成 package-lock 双轨——立即删并 pnpm install 恢复单轨②lockfile 缺失是环境敏感炸弹——任何依赖树变动触发重解析 peer 冲突爆炸③wails 隐式 npm install 依赖环境解析——显式前端构建+-s 是在册坑配方 build.bat 此前未遵守本轮落地。**产物**=exe 50979328B SHA256=785a740a…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过；go1.26.6 构建）；保留策略删 v4.365.exe。**文档**=releases/v4.370.0.md+CHANGELOG/README+releases/README（计数 391→392+34 席插 v4.370 裁 v4.336）+AGENTS 迁 1 插 1（八十五迁：v4.367 入 archive）+progress/todos（excelize 上游未修留观）。

- **最新发布：v4.369.0（2026-09-21）「真机走查班第二班：流式分段渲染真机验收 + --w-ink-3 重指向」**——用户口径「继续」，走查班第二班验收 v4.366~368 三轮；顺手落地别名重指向小刀。前端 1 css 文件，绑定面 706 不动。**走查结论**=①流式分段渲染链路真机验证通过（新建会话→发短消息→模型正常回复落库渲染，终态无错误无 file:// 残留无 console 告警；切分契约由 findStableCut 6 例单测锁定）②--w-ink-3 重指向目检通过（launcher 局部令牌实测 #5b6472=text-tertiary，别名重指向两目收官）③环境事实=走查见「请求超时」历史消息系用户环境模型服务当时不可用非回归。**落地**=module-launcher.css --w-ink-3 从 color-mix(text 46%) 改 var(--md-sys-color-text-tertiary)，.ml-avatar-user 二次混色底 12%→14%。**清场**=测试消息对经 chat.db 按 id 精准删除（会话恢复原有 6 条）；脚本/截图清理；杀壳。**门禁**=tsc/eslint 0+全量 ci 绿（vitest 3315 例）+drift OK@706+版本三处 4.369.0。**坑**=①CDP 读局部令牌要在定义作用域元素上读（--w-ink-3 在 .ml 下 documentElement 读恒空）②走查发消息会写用户真实库——聊天无消息级删除绑定，测试消息只能 chat.db 按 id 精准删；后续验证流式先建专用测试会话再删整会话。**产物**=exe 50951680B SHA256=26f0293b…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.364.exe。**文档**=releases/v4.369.0.md+CHANGELOG/README+releases/README（计数 390→391+34 席插 v4.369 裁 v4.335）+AGENTS 迁 1 插 1（八十四迁：v4.366 入 archive）+progress/todos（别名重指向两目收官）。
- **最新发布：v4.368.0（2026-09-21）「性能轮深水区：聊天流式分段渲染 O(n²) 根修」**——用户口径「继续」：性能留池最大项落地。前端 3 源文件+1 新测试，绑定面 706 不动。**问题**=聊天流式每 delta 对全量累积文本重跑 react-markdown（remarkGfm+remarkMath+rehypeKatex），O(n²)，5KB 尾段 5~20ms×30+ chunk/s=主线程高占用+GC 压力。**方案**=三选一定 A（ChatRow 流式分支分段；B 动公共组件冲击 t74 调用计数断言+波及非流式方；限频只降频率不降规模）。**落地**=①findStableCut 导出+盲区修复（原只扫切点后 suffix，fence body 含空行计数偶数误判可切拦腰切断；改全量行扫描 fence 状态切点在未闭合 fence 内回退到打开行前，既有 MemoMarkdown 测试零改动通过）②ChatRow 流式分支 stable+pending 两段渲染（stable 字符串不变时子树 memo 整体跳过；pending 每帧重解析通常 KB 级；终态回既有路径零变化）。**契约**=genui 零破坏（流式分支本就不传 overrides）；折衷=松散列表序号短暂重排终态自愈+翻转 DOM 重建一次；改进=尾段走完整管线未闭合 fence 显示为增长代码块。**门禁**=定向 +6（findStableCut 含盲区用例）+MemoMarkdown/genui/聊天回归全绿+tsc/eslint 0+全量 ci 绿（vitest 3315 例）+drift OK@706+版本三处 4.368.0。**坑**=①正则整段替换函数体非贪婪匹配吞闭合括号②性能改造行为等价是「终态等价」——中间态 DOM 单块变两块，验收=终态一致+中间态不劣化。**产物**=exe 50951680B SHA256=e1bc4358…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.363.exe。**文档**=releases/v4.368.0.md+CHANGELOG/README+releases/README（计数 389→390+34 席插 v4.368 裁 v4.334）+AGENTS 迁 1 插 1（八十三迁：v4.365 入 archive）+progress/todos（性能八项消一项）。
- **最新发布：v4.367.0（2026-09-21）「编辑输入性能：章节编辑 memo 化 + 设定页预览/统计防抖」**——用户口径「继续」，性能轮延续：编辑输入链路每击键全页重渲染与全文重解析治理，全部行为等价。前端 4 源文件+1 新 hook，绑定面 706 不动。**①ChapterEditor memo+updateTab useCallback**=章节编辑每击键两次 setTabs 使 959 行 ChapterPage 整页重渲染、未 memo 编辑区全场景框陪跑→updateTab 改 useCallback（依赖 activeKey）稳定 onUpdate 引用+ChapterEditor 包 React.memo。**②ChapterPage 上报防抖**=novel:chapter-active 事件 effect 依赖 activeTab（每击键变）每次全文 join+countTextChars 并拖动壳层 inspector 重渲染→250ms 防抖（cleanup clearTimeout）输入期间不付全文遍历。**③NovelSettingPage 预览/字数防抖**=分屏/渲染模式每击键全文 react-markdown+KaTeX 重解析（10k 字约 10~30ms/键输入明显卡顿）+wordCount 每键全文扫描→新增 useDebouncedValue 通用 hook（300ms），MarkdownContent 与字数消费防抖镜像值，编辑器保持逐键受控输入零延迟。**门禁**=tsc/eslint 0+全量 ci 绿（vitest 3309 例；ChapterPage/NovelSettingPage/novel 187 例定向全绿）+drift OK@706+版本三处 4.367.0。**坑**=①跨层字符串转义地狱——python 补丁多层传递中反斜杠 n 被吃成真实换行写进源码（TS Unterminated string literal），构造含反斜杠字面量用 chr(92) 拼接彻底避开转义层级②防抖的正确姿势是「镜像值」而非「延迟源」——编辑器保持逐键受控（输入零延迟），只有下游重计算（Markdown 解析/字数）消费防抖镜像；防抖放 onChange 上游=输入回显延迟，那是 bug 不是优化。**产物**=exe 50951680B SHA256=177331f5…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.362.exe。**文档**=releases/v4.367.0.md+CHANGELOG/README+releases/README（计数 388→389+34 席插 v4.367 裁 v4.333）+AGENTS 迁 1 插 1（八十二迁：v4.364 入 archive）+progress/todos（性能八项再消两目——ChapterEditor 受控下沉被 memo+防抖等效覆盖大半，下沉本体留池）。
- **最新发布：v4.366.0（2026-09-21）「性能轮收官：聊天组件 memo 化专项 + StoryStream 行级 memo」**——用户口径「继续」：性能八项留池中「聊天组件 memo 化」props 链梳理完成落地收官；StoryStream 行级 memo 同步根修（O(消息数×分段) 流式放大）。前端 7 源文件+1 守卫适配，绑定面 706 不动。**刀1 聊天组件 memo 化**=ChatPage 五个内联箭头回调 useCallback 化（handleToggleSearch/ForceSearch/Thinking/OpenVoiceSettings/SwitchPersona）+quickReplies 内联 [] 提 EMPTY_REPLIES 常量+四组件（ChatModeBar/ChatPersonaBar/ChatComposer/ChatInspector）React.memo 包裹（XInner+文件尾 memo 导出）；ChatInspector 统计三遍全文遍历合并单趟 useMemo。memo 语义安全：props 梳理不完整只损失收益无正确性风险。**刀2 StoryStream 行级 memo**=抽 SinAssistantRow memo 行组件（parseStorySegments 下沉行内）——前提核实：useSinStory 流式 patch 非流式行引用稳定+插图回调 useCallback 稳定；流式期间每 delta 只重渲染流式中的那一行。**守卫适配**=E16 QUICK_REPLIES 作用域断言按 memo 化声明形态适配（意图不变）。**门禁**=tsc/eslint 0+全量 ci 绿（vitest 3309 例+E16 PASS）+drift OK@706+版本三处 4.366.0。**坑**=①改组件导出形态先查源断言守卫（E16 按声明文本定位，memo 化改名守卫失明）②memo 化顺序纪律——先稳定 props 再包 memo，反了空转无报错。**产物**=exe 50951168B SHA256=a6d7be9a…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.361.exe。**文档**=releases/v4.366.0.md+CHANGELOG/README+releases/README（计数 387→388+34 席插 v4.366 裁 v4.332）+AGENTS 迁 1 插 1（八十一迁：v4.363 入 archive）+progress/todos（性能八项消两项）。
- **最新发布：v4.365.0（2026-09-21）「前端性能轮：流式节流 + 后台空转治理 + 缓存统一」**——用户口径「继续」，前端换新镜头性能审计（三路：React 渲染/长列表流式/桥接数据面），全落行为等价低风险刀，前端 22 源文件+1 测试，绑定面 706 不动。**线1 流式节流**=useChatStream delta 改 buffer+rAF flush（原每 chunk 一次 setState 使 ChatPage 30~120/s 全页重渲染+吸底 reflow；四条终态路径 flush 前 cancelPendingDelta）+角色打字机 rAF 时间驱动+ChatPanel 打字机 rAF 每帧 3 字符。**线2 后台空转治理**=五 canvas 循环（ParticleFlow/SoundWaveOverlay/CompanionAvatar/VoiceChatOrb/RelationGraph）document.hidden||offsetParent 挂起守卫/DagPanel·AgentTree·useComfyTaskProgress·useImageGenQueue·SinIllustration 轮询秒表 hidden 跳过/TaskCenter onTaskEvent 接 gate/AIConsole 隐藏丢事件。**线3 渲染链**=MainLayout（根壳）/HomePage/ModelCenterPage/AppearancePanel×8 整 store 订阅改逐字段选择器/hits key 稳定化。**线4 缓存统一**=getCachedAttachmentDataURL 共享缓存（Message/FileThumb/inspector 接线）+粘贴/截图复用内存 dataUrl。**线5 AOA 几何**=查找表 Map 化+几何管线组件级 useMemo，hooks 移 early return 前。**顺手修真 bug**=AIConsole 违反 v4.62.2 EventsOff 事故纪律（改 subscribeWailsEvent）/TaskCenter 事件 gate 漏接。**门禁**=定向 +4 源断言+tsc/eslint 0+全量 ci 绿（vitest 3309 例）+drift OK@706+版本三处 4.365.0。**留池**=流式分段渲染/真虚拟化/StoryStream 行级 memo/ChapterEditor 受控下沉/Gantt 行组件化/分页绑定/blob URL/聊天组件 memo 化。**坑**=①组件 memo 非免费午餐②rules-of-hooks 硬约束③mock 缺方法时可选链与直接调语义差④根壳粗订阅优先治理。**产物**=exe 50951168B SHA256=c2d09a93…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.360.exe。**文档**=releases/v4.365.0.md+CHANGELOG/README+releases/README（计数 386→387+34 席插 v4.365 裁 v4.331）+AGENTS 迁 1 插 1（八十迁：v4.362 入 archive）+progress/todos。
- **最新发布：v4.364.0（2026-09-21）「真机走查班：v4.361~v4.363 前端三轮验收 + withinReadRoots 绘梦图误伤修复」**——用户口径「继续」（授权闲置窗口），CDP 9333 附着 v4.363.0 壳走查（只读纪律），走查拽出 v4.358 读侧收口真机才现形的误伤，修复发版。Go 1 源文件+1 测试，绑定面 706 不动。**走查结论**=双空间 14 板块错误边界 0/空白 0/console.error 0/exception 0/file:// img 残留 0；深验=PersonaPicker popover 31 可聊天角色 26 头像全渲染零裂图零 file://（v4.355 报 27 条告警同场景收口确证）/schedule 行号色实测 rgb(74,64,96)=Violet 亮态 onSurfaceVariant（v4.361 生效）/tertiary 双态 #5b6472↔#8b93a0 切换正确/longtask 全程仅 1 条 800ms 真长任务（阈值后噪音归零）。**修复 withinReadRoots 遗漏图片保存目录**=走查日志 6 条 AttachmentDataURLError（Pictures\gaea 绘梦历史图被拒）——v4.358 论断「绘梦资产均落两根内」不成立：绘梦图实际落 cfg.ImageSaveDir（默认 USERPROFILE\Pictures\gaea）；修=withinReadRoots 改 App 方法补第三根（ImageSaveDir 非空+默认兜底，与 image_handler 落盘口径一致）；真机复验同一张被拒图读回 2.89MB data URL；定向 +1 TestWithinReadRootsCoversImageSaveDir（兜底根纯前缀断言不写用户目录）；顺手修 &App{} 裸构造 panic（方法化后 nil core）加 a.core!=nil 守卫。**门禁**=定向 +1+app 全量绿 102s+tsc/eslint 0+全量 ci 绿（vitest 3305 例）+drift OK@706+版本三处 4.364.0。**坑**=①mock/单测测不出路径语义——白名单论断没经真机就写注释，读侧白名单变更必须真机过真实数据路径②走查拽错要看壳日志不只看页面（前端有占位兜底页面全绿）③包级函数改方法先 grep 裸构造测试④CDP 探针传 Windows 路径转义陷阱（反斜杠被吃），用 join(String.fromCharCode(92)) 或正斜杠。**产物**=exe 50948096B SHA256=e026857b…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.359.exe。**文档**=releases/v4.364.0.md+CHANGELOG/README+releases/README（计数 385→386+34 席插 v4.364 裁 v4.330）+AGENTS 迁 1 插 1（七十九迁：v4.361 入 archive）+progress/todos。
- **最新发布：v4.363.0（2026-09-21）「后端留池终审：ConvertToPdf 读侧收口落地 + prompt 双构造辨伪关闭」**——用户口径「继续」：后端挂池仅剩 2 项逐项终审，一项落地一项辨伪，后端挂池清零。Go 1 源文件+1 测试+前端 1 小刀，绑定面 706 不动。**刀1 ConvertToPdf 读侧收口**（挂池设计项落地）=取证确认三类调用方（工作区相对/uploads 绝对/对话框工作区外素材）全被现有机制覆盖——收口=相对路径 Clean 拒 .. 穿越（原 Join Clean 掉 .. 可逃逸）+统一门 !withinReadRoots && !isPickedFile fail-closed（对话框素材经 GaeaPickFiles 登记时已入表现成覆盖，对齐 ReadFileB64 口径）；写侧 exports 全服务端拼装无越界；三类合法调用方零误伤；定向 +1 TestConvertToPdfPathGuard（四场景零外部进程——放行断言借 .doc 扩展名拒绝分支，.docx 装 soffice 的测试机会真转成功反而无法断言）。**刀2 prompt 双构造辨伪关闭**=复核实为 New() 构造后立即被 SetPromptFS 换新（main.go 同步单线程在 Startup/httpbridge 前）第一实例零读者无正确性影响；换新是 embed FS 注入唯一无锁手段（Engine 无锁契约）；收益个位数毫秒 vs 成本改签名或加锁+绑定生成面三处——风险>收益辨伪关闭，低风险形态=New 可选 embed-FS 参数+SetPromptFS 幂等短路排池尾。**刀3 前端小刀**=MemoryHubPage 总览读取失败 rail 计数「—」占位。**门禁**=定向 +1+app 全量绿+tsc/eslint 0+全量 ci 绿（vitest 3305 例）+drift OK@706+版本三处 4.363.0。**坑**=①收口测试放行断言借转换前确定性分支②辨伪关闭也要证据链留档。**产物**=exe 50947584B SHA256=5a2bdafa…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.358.exe。**文档**=releases/v4.363.0.md+CHANGELOG/README+releases/README（计数 384→385+34 席插 v4.363 裁 v4.329）+AGENTS 迁 1 插 1（七十八迁：v4.360 入 archive）+progress/todos（后端挂池清零）。
- **最新发布：v4.362.0（2026-09-21）「前端优化轮第二弹：吞错可见化收尾 + tertiary 文本令牌收敛」**——用户口径「继续」：v4.361 余量两路取证（剩余吞错全量复核+别名收敛影响面）后定刀，纯前端 17 源文件+2 测试+3 语言文件，绑定面 706 不动。**刀线一 吞错收尾 12 刀**=OfficePanel 读失败防覆盖（置顶数据覆盖风险：gaeaSettings 失败草稿留默认值，保存即覆盖真实引擎 config.toml→loadFailed+Alert+禁保存+拦截，定向 +2）/「删除假成功」家族 5 刀（PriceSourcesRepository·PriceSourcesPanel+加载空面板错误态·CostProjectsView 删行·restoreVersion 旧行删除失败中止恢复〔原吞错继续插=删半截+重复〕·CostNotesView）/OfficeMemoryLibrary doMergeAll 计数分报失败对保留/useChatTopics 初始化失败一次性 message.error/ProgrammingPage 轮询首败 setError 复用 prog-error（原永久「检测中…」）/ModelSwitcher 失败态点击重试分流/TaskInboxPanel 状态变更提示/小刀 3（ChatPanel 人格·AboutPanel「v—」·useSinStory 自动命名）。**刀线二 tertiary 收敛**=ThemeTokens 新增 colorTextTertiary（暗 #8b93a0 平移/亮 #5b6472——原 #6b7280 Violet 亮 surface 4.41:1 不达 AA；新值全 surface ≥5.45），App.tsx 三别名改令牌下发变量名全保留=25 消费点+softTextStyle 7 文件零改动，机检扩面（BODY_TOKENS+锁值+防回流源断言）；别名层裁决=纯转发保留、--fg-faint 千级重指向独立拍板、--w-ink-3 需目检挂池。**门禁**=定向 +4+tsc 0+eslint 0/0+全量 ci 绿（vitest 387 文件 3305 例）+drift OK@706+版本三处 4.362.0。**坑**=①LocaleProvider 跟随 localStorage gaea-lang，beforeAll loadLocale 不稳固——重渲染 t() 翻回 en 断言飘，beforeEach setItem②antd disabled Button accessible name jsdom 不稳定，定位走 testid/textContent③zh-TW 必须补齐全部 DictKey④恢复类先删后插吞错=删半截+重复，失败要中止⑤对比度选值喂最差场景背景。**产物**=exe 50946048B SHA256=c2643285…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.357.exe。**文档**=releases/v4.362.0.md+CHANGELOG/README+releases/README（计数 383→384+34 席插 v4.362 裁 v4.328）+AGENTS 迁 1 插 1（七十七迁：v4.359 入 archive）+progress/todos。
- **最新发布：v4.361.0（2026-09-20）「前端优化轮：失败可见化 + 观察池清账 + 令牌卫生」**——用户口径「优化gaea前端UI」：三路并行只读审计（令牌一致性/交互三态/观察池取证）后定刀，纯前端 34 源文件+4 测试+2 新工具，绑定面 706 不动（零 Go 改动），零删功能。**刀线一 失败可见化 7 刀**=NovelSettingPage 读失败防覆盖（loadFailed+Alert 重试+禁保存+Ctrl+S 拦截，原空编辑器可覆盖真实设定=唯一真丢数据风险）/SearchModal（Ctrl+K）检索失败三态（参与线全败才报错单路降级，v4.350 漏网面）+存任务失败提示/ConsistencyPanel 检查失败不伪装「全部通过」（ruleError 横幅+「结果不可信」空态）/CostLibraryView batchStatus 失败计数+busy 闸（batchDelete v4.350 同函数漏网兄弟）/CostLibraryPage 概览失败≠空库（statsFailed 错误态+重试单路降级）/WeixinPage 提醒失败态+首拉 loading（照 v4.351 范式+loadedOnce）/批量吞错 6 处（KnowledgePanel doReview·MemoryPanel 三开关回滚 toast·ChatPage 清空失败恢复快照·ModuleLauncher 语音发送·TaskCenter 输出·VoiceSettingsPanel）。**刀线二 观察池清账 3 项全清**=①file:// 头像通道统一（PortraitImg 抽 usePortraitUrl hook 独立文件+模块级成功缓存；PersonaPicker〔PersonaAvatar〕/AssetStudio〔CharGridPortrait+顶层 hook〕/WeixinPage〔WxPortraitAvatar/WxPortraitImg〕残留直连全接线=v4.355 走查 27 条 console 拒载告警清零）②longtask 日志阈值 50→200ms（continue 置于 10s 窗口判定前防短任务占配额）③schedule 弱化文字对比度（对比度普查遗留拍板项落地）——css 9 处 color+UsageView DIM_COLOR+AoaView 2 处 SVG fill+PredEditor 把 outline（0.25 alpha 边框令牌）当文字色全换 on-surface-variant（亮态 1.3~1.8:1→≥6:1，v4.127 刀E 先例；border/background 用途合法保留；兜底统一 #6b7280），回归锁=contrast-hex 源断言。**刀线三 令牌卫生 零视觉变化**=softTextStyle 7 文件逐字重复→utils/uiStyles.ts 单源（labelTextStyle 三处有意差异不收敛）/情绪色 map 2 处重复→utils/emotionColors.ts（EMOTION_COLORS+emotionColor；no-raw-hex 豁免名单随文件迁移登记）/novel-workspace 2 处 var(--color-text,#fff) 反向兜底→currentColor/tailwind --transition 注明被 App.tsx ThemeTokens 注入覆盖。**测试与门禁**=定向 +6+tsc 0+eslint 0 error 0 warn+全量 ci.ps1 绿 EXIT=0（vitest 386 文件 3301 例——首跑 PptxEditPanel 1 例 flaky 与本轮足迹零交叠单跑 8/8 复绿后全量复跑 OK）+E 系列回归守卫 OK+仓库卫生守卫 OK+bindings drift OK@706+版本三处 4.361.0。**坑**=①「参与者全失败」合取式里不参与的路贡献 true（vacuous truth）而非 false——失败判定写反两次被定向测试当场抓出，scope 单路场景才暴露②源断言 not.toMatch(/color:.*outline/) 会误伤 border-color: 行与 outline-variant 前缀——行首锚定 ^\s+color: 且令牌名后带标点 [,)] 排除前缀族③no-raw-hex 豁免按文件名白名单——色板提取到新文件后原豁免失效 eslint 拦 11 处，豁免名单随文件迁移同步登记④hook 别与组件同文件导出（react-refresh/only-export-components 0 warn 门禁）——usePortraitUrl 拆独立文件⑤测试定位 select 按 option 文本而非裸 querySelector（页内多个 select 拿错元素）；select value 必须是 STATUSES 合法值，非法值 jsdom 静默回落空串 onChange 拿 falsy 短路。大工程留池（镜头A 审计结论勿顺手做）=字号阶梯全量替换（裸 px ~700 处先补档）/玻璃配方收敛（4 套+58 处裸 backdrop-filter）/canvas 图表调色板 resolveToken/次级文本 6 别名收敛进 ThemeTokens 机检——todos 新挂池行。**产物**=exe 50941440B SHA256=a2c695b3…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.356.exe。**文档**=releases/v4.361.0.md+CHANGELOG/README+releases/README（计数 382→383+34 席插 v4.361 裁 v4.327）+AGENTS 迁 1 插 1（七十六迁：v4.358 入 archive）+progress/todos。
- **最新发布：v4.360.0（2026-09-20）「后端优化轮第五弹：挂池再清 3 刀——.tmp 卫生守卫 / 导入事务化 / 版本号原子化」**——用户口径「继续」：v4.359 余量再取证落地 3 刀（含 .tmp 病根本身入闸），绑定面 706 不动。**刀1**=scripts/clean-tmp.ps1 新增+ci.ps1 接入（.tmp 超 512MB 只清 Test*/*.log/edge-* 等 profile/日志瞬态模式）——v4.359 发现的 vitest 病根本身入闸；坑=.ps1 含非 ASCII 必须带 UTF-8 BOM（在册守卫），无 BOM 时 GBK 误读破坏 param 行阈值默认值静默失效变「每次都清」，首跑即暴露。**刀2 ImportProjectCharacters 整体事务化**（characterlib）=抽 execer 接口（DB/Tx 公共 SQL 子集）+getOn/prepareUpsert（磁盘 IO 不入事务）/upsertOn/associateOn 四助手拆分，Get/Upsert/Associate 改薄包装签名不变绑定面零影响，导入循环 Begin→tx→Commit 失败整体回滚（原每角色三次 autocommit 往返，中途失败=部分导入）；既有 4 个 Import 测试零改动全绿=事务化等价性证明。**刀3 SaveVersion 原子化+SchemaV22**（costproject/gaea db）=INSERT 内 SELECT MAX+1 自算版本号（单语句 SQLite 写锁下天然原子，读改写窗口消除，并发双保存后到者拿 MAX+2）+回读实际落库版本填返回值+SchemaV22 先清历史重复（保留最新 rowid）再建唯一索引硬约束背书；定向 +1（TestSaveVersionSequenceAndUniqueIndex：序列连续+直插重复被拒）。**留池仅剩 2 项**（均需设计）=prompt 双构造（agent 持 eng 指针时序）/ConvertToPdf 绝对路径（Pick/白名单统一设计）。**门禁**=build/vet 0+受影响 4 包绿+全量 ci 绿+drift OK@706+版本三处 4.360.0。**坑**=①.ps1 无 BOM 乱码是语义问题非显示问题②execer 接口是 Go 事务化标准姿势，磁盘 IO 留事务外③「单语句天然原子」优先于「包事务」——INSERT...SELECT MAX+1 零锁成本，事务留给多语句组合。**产物**=exe 50936832B SHA256=3c42f429…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.355.exe。**文档**=releases/v4.360.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（七十五迁：v4.357 入 archive）+progress/todos。
- **最新发布：v4.359.0（2026-09-20）「后端优化轮第四弹：挂池清账——v4.358 审计辨伪项落地 7 刀」**——用户口径「继续继续」：v4.358 挂池逐项再取证定刀，可落地 7 刀全清、留池 4 项注明原因，纯 Go 7 源文件，绑定面 706 不动。**刀A SQL**=①SelfHeal 启动期 N+1 点查→分类树一次捞内存 map 纯查表（原 pathResolves 每条目每段逐条 QueryRow）②migrateLegacyDB 逐文件直写非原子→只拷主+wal、.migrating 临时文件+rename 原子落位、-shm 不拷+残留 log.Printf 收口 slog③FTS 降级 LIKE 多列长 OR 链（在册 modernc 空集坑高危形状——兜底自己失明）→likeSearch 助手分轮单列查询+Go 合并去重+凑满提前收工。**刀B 启动链**=④Startup 幂等三处（logClose 先关旧/weixinServers 先清扫/fileWatch 先 Close）⑤ai.Client 双构造+桥接早启窗口→Startup 复用 New() 实例（nil 才新建，configureClient 统一接线）⑥filewatch 同步 Walk→app 层 go startFileWatch 整体移出 Startup 临界路径（**addTree 异步化试错证伪回退**：监听就绪前事件真丢且全量索引兜底不成立，filewatch 保持 Start 返回=就绪契约，测试零改动）。**刀C**=⑦GaeaListDir 相对路径拒 .. 穿越（四调用方全工作区相对零误伤；IsAbs 保留=v4.98 冻结面）。**留池**=ImportProjectCharacters 事务化（需 tx 化三助手）/prompt 双构造（毫秒级+agent 持 eng 指针时序风险）/SaveVersion 并发窗口（待复现）/ConvertToPdf 绝对路径（需统一设计）。**门禁**=build/vet 0+受影响 6 包绿+全量 ci 绿+drift OK@706+版本三处 4.359.0。**坑**=①审计论断「有全量索引兜底」要核实兜底是否真存在——照抄即真回归，测试 5s 超时是免费反证②挂池再取证≠照单全收，留池与落地同等重要。**产物**=exe 50931200B SHA256=acd0851d…（SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.354.exe。**文档**=releases/v4.359.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（七十四迁：v4.356 入 archive）+progress/todos。
- **最新发布：v4.358.0（2026-09-20）「后端优化轮第三弹：三路审计（SQL 存储层/启动链路/输入校验）——分类改名 P0 根修+读侧收口+FTS 增量」**——用户口径「继续优化后端」：v4.356~357 已扫 panic/并发/句柄/吞错四轴，换新镜头三路并行只读审计，纯 Go 36 源文件+3 测试文件，绑定面 706 不动，前端零改动。**线1 SQL**=①分类改名 substr 字节/字符错位（**P0**，Go len() 喂 SQLite 按字符计数的 substr——中文路径子树条目路径整段截断/条目重挂）→rune 计数偏移+精确行 category 叶子名同步+节点/条目两写包事务+换父也重写（原门控只在改名）+环检测（挂子孙→Categories resolve 栈溢出）+名称含 / 拒绝（同函数五问题一次收口）②rows.Err 缺失 17 处批量补（记忆/三元组/情节恢复主路径+成本检索语料+测算明细 ListItems——直通 SaveVersion 不可变版本快照静默丢行）③单条写全量重建 FTS O(N²)→接上写好却没接线的增量助手 InsertFactFTS/DeleteFactFTS/InsertEpisodeFTS（失败降级全量重建兜底）+两个 Rebuild 事务化（原 DELETE 与逐条重插 autocommit=索引空窗）④schema_v15 补 idx_facts_session/idx_episodes_session（V12 给 traces 补过 facts/episodes 漏）+向量写事务化+COUNT 裸 Scan 收错×5+GetSource 点查。**线2 启动链**=⑤ASR provider Startup 末尾 4 引擎刷新 goroutine 并发写竞争→SetASRProvider 持锁+读侧 currentASRProvider 快照（对齐 SetRealtimeSession 先例）⑥恢复/迁移结论先于 setupLogging（恢复会改写 DataRoot 日志在其中不能先建句柄）GUI 全盲→restoreSummary 字段日志就绪后回放⑦chat/characterlib/Hephaestus 三 db 打开失败 log.Printf→slog.Error⑧Shutdown 补关 Hephaestus/whisper db（对称性）+微信 Stop 通知异步化（原持锁同步 POST 10s×N 卡顿退出，对齐 notifyStart 先例）+回退轮询 stop 接线（原 _ = 丢弃无人能停）+reminderStop Once 闸。**线3 读侧收口**（审计结论：写侧删侧护栏完备，读侧是系统性短板）=⑨GaeaReadFile 零约束读任意文件→对齐写端口径（拒穿越+withinWriteRoots+2MB 截断）⑩AttachmentDataURL→withinReadRoots 根白名单（工作区+数据根）+32MB⑪ReadFileB64「仅对话框所选」契约强制化=Pick 登记机制（GaeaPickFiles 登记读取校验，fail-closed）⑫Preview 相对路径拒穿越+image/docx 32MB 封顶⑬快照/场景 sceneID 白名单 validSceneID（唯一写越界点：..evil 项目外 MkdirAll 写文件）⑭上下文看板三只读口 sessionPath 补 sessionDirForPath（同族 Delete/Stats 均过）⑮CreateProject 书架 containment（对齐 DeleteProject）。**辨伪挂池**=FTS 降级 LIKE 多列长 OR 链疑似空集坑（未确证形状）/SaveVersion MAX+INSERT 并发窗口/migrateLegacyDB 逐文件拷贝活 WAL 库/deferred 事务升级 BUSY/SelfHeal 启动期 N+1 点查/ImportProjectCharacters 无事务/Startup 幂等缺口/filewatch 同步 Walk 大工作区/prompt 引擎与 ai.Client 双构造+桥接早启窗口/GaeaListDir 全盘枚举原语（收紧需先查前端全部调用源）/GaeaConvertToPdf 绝对路径（需 Pick/白名单统一设计）——todos 新挂池行已给 file:line。**测试与门禁**=定向 +3=TestSaveCategoryRenameChineseSubtree+TestSaveCategoryGuards（P0 回归：中文路径改名/换父重写+叶子名同步+环检测+分隔符拒绝）+TestReadFileB64RequiresPick/TestGaeaReadFileTraversalGuard/TestSnapshotSceneIDGuard（读侧三防线）；既有测试修正 2 处=contextview 显式路径两测试的伪造路径改真实 UI 会话目录形态（<ws>/.gaea/sessions/work/<file>，对齐新校验）；V15 迁移断言 user_version=15（schema_v13_test 更新）；go build/vet 0+受影响 10 包测试绿+全量 ci.ps1 绿（go test 全量+lint+build+vitest 386 文件 3295 例——首跑 vitest 偶发失败，按在册纪律单跑复绿后全量复跑 CI OK）+check-docs OK（AGENTS 41704B 预算内）+bindings drift OK@706+版本三处 4.358.0。**坑**=①Go/SQLite 长度语义差是中文环境必炸点——len() 字节喂按字符计数的 SQL 函数 ASCII 测试全绿、中文数据必坏，跨语言边界偏移一律 rune 计数或 Go 侧完成②增量助手存在却没人用——InsertFactFTS 写好后单条写路径没接（性能债埋数月），接闲置能力时补失败降级兜底保最终一致③同函数多问题一次想全——SaveCategory 五问题分开修会互相打架（门控变了重写条件也变）④读侧防线不能照抄写侧——写可全白名单、读有合法绝对路径用途（附件/素材/预览），收口=根白名单+Pick 登记+尺寸封顶组合，逐绑定核前端调用链防误伤（AttachmentDataURL 只限 portraits 会误伤绘梦资产）⑤npx 直调 vitest 扫全仓生成噪音（错误姿势，在册坑重演）——入口必须 npm.cmd run test。【产物】exe 50928640B SHA256=2e1bfdf827f3aa70cc2f8f84a21d3259d2776c6bec337e5f33b553c21e2641bf（releases/gaea-v4.358.0.exe+SHA256SUMS-v4.358.0.txt，exe 仅本地不入库；桌面副本同哈希实测一致；冒烟 /api/health 200 过）；保留策略 5 版留 v4.354~v4.358 删 v4.353.exe（SUMS 身份档案全保留）。【文档】releases/v4.358.0.md+CHANGELOG/README+releases/README（保留策略行+发布说明计数 379→380+34 席索引插 v4.358 裁 v4.324）+AGENTS 迁 1 插 1（七十三迁：v4.355 入 archive）+progress/todos（新挂池行附 file:line）。
...
- **最新发布：v4.352.0（2026-09-19）「前端优化第四轮：ForeshadowPanel 行 memo / ModelCenter ctx 两通道拆分 / 图标钮可访问名」**——用户口径「继续」（v4.351 池延续），纯前端 16 源码+5 测试，零绑定 706。①ForeshadowPanel 抽 ForeshadowRow memo+六回调 useCallback+编辑态布尔/文本双 prop（原每键全列表重渲染）。②ModelCenter ctx 拆 state/actions 两通道+兼容口（v4.350 辨伪项正解：五 hook 对象字面量 deps 无法建立→拆分后 state 内容变化才重渲染、动作引用波动单独承载），9 section 迁 useModelCenterState+按需 Actions，4 测试文件补三连 Provider。③ChatRow/ChatModeBar 八个图标钮补 aria-label（Tooltip 不参与可访问名）。门禁=tsc 0 --force+eslint 0/0+全量 ci 绿 3289 例+drift OK@706+版本三处 4.352.0。坑=①多行解构迁移先抄全字段再分类②测试文件改完 tsc --force。产物=exe 50874368B SHA256=32c47fa8…（releases+SUMS 仅本地；桌面副本同哈希；冒烟 200 过）；保留策略删 v4.346。文档=releases/v4.352.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（六十七迁：v4.349 入 archive）+progress/todos。

- **最新发布：v4.351.0（2026-09-19）「前端优化第三轮：启动反闪根修 / 绘梦历史有界化 / 亮主题叠加层失效群 / color-scheme / 反馈确认补遗」**——用户口径「继续」（v4.350 下刀池延续），纯前端 29 源码+4 测试（1 新 3 扩），零绑定 706。①启动反闪根修=亮色用户每次启动先看 ~2s 深空屏（index.html 静态启动屏硬编码深底+主题变量首帧后才注入）→head 内联脚本预读 gaea-display-mode（判定序逐字对齐 appStore.loadMode：light/system→matchMedia/旧布尔键/缺省 dark）亮则 html[data-bs-light]+静态屏 body 浅分支+boot-splash.css 首帧兜底。②绘梦历史有界化：持久化 HISTORY_META_MAX=500 读写同截/渲染窗口 60+加载更多/回填 limit=48 按 needsFileRestore 过滤（原全量 dataURL 常驻=数百 MB），窗口外缩略图占位+resolveResultImage 按需读，零功能删除。③亮主题中性叠加层失效群 30 处 rgba(255,255,255,x)→color-mix(var(--color-text) N%)（暗底白提亮在浅底白叠白不可见）；辨伪保留 ChatCodeBlock 2 处 hex-exempt；MarkdownContent pre 底令牌化。④color-scheme 声明注入。⑤反馈确认补遗：角色记忆弹窗失败 Alert/青鸟助手双失败载入失败条（原伪装假空态）/图片下载失败 message+成功提示/生图模板删除 Popconfirm。测试=HistoryRail.test 3 新+historyMeta/meta/WeixinPage 扩 4。门禁=tsc 0 强制全量+eslint 0/0+全量 ci 绿+drift OK@706+版本三处 4.351.0。坑=①静态期预读判定序必须逐字对齐 store.loadMode②limit 按需恢复项计数非位置③heredoc 三层转义写完看原始字节④rgba(255,255,255,x) 先排除 hex-exempt 再批替换。文档=releases/v4.351.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（六十六迁：v4.348 入 archive）+progress/todos。

- **最新发布：v4.350.0（2026-09-19）「前端优化第二轮：事件总线连环炸根修 / P0 幽灵令牌 / 破坏操作确认 / 静默失败 / 流式渲染热点 / 主题破绽」**——用户口径「优化 gaea 前端」（v4.349 五线后第二轮），四路并行只读审计（事件与定时器泄漏/交互反馈三态/渲染热点/视觉一致性）按证据定刀，纯前端 32 源码+6 测试（3 新 3 适配），零 Go 逻辑改动零绑定变更（706 不动）。①事件总线连环炸根修：onTaskEvent 清理走 EventsOff(channel) 全清（v4.61 事故红线 v4.62.2 漏网），gaea-task 5 并发订阅点任一卸载=角标冻结+自动打开失灵（keepAlive 至重启）→subscribeWailsEvent 按监听者退订，onUpdaterProgress/onReady 同收口；polyfill（网页）EventsOn 返回 void→ModelCenter 四通道叠加 handler→改返回退订对齐桌面语义，EventsOff(带 cb) 无条件 sse.close()→只摘自己通道空才关。②P0 幽灵令牌：--md-sys-color-error 零定义 26 处消费全失效（失败态红全消失）→colorDestructive 别名；--md-sys-color-surface-container-low 零定义→追问发送钮箭头 12 主题隐形→color-mix 插值；--color-info 补注入（#38bdf8/#0369a1）；幽灵四连 --v3-fg-soft/--v3-line-soft/--color-text-tertiary/--md-sys-color-text-tertiary 明暗分档（暗主题 12px 3.9:1<AA）；modelcenter.css 13 处 gaea 作用域 token 换主令牌（亮主题 #ddd 白底 1.3~2.5:1）。③破坏操作确认 9 处：知识库/成本库批量删（假成功根修=诚实成功 N 失败 M）/绘梦清空/原罪清空（ToolbarButton 无 forwardRef→Modal.confirm）+收件箱删除（吞错可见化+i18n 三语）/青鸟提醒/组织/关系/划线想法。④静默失败：三脑检索三态/排程导出 XML 成败提示/章节载入失败 message.error。⑤性能：Transcript 提及扫描按文本缓存（每 chunk 全会话正则→只付流式段）；ChatPage topicList memo+侧栏 React.memo+hover 纯 CSS；ToolCard 三处 memo；useNow(active) 条件订阅（O(N)/秒常驻清零+伴生修复思考耗时完成后持续增长→边沿定格）。⑥视觉：RelationGraph 画布写死 #ddd/#555 亮主题不可见→主题令牌解析；mermaid 跟 data-hl 非 OS。辨伪=ModelCenter ctx 不 memo（五 hook 对象字面量 deps 无法建立，强行 memo=陈旧 ctx 真 bug）。门禁=tsc 0+eslint 0/0+全量 ci 绿（vitest 384 文件 3280 例）+drift OK@706+版本三处 4.350.0。坑=①EventsOff 红线是禁全清非禁用②Popconfirm clone 覆盖子 onClick（Dropdown 坑家族）③确认钮定位一律 testid 防「删 除」空格名④go test 负载 flaky 复跑绿、ci 日志勿 tail 截断。文档=releases/v4.350.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（六十五迁：v4.347 入 archive）+progress/todos。

- **最新发布：v4.349.0（2026-09-19）「前端优化五线：可访问性动线 / 亮态可读性 / 运行开销 / 布局 / 稳健性」**——用户口径「优化迭代 gaea，进行前端优化」；先四路并行**只读审计**（主题可读性/交互可访问性/渲染性能/布局响应式，各带 file:line 与实测数字）再按证据定刀，纯前端 18 源码+9 测试，**零 Go 逻辑改动、零绑定变更**。**线1 可访问性**=记忆中枢全局检索命中行（主入口动线）裸 div→role=button+tabIndex+Enter/Space；轻语记忆面板标题/摘要键盘化+确认/取消/编辑/删除四图标钮补 aria-label（Tooltip 不参与可访问名）；阅读「删除高亮」补 Popconfirm；Lightbox 关闭钮补名；批准弹窗 aria-modal false→true。**线2 亮态可读性**=①真缺陷：changesdiff-tok.css 写死 One Dark 七色而容器继承面板背景（亮态浅底）实测 .tok-typeName 1.38:1 / .tok-string 1.61:1（注释自称浅色可辨被证伪）→ 接共享调色板 --hl-*（真源 hljs-theme.css 已备浅色深阶组随 data-hl 切；ChangesDiff 显式 import 真源防懒加载链 var 未定义），文件零字面色值；②lightFn 下沉 warning #92400e / success #047857（Moss lime 保留）/ primary Jade·Rose·Amber→#0f766e·#be123c·#b45309（accentRgb/glow 跟随；Violet/Moss/Slate 原达标不动）；③新增 12 主题×5 令牌×2 背景对比度矩阵机检+深阶锁值+hljs 浅色组逐令牌 ≥4.5。**线3 运行开销**=①main.tsx 诊断层 500ms 轮询只写时间戳（17.3 万次/天空转）→ 心跳由既有 rAF 探测循环每帧维护、降级路径补 500ms 兜底续跳（否则误报卡死）②getThemeTokens 每渲染换新对象+ConfigProvider theme 内联字面量 → 双 memo（省 ≈45 个 setProperty/渲染 + antd 主题算法）③SelectionToComposer 先判 isCollapsed 短路（原上来就物化整页选区文本）④WhisperMemoryList 过滤/分组 useMemo+查询词预小写（原 ≈7N 谓词/渲染）。**线4 布局**=摘要 chip 补 nowrap+shrink-0（「基线 N」整排参差）；基线槽位行 wrap+工期/时间戳固定段不可压缩（原 326px>minWidth 300 致行内换行）；海报描述补 line-clamp（定高卡原先静默裁切）。**线5 稳健性**=①书架 loadProjects 只 console.error→首页把读失败渲染成「书架空空如也」假空态 → store 增 projectsError（只表态不抛出）+错误态含原因与重试；②「最近文档」仅挂载读一次而 v4.346 起 keepAlive → lib/recentFiles 增订阅通道（写入广播+解析缓存保快照引用稳定，满足 useSyncExternalStore），首页账页与办公「最近文件」条同改订阅。**审计辨伪**=印泥章 .w-seal #d06055 **不改**（20px/700 属 large text 阈值 3:1，实测 3.49~3.83 达标，按 4.5 判死是误报）；reduced-motion 无缺口（index.css:461 全局兜底已在+GSAP 三 hook 均真调 prefersReducedMotion）；暗态 6 主题×27 配对 0 失败。**测试**=新增 4 文件 44 例+扩展 5 文件 8 例。**门禁**=tsc 0+eslint 0 error 0 warn+全量 ci.ps1 绿（vitest 382 文件 3270 例）+drift OK@706+版本三处 4.349.0；**首轮 ci 被 frontend build 拦下**（新加测试文件后未重跑 tsc：需要 DOM.Iterable/ReadingAnnotation 缺字段）。**目检**=dev ?mock=1+无头 Edge CDP 9347：三页错误边界 0/空白 0；检索 5 条命中全 role=button+tabindex=0；亮态令牌实测 #0f766e/#92400e/#047857 与锁值一致；.p-poster-desc 实测 webkitLineClamp:4；hero 中段空白实测 273px（与审计 276 吻合=本轮有意不动）；截图 .tmp/uiwalk-v4349/。**产物**=exe 50865152B SHA256=615319a09773dc693c2be6d943904bae226dd686d797291c905d605b5174ecea（releases+SUMS；桌面副本同哈希；冒烟 health 200 过）；保留策略留 v4.345~v4.349 删 v4.344。**坑**=①审计阈值必须复核（large text 3:1 被按 4.5 判死会白改品牌色）②--hl-* 是懒加载 CSS 变量，接色板必须同时 import 真源③source-guard 里 indexOf('.hl-scope-dark') 会命中文档头注释须 lastIndexOf④antd 两字按钮可访问名带空格（「删 除」）测试按 /^删除$/ 找不到⑤心跳改 rAF 驱动必须处理降级路径⑥新加测试文件后必须重跑 tsc。**文档**=releases/v4.349.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（六十四迁）+progress/todos。**未做（下刀）**=海报墙 hero 中段留白 276px（须加内容槽=内容决策，改动需验 1440/1180/1100/760 四断点）；其余可点 div 键盘化（章节树/大纲/统计分类 ~8 处）与 ResizableDrawer 手写弹层焦点管理按动线权重分刀；进度计划页 .gsched 工具栏换行与基线 Popover 本轮未实测（mock 无「进度计划」入口）。

- **最新发布：v4.348.0（2026-09-19）「原罪板块优化双刀：故事底稿直注前情 + EPUB 电子书导出」**——原罪优化班：①长程一致性=模型自记的便签/大纲底稿非空时随每轮前情直注 buildSinUserPrompt（预算 4000 rune 从头带、超限如实报数引导 read；空稿提示词逐字零漂移；回合中途 write 下一轮生效；sinDraftForPrompt fail-open），工具描述/系统提示词同步改口「底稿已随前情附上」省 read 工具轮——掉出 12 条历史窗口的早期设定确定性回归，不再赌模型自觉 read；②EPUB 导出=SinExportEpub（绑定面 705→706，play）：每条助手回合一节（第N回中文序数）+用户指令引块置首+插图内嵌（go-epub AddImage 本地路径；首图兼封面；webp 不在支持集占位不硬塞）+未生成占位（cue 次序键优先描述键兜底同 MD 口径），落 sin/exports 同名不覆盖-2/-3、写出失败删半截；顶栏导出改下拉（Markdown 另存为/EPUB 后端落盘告知路径，mock 如实抛）。**测试**=底稿直注 5 用例（空稿逐字一致/排序/预算截断/判空/fail-open）+EPUB zip 全链 2 用例（内嵌恰 1 张+cover.xhtml+占位+同名-2；空故事/跨板块拒绝）+既有三处调用点补参断言零改动；**门禁**=tsc 0+全量 ci 绿+drift OK@706+spaceBindings 锁 528→529+bindingNames gen_bindings -names 再生+版本三处 4.348.0；产物=exe 50863104B SHA256=f84e9bd9164f2bd55b1b12220f6963c6251f39247abad8dba1bb8a6a0249ed00（releases+SUMS；桌面副本同哈希；冒烟 health 200 过）；本地 exe 保留策略执行留 v4.344~v4.348 删 v4.343；**坑**=Dropdown clone 注入的 onClick 覆盖子元素 prop（ToolbarButton 无 forwardRef 且 onClick 必填，占位空函数即净，不为原罪改办公组件）/单条恰=预算的便签整条收下（「超了才截」，测试前提咬一次）。**文档**=releases/v4.348.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（六十三迁）+progress/todos。**未做（下刀）**=sin 真机一条龙走查（书源卡+导出下拉+底稿直注实写）挂闲置窗口池；插图变体历史候立项。

- **最新发布：v4.347.0（2026-09-19）「GLM-5.3-FlashX 新模型接入目录 + Flash 补官方绝对价」**——智谱 9 月中旬新发 GLM-5.3-FlashX（Flash 加速版，320B 总参/18B 激活，200 tokens/s），官方四页交叉核实（模型概览/详情/定价/coding 活动）后接入模型中心 GLM 静态目录；纯数据刀，零新绑定 705、零代码逻辑变更。**落地**=①`glm_catalog.json` 追加 `glm-5.3-flashx`（1M/128K、caps 同 Flash、国内绝对价 2/7 元/M、缓存命中 0.57 记 price_note；尾部追加纪律）②coding 套餐官方明示「暂未开放 FlashX」（仅 Flash 上线）→不配积分系数、不进别名表③Flash 补绝对价 0.8/2.8 元/M——「仅相对价不填绝对价、估算回退内置表 USD」的 09-02 口径作废，估算从 USD 近似（0.65/M+M）变官方国内价精确值（3.6 CNY/M+M）④`glm_catalog.go` 头注释核实日期增补。**测试**=锚定清单 +`glmCatalogV2FlashXIDs`+计数 45→46 全对齐（catalog_test ×5+catalog_remote ×3）+FlashX 元数据/价格锁值+积分守卫名单+估算锁值翻新+CatalogSource 日期；modelengine 包全绿。**坑**=①文档站正文动态渲染抓不到表——`llms.txt` 索引+`.md` 后缀直出是正道②「无绝对价回退 USD」是快照口径，官方补价须回头改目录+锁值（Flash 拖 17 天）③同批发布≠同套餐：逐模型核实 coding 收录再配计费④pnpm 直调会生成占位 workspace/lock 噪音文件，定向复跑走 `npm.cmd run test -- <file>`。**门禁**=gofmt 0+全量 ci.ps1 绿（首轮 ContextView 负载 flaky 隔离 28/28 复跑全量绿收口）+drift OK@705+版本三处 4.347.0；产物=exe 50844672B SHA256=dd51dc7c1c08e279fc4ef3107cd79a2be481d1f09299d8b1d7740e3dda8c9e65（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=releases/v4.347.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（六十二迁）+progress/todos。**未做（下刀）**=coding 套餐若开放 FlashX 补 points/别名（覆盖文件可先行）；其余模型绝对价维持估算回退。
- **最新发布：v4.346.0（2026-09-19）「UI 健壮性双修：错误边界页级隔离（keepAlive 连坐根修）+ TisorRadar 缺档崩页」**——UI 优化班：隔离目检（vite dev ?mock=1+无头 Edge CDP）双空间全页×明暗两态扫出两缺陷全根修；纯前端四文件，零新绑定 705、零新依赖、零功能删减。**发现**=角色库整页崩错误边界（reading 'T'，堆栈单点收敛 TisorRadar `dims[k]/100`）；「原罪页也崩」是边界连坐假象（原罪本体无辜）。**根修**=①MainLayout 边界下沉 keepAlive 每页内部：visitedPages 全页常驻挂载+边界包整组外面=任何一页崩卸载全部页（keepAlive 状态俱失）且后续导航全停错误态——与「防止单页崩溃拖垮整个应用」注释意图相反；页级实例后只瘫自己那页，外层保留兜底②TisorRadar 守卫（dims 可选+缺档渲染 null；Inspector `c.dims&&` 是先例卡片漏了）+CharacterCard 调用方守卫对齐③mock 三角色补 dims（Go Dims 值类型必出，mock 对齐真契约——崩页正是分叉暴露的洞）。**测试**=TisorRadar.test 新建 +3+CharacterCard.test +1（antd 图标也是 svg，按 circle 计数断言）定向 19/19。**坑**=①错误边界+keepAlive 隐形耦合：边界粒度须与常驻粒度对齐，否则隔离只在注释里②生成类型必填≠运行时必达，防御守卫落渲染组件边界③CDP 切主题走 rail aria-label（Tooltip 不落 title）；无头 Edge 临时 profile 记住主题态，脚本按当前态自适应。**门禁**=tsc 0+全量 ci.ps1 绿+drift OK@705+版本三处 4.346.0；产物=exe 50844160B SHA256=5c2a7ec30751b31bc6eb739e2ba6b0250eec844b70795a7c8565954c22c24631（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=releases/v4.346.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（六十一迁）+progress/todos。**未做（下刀）**=亮态 accent 弱化文本对比度打磨（视觉拍板维持观察池）；动效手感待上手定论；真机走查清池班；技能核数 ≈09-30。
- **最新发布：v4.345.0（2026-09-19）「filewatch 关闭竞态根修：fs 通道关闭路径漏 close(out) 致消费方挂起」**——全量 ci 偶发时间型 flaky 深挖后是真并发缺陷；单文件 Go 修复+测试加固。**根因**=loop() 三退出路径中，`fs.Close()` 连带关闭 fsnotify Events/Errors 通道的两条路径此前裸 `return` 漏 `close(w.out)`——与 done 分支 select 竞速（随机取胜），输了就永不关闭输出通道，消费方 `for range w.Events()`（工作区语义索引触发链）永久挂起=关闭竞态协程泄漏；压测频率 ~1/20，全量 ci 高负载放大竞速窗口。**修复**=①outOnce sync.Once + closeOut()：三条退出路径统一幂等关闭（done 分支保持 flush 后关）②TestCloseStopsEvents 断言 2s 硬超时改终态轮询（10s 预算，v4.335 「异步链断言等终态不赌时序」纪律）——既是加固也是回归锁（修复前 1/20 必挂，修复后 20/20 绿）。**坑**=flaky 分两级：预算太短（改预算就绿，掩盖真缺陷）与预算拉满仍挂（真缺陷）——治理必须压测到「拉满仍挂」才停，否则只是把缺陷埋深；select 多通道退出的关闭路径要逐条清点——主动关闭路径正确不代表被动关闭路径也正确（fsnotify 连带关闭是隐形触发源）。**门禁**=go vet 0+filewatch 20 连跑全绿+全量 ci.ps1 绿+drift OK@705（零绑定变更）+版本三处 4.345.0；产物=exe 50843648B SHA256=b3befbdc11c7975aa272848ac9deca857bade2b2dca267feca573ba99e465cf0（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=releases/v4.345.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（六十迁）+progress/todos。**未做（下刀）**=真机走查清池班（v4.319~v4.345；持久 overlay 真机目检随下一班）；技能核数 ≈09-30；t2 余项按反馈。
- **最新发布：v4.344.0（2026-09-19）「t7 最终形态：编辑器持久标注高亮（overlay 常驻 + 编辑退场）」**——v4.343 轻量版完全体（真机镜像对齐已过，最后顾虑清掉）；纯前端三文件，零新绑定 705、零新依赖。**落地**=①分段工具收敛：新建 create/annotationMarks.ts（buildAnnSegments+runeToCodeUnit），分析面板高亮视图与编辑器镜像同一实现——rune↔code-unit 口径全仓唯一出处（Panel 本地副本删除，11 用例零改动全绿=重构等价证明）②EditorPanel：单条 hl 换 annotations prop 驱动 marks（useMemo 派生），镜像渲染全量段（交叠钳制 Q5 口径）；dirty 纪律——正文编辑整体退场（偏移漂移结构性规避）、切章/标注重载恢复；滚动条占宽 gutter 镜像显形时 rAF 实测同步③CreatePage 随激活章加载 NovelChapterAnnotations（alive 守卫防竞态）④locate 句柄契约不变（光标+滚动定位），与常驻 mark 解耦——v4.339 语义零变化。**测试**=EditorPanel 重写+2 共 11/11（常驻双 mark rune 换算断言/编辑整体退场/locate 契约不受 dirty 影响/越界标注无 mark）+Panel 11/11（重构等价）+CreatePage 15/15（补 NovelChapterAnnotations 桩——bridge appStubs 漏桩）。**坑**=①effect 引用 200 行后才声明的 const（activeChapterNum）=TDZ，tsc 不抓靠读序发现②测试桩漏项放大成组件树崩（unhandled rejection→整树卸载→后续断言全「找不到元素」），先看 unhandled errors 段。**门禁**=全量 ci.ps1 绿+drift OK@705+版本三处 4.344.0；产物=exe 50843648B SHA256=95ecb91d66a9d1828a26fb8d7c660d1a4f0bba3db7a7c8292c47c654fd74d5fc（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=releases/v4.344.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（五十九迁）+progress/todos。**未做（下刀）**=真机走查清池班（持久 overlay 真机目检随下一班）；技能核数 ≈09-30；t2 余项按反馈。
- **最新发布：v4.343.0（2026-09-19）「t7 收尾「编辑器标注高亮」轻量版：定位单条镜像 mark + 编辑即失效」**——观察池最后一项（v4.325 有意裁剪的编辑器 overlay）轻量落地；纯前端 EditorPanel+一条 CSS，零新绑定 705、零新依赖。**落地**=①镜像背景层（同排版 div：衬线栈/font-size 变量/行高 1.9/字距/padding 对齐，文本 transparent 仅 mark 显色 --gaea-glow 32%，textarea 切 .novel-editor-mirror-hl 底透出）②换行对齐（滚动条占宽 offsetWidth−clientWidth 补镜像右内距+pre-wrap/break-word 一致+onScroll/rAF 同步 scrollTop）③失效纪律：content/activeNode 变化即清除（手写/流式/切章），偏移漂移结构性规避。**测试**=EditorPanel +1 共 11/11（真实 state harness：定位前无镜像/mark 文本/编辑后清除）。**坑**=①rune 区间心算又错（rune[1,3) 在 𝌆 开头串=「一二」非「二三」）②定位句柄里 setState 异步渲染须 findBy，setSelectionRange 同步可即断言——一次 locate 两种时序③textarea 底色 !important 内联压不过须同优先级类+源码序在后。**门禁**=全量 ci.ps1 绿+drift OK@705+版本三处 4.343.0；产物=exe 50842624B SHA256=49381cbd2b5af04af05a124b6678c4916342743b7758e3ab32d564a790338ecb（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=releases/v4.343.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（五十八迁）+progress/todos。**未做（下刀）**=真机走查清池班（镜像对齐需真机目检后再议持久全量）；技能核数 ≈09-30；t2 余项按反馈。
- **最新发布：v4.342.0（2026-09-19）「t7 观察池「多章对比」最小形态：分析面板章际对比」**——纯前端两文件，零新绑定 705。**落地**=①ChapterAnalysisPanel 增可选 chapterOptions：提供且排除本章后可选≥1 时渲染「章际对比」区（缺省整体隐藏）；Select 选对比章拉其 V2→差值表（综合/节奏/代入/连贯+情感强度）；Δ 语义=四质量维上绿下红、情感强度中性不判色；对比章未分析→行内提示不 toast；V2 无 scores→提示无评分；切章/关面板重置②CreatePage 传 flatNodes 章号清单。**测试**=Panel +3 共 11/11（下拉排除本章/差值表 7.8 vs 6.0 Δ-1.8/未分析行内提示）。**坑**=①flattenTree 返回 TreeNode 章号在 .node 下——tsc 抓住 map(n=>n.order_index) 运行期隐患②antd Select mousedown 必须落内层 role=combobox（根 div 不开下拉），dropdown 在 portal 需 findByTitle 等待，选项点击 jsdom 可用。**门禁**=全量 ci.ps1 绿+drift OK@705+版本三处 4.342.0；产物=exe 50841600B SHA256=3ade927983d1b41e7ac1a6351f72302169e0e52d1e1470bec5db61318bec41dd（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=releases/v4.342.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（五十七迁）+progress/todos。**未做（下刀）**=真机走查清池班；技能核数 ≈09-30；t7 仅剩 overlay 持久高亮（镜像背景层中刀候拍板）。
- **最新发布：v4.341.0（2026-09-19）「t7 观察池「情感曲线图形化」：全书体检面板情感弧线折线」**——观察池条目（v4.325 记录）；纯前端单文件 BookHealthPanel，零新绑定 705、零新依赖（纯 SVG 不引图表库）。**落地**=①体检面板情感曲线区（逐章表与伏笔 findings 之间）：默认「生成曲线」按需触发——N 章=N 次 V2 读盘 RPC 交给作者决定不随体检自动跑②逐章读 NovelChapterAnalysisV2：命中 emotional_arc.intensity（钳 0-10）收集 {章号,强度,主导情绪}，缺档/无弧线/报错跳过并计数（缺档只报「尚未分析」不触发重建，循环安全）③纯 SVG 折线：x=章号线性/y=强度反转/0-5-10 参考线/相邻点直连——未分析章间隙长段如实呈现不插值/圆点 title tooltip/viewBox 自适应④诚实不足态：<2 章提示需≥2 章有弧线+跳过计数⑤「重新体检」重置曲线。**测试**=BookHealthPanel +4 共 7/7。**坑**=①点数与跳过数断言按报告章数编排（2 章跳 1 章后只剩 1 点走「不足」分支）②未分析章 V2 绑定报「尚未分析」不触发重建（重建是标注绑定的行为），逐章循环安全不引爆 LLM。**门禁**=全量 ci.ps1 绿+drift OK@705+版本三处 4.341.0；产物=exe 50838528B SHA256=9067547b1fa0f7207370d98cc113509307d0dea93650b84e1969ac306e9ffaa9（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=releases/v4.341.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（五十六迁）+progress/todos。**未做（下刀）**=真机走查清池班；技能核数 ≈09-30；t7 余项（overlay 有意裁剪/多章对比候拍板）。
- **最新发布：v4.340.0（2026-09-19）「t2 观察池「反推任务取消绑定」：AI 反推大纲轮询期可取消」**——观察池条目（t2 拆书线 v4.291 任务化体验余项）；纯前端单文件 CreatePage，零新绑定 705（后端取消能力 v4.291 起即备齐：TaskState.TaskID 回传+GaeaTaskCancel 协作取消 ctx 直通 handler，缺的只是前端入口）。**落地**=①取消状态三件（cancelRef 轮询标志/taskIdRef/cancellable=taskId 到手才 true 精确门控——同步回落路径无任务 id 不出取消钮）②轮询循环加检查点（入循环前+3s sleep 后）：命中→退出+app.TaskCancel 尽力取消（完成竞态后端报错被吞，消息如实说「已请求取消」，任务中心=权威）+落「已取消反推等待」return 不弹应用确认③rail danger「取消反推」钮 finally 复位；novel:auto-reconstruct 自动链路同样受益。**测试**=CreatePage.test +2（轮询期取消消息+TaskCancel 调用+确认不弹；同步回落不出入口零 Cancel）15/15；**补两处漏桩**（NovelB mock 缺 NovelOutlineReconstruct 同步回落本体/bridge appStubs 缺 TaskCancel）；3s 轮询 sleep 靠全局 asyncUtilTimeout 5000 覆盖。**坑**=①取消是尽力而为：任务恰在取消前完成是正常竞态，UI 语义=停等待+尽力取消+如实说请求已发②取消入口以 taskId 到手门控勿只看 busy 态。**门禁**=全量 ci.ps1 绿+drift OK@705+版本三处 4.340.0；产物=exe 50835456B SHA256=7aaf15a8fcea664ec85969f3048a49ffe1be2ac2054e8d70021fbb2c63c8cb93（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=releases/v4.340.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（五十五迁）+progress/todos。**未做（下刀）**=真机走查清池班；技能核数 ≈09-30；t2 余项按反馈。
- **最新发布：v4.339.0（2026-09-19）「t7 观察池「标注定位编辑器光标」：分析面板→正文编辑器定位闭环」**——拍板池全决策项，按既定习惯从观察池挑余项（v4.325 记录）；零新绑定 705，纯前端三组件。**落地**=①EditorPanel 转 forwardRef 暴露 locate(runeStart,runeEnd) 命令句柄（rune→code-unit 换算 toRune 逆〔代理对按 codePoint 步进〕+setSelectionRange+focus〔Chromium 聚焦即滚选区入视口〕；无激活章回 false）②ChapterAnalysisPanel 增可选 onLocate：锚定标注行内「编辑器定位」钮（stopPropagation 不触发高亮跳转），原「↩定位」改「↩高亮」消歧③CreatePage 接线：**onLocate 仅面板章=编辑章时提供**（gate 跳他章时面板 content 是他章正文——入口隐藏而非点了报错），关面板→复位 gate→locate(pos,pos+length)。**测试**=EditorPanel +3（𝌆 代理对换算/越界钳文末/无激活章 false）+Panel +3（回传+stopPropagation/未锚定无入口/未提供隐藏）18/18。**坑**=gate 跳转的章≠编辑章（面板 content 可为 gateContent）——定位入口按章一致条件提供。**门禁**=全量 ci.ps1 绿+drift OK@705+版本三处 4.339.0；产物=exe 50834944B SHA256=447cc8b0452af06a912edbd5009b14a32e830f9f639a0b681b579ca9fa8290ea（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=releases/v4.339.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（五十四迁）+progress/todos。**未做（下刀）**=真机走查清池班；技能核数 ≈09-30；t7 观察池余项候拍板。
- **最新发布：v4.338.0（2026-09-19）「无参绑定会话语义审计收官 + 死链清理（绑定面 707→705）」**——todos 挂账（v4.181.0 起池）收官；审计档 docs/gaea-session-binding-audit-2026-09.md。**结论=需修 0 项，家族关闭**：枚举全部 Gaea* 导出绑定逐个核对 ga.ctrl 会话态读点——该应用会话模型构造性保证「看历史必经 ResumeSession 切内核」（currentSessionPath 的 current 标记本身来自 GaeaListSessions 读 c.SessionPath()），对话主流水线（History/ResyncEvents/Context/FactBase/Current 标记）无参读内核自洽；v4.181 旁路看板族（轨迹/网络/上下文/子代理 runs）无同构残余；提交类/引擎级豁免；**复审口径入档**（新绑定无参读内核三条件；带会话切换的看板一律显式 sessionPath）。**顺手清账两条死链**=①GaeaCheckpoints（唯一引用=bridge 声明+mock，UI 回退实走 GaeaRewind）连带删 CheckpointMeta/TestGaeaCheckpoints/wire 类型/wailsjs 再生②GaeaTCCAReport（state.tcca 零渲染消费）连带删 controller 两处拉取+TCCAReport 接口+mock+测试。**拍板池新候选**=GaeaSkillDraftFromSession 参数化（唯一无参读全会话做加工点，「从历史会话蒸馏技能」候拍板）。**坑**=①gen_bindings -names 只打印不写盘（v4.145 在案）bindingNames 手工同步；wailsjs 目录 gitignore 再生后 git status 不显示，验证须看文件②删 Go 测试带走 import 唯一使用——build 段不测 test 文件，删测试后 go vet 快验。**门禁**=go build/vet 0+internal/app 全量 ok+tsc/eslint 0+store 域 38/38+drift OK@705+全量 ci.ps1 绿+版本三处 4.338.0；产物=exe 50833408B SHA256=9d4f70562e1e9e4b82fb4373cc7d4cef2e2de15bca301196baaf67f13ed5b0d5（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=审计档+releases/v4.338.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（五十三迁）+progress/todos。**未做（下刀）**=真机走查清池班；技能核数 ≈09-30；TaskCenter 会话关联结构刀（另立版本）。
- **最新发布：v4.337.0（2026-09-18）「办公对话流美化三轮收官：对齐 Codex web（降噪+动线+语义归位）」**——办公对话流美化线程收口发版（在途三轮合一版）；纯前端零新绑定 707，零 Go 改动。**落地十件**=①用户消息气泡化（surface-container-high+细边框，轮次边界扫读清晰）②裸思考行 bare 模式（纯思考段不出过程卡，行数 meta 进思考行头部；三语键 reasoning.metaLineOne/metaLines+英文单复数——收口修掉初版硬编码中文「行」）③过程卡完成即收起（运行中自动展开/完成收起一行「已工作 Xs·…」/历史恢复同样折叠/手动干预保留；旧「展开态默认展开」废=垂直噪音主源；耗时角标只在「已工作」缺席时补位）④WorkHeader 三改（轮内有过程卡时完成态「已完成·用时」行让位 doneSuppressed/纯问答轮 0 步完成态不渲染/运行态样式对齐过程条左细线+hover 底）⑤尾随工具段合并（buildSegments 末段纯过程并回前段——store 事件序工具尾追，过程卡按 Codex 语义渲染在正文前，消「答后动作」假象）⑥轮尾登记-only 交付卡补挂（reasoning-first 轮尾无正文段原先丢卡）+omitPaths 跨段去重（防同文件双卡）⑦交付卡统一边框容器（细边框+行分隔线+整卡一圆角）⑧消息操作 hover 淡入（复制/评分后驻留）⑨顶条只留 waiting 档（≤5s 连接档与 WorkHeader spinner 同义不显示，>5s 才出顶条——正常回合运行态无第二行横幅）⑩ToolGroup 文案精简「bash × 3」+title 完整语义（三语新键）+ToolCard 代码块圆角统一。**测试**=ProcessCard 展开态测试重写钉新行为（完成态折叠 small/非 small 一致+运行中自动展开+bare 无卡头——旧测试钉已废「非 small 默认展开」且用例数据恰落 bare 分支，全量首跑 1 红）；vitest 3199/3199；tsc/eslint 零；三语 +4 键同轴。**目检**（本班收口补验）=vite dev 9344 ?mock=demo+独立 headless Edge 9345 CDP 驱动真实 UI 两轮五态截图全过（运行中自动展开/完成收起/交付卡容器/用户气泡/顶条无横幅/bare「思考 1 行」实测/Composer 排队提示在位）。**坑**=①摘要类文案禁硬编码——一律三语键+注意英文单复数②行为变更须重写钉旧行为的测试（其用例数据可能已落新分支）③杀隔离进程按 user-data-dir/端口过滤勿全杀。**门禁**=全量 ci.ps1 绿+drift OK@707+版本三处 4.337.0；产物=exe 50837504B SHA256=36d7b3e2ab26886b2f96192d13db16666db7686f18c729ce0c36381f0d89c641（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=releases/v4.337.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（五十二迁）+progress/todos。**未做（下刀）**=真机走查清池班（须闲置窗口）；技能核数 ≈09-30；绘梦阶段二候拍板。
- **最新发布：v4.336.0（2026-09-18）「chapter-gate 通知跳转 + oh-story T5 落库接线」**——用户指令「继续」；规格书 进度计划/gaea-gate-jump-t5-wiring-20260918.md。**甲件**（v4.331 观察池头名）=useChapterGateNotice 增可选 onOpen（ref 保最新回调防过期闭包）通知 onClick 传章号；CreatePage gateChapter 覆盖态开分析面板，跨章 GetChapter 拉正文锚定（失败回退空串）；无回调零变化；测试 +1。**乙件**（todos 欠账本体）=摸底证实 T5 资产（.gaea/skills/novel-agents/ 七角色卡 dca0936b）零代码引用、消费面应为 run_skill/任务子代理（非角色库）——①SKILL.md `runAs: subagent`+派发契约段（解析 role→read_file agents/<role>.md→按卡执行；arguments 格式 `role=<角色> <任务>`）②spawn 第五内置模板 subagent_writing+boot 映射 novel-agents→subagent_writing（L4 前缀缓存 V5.30）③验收钉 Go +3（skill 直读仓库资产 Scope/RunAs/锚点/七 role；boot 映射；cache 计数 4→5）。**oh-story 余项只剩写前契约硬闸（等上游一键补大纲）**。零新绑定 707；门禁=全量 ci.ps1 绿+drift@707+版本三处 4.336.0；产物=exe 50833920B SHA256=235e3f05ca7ab062ebea99c49e24160f439a599b80db51a648f33bd1419d77ea（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=规格书+releases+CHANGELOG/README+AGENTS 迁 1 插 1（五十一迁）+progress/todos。**未做（下刀）**=真机走查清池班（须闲置窗口）；技能核数 ≈09-30；绘梦阶段二候拍板。
- **最新发布：v4.335.0（2026-09-17）「办公输入动线对齐 DSH/Codex：运行中 Enter=排队，插话改显式」**——用户报告「办公板块消息输入的排序/插话/撤回不见了，直接插入正在跑的对话中」。**归因=非回归**：队列功能本体（v4.200/201 拖拽排序/插话/撤回/发送中锁定）一直在且测试全绿，丢的是入口——v3.6.0（2026-08-28）把运行中 Enter 从排队改成插话（对齐豆包「边跑边改」），排队退到 Clock 小按钮（运行中且输入非空才显示），用户 Enter→直插当前对话→队列卡从未出现=体感「优化不见了」。用户拍板「按 DSH/Codex 方式处理」。**落地**（纯前端零绑定 707）=①运行中 **Enter=排队**（入队→队列卡回主动线→回合结束 FIFO 派发）②**插话显式化**：Alt+Enter 直插当前回合，队列卡 Zap/全部插话不变③Shift+Enter 纠正/Esc 停止/Clock 语义零变化④发送钮 title 三态换 sendQueuedTitle+placeholder 三语更新⑤composer.steerTitle 键删（0 死键维持）；Composer 四处重复组装抽 assembleSubmit/enqueueSubmit/pushInputHistory，入队统一进输入历史。**测试**=Composer.queue +3（Enter 排队不走 steer/Alt+Enter 直插不入队/Shift+Enter 纠正回归锁）+I18n 断言对齐；composer 域 22/22。**观察**=GenUI action 运行中仍走 steer（机器动作语义与用户输入分线）。门禁=tsc 零错/eslint 零告警/全量 ci.ps1 绿/drift OK@707/版本三处 4.335.0；产物=exe 50832384B SHA256=556c906f1efed83273dd72d7b289610abf1c90c1287560393cd0e3ddf446ccd0（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=releases/v4.335.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（五十迁）+progress/todos。**未做（下刀）**=真机走查清池班；技能核数 ≈09-30；绘梦阶段二候拍板。
- **最新发布：v4.334.0（2026-09-17）「revolution 刀8 收官：跨模块验收+回退演练+版本三处漂移根治」——**小说 revolution 刀 1–8 全线收官****——用户指令「继续优化迭代 gaea」；三线并发子代理+主代理收口；规格书随刀入库 进度计划/gaea-rev-knife8-acceptance-20260917.md。论点=各模块单测在位但跨模块串联零覆盖（自动门成功路径从未被测/审批链 app 级 0 测试/回退三径零断言/性能与保真判据无钉）。**落地 Go +7（零生产代码改动）**：线A novelstyle=性能钉（~5200 rune 章打分 3.3~5.0ms<1s 余量 200 倍）+去味保真（100→27 分/rune 漂移 0/实体逐字保留/句数恒等）；线B 生成主轴端到端**史上首测**=herdsman→httptest SSE 双路桩（按「小说分析编辑」标记分流）贯通 CreateChapter→自动门分析成功→V2 落盘/memories/annotations pos≥0/伏笔 planted/场景重置物化/**chapter-gate 事件 httpbridge SSE 订阅捕获**+50 章书级体检（25 脏/AnalyzedChapters==3/~0.7s 零 LLM）；线C 审批链=Settle(false) **AI 建议无一自动入库**→Settle(true)→journal Replay 与 GetNovelState 逐字段一致→账本只增→坏 JSON 拒；+app 级快照往返+**真 v3 夹具**迁移非破坏（`_v3_backup` 原文保留）。**版本三处漂移根治（独立发现）**=app_info.go/versioninfo.rc 停 4.323.0（v4.324 起十版未跑 sync-version，闸门不在 ci 从未拦截）——三处同步 4.334.0+**ci.ps1 新增 version drift check 段**。顺手=eslint 5 条存量告警清零（EXTRACT_OPTIONS 归位 novelOptions.ts+4 处未用变量）。**坑=①RetryJSON ExtractJSON 对裸 JSON 回复判未找到——桩须包 ```json 围栏②rebuildScenesFromBlob 无场景章 no-op（物化靠读路径惰性）③project.Create 现直写 v4 标记，旧夹具 v3 假设过时（newMaterializeApp 里 MigrateV3ToV4() 实为 no-op），真 v3 须手动摘 `.gaea/v4`**。门禁=go vet/test 全量绿+vitest 3185/3185+tsc 零错+eslint 零告警（5→0）+drift OK@707（零新绑定）+版本三处 4.334.0（新闸门过）；产物=exe 50832384B SHA256=4d2a01c5c84a8e6696fbe845d3583d0591ec79f26e083840dc01110b31c081bc（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=规格书+releases/v4.334.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（四十九迁）+progress/todos+revolution 刀8 勾选（**规划收官对账**）。**未做（下刀）**=真机走查清池班（v4.319~v4.334 挂池，须用户闲置窗口）；技能 ≥5 次核数 ≈09-30；绘梦阶段二与缺省形态翻转候拍板。
-  **最新发布：v4.333.0（2026-09-17）「阶段七出口对账 + 7.3-1 会话级回源收口」**——用户指令「继续」；规格书随刀入库 进度计划/gaea-stage7-audit-resume-20260917.md。两件：①**会话级回源**（v4.318 唯一结构欠账）=pendingSessionResume 模块（单例 pending+CustomEvent 双态通道——gaea 板块 keepAlive：已挂载走事件/冷启走挂载消费）+gaea App 挂载消费（**ref 保最新回调防过期闭包**，projectGroups 异步）+TaskInboxBoard/Panel +onResumeSession（有回调带路径精确回源，否则 V1 板块粒度零变化）；零新绑定 707。②**出口对账**（stage7 §5 门表+总判据更新）：7.1/7.2/7.3 已落、7.4 已清；挂账三项=本地建议真实采纳样本（真机）/录制复跑 ≥80% 抽样+结晶 ≥5 次（≈09-30 核数）/总判据⑤真机走查班（v4.319~332 挂池）。测试=前端 +5。**坑=①测试尾 rfind 追加吞闭合同坑两日三犯（规约：append 前数尾括号）②[] 依赖订阅 effect 引用异步数据回调=过期闭包，ref 保最新**。门禁=go test 全量复跑绿+vitest 3185/3185；**ci.ps1 首两跑分撞 go/vitest 段瞬时失败单跑皆绿、清残留 node 第三跑 CI OK（环境竞争先例+2）**；版本三处 4.333.0；产物=exe 50832384B SHA256=89d1de3d332d19ca77b42952708bef88bfac0cc45c355c28052caa28773c0ba2（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=规格书+releases/v4.333.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（四十八迁）+progress/todos+stage7 对账。**未做（下刀）**=真机走查清池班（须闲置窗口）；技能 ≥5 次核数 ≈09-30；刀8 余项与绘梦阶段二候拍板。
 **非版本刀（2026-09-16）真机验证清池首班：v4.316 归因/v4.317 蒸馏/v4.318 收件箱三刀壳内走查全绿**——用户拍板「真机验证清池固定车位」首班；DSH 同树 v4.318 收口期间备脚本不抢足迹、commit 后以 v4.318 exe+CDP 9333 走查，**三刀全绿零产品缺陷**（全程零异常零 console error）。收件箱=语音闭环（routeIntent 落库 source=voice）/dry-run 零落盘/状态机含终态拒迁/Ctrl+K 全链（预览卡→source=ctrlk+内联回执）/空间隔离双向/清场还原；归因=KPI×4 真数据（¥2617.95·2848 次·97.8%）+17 桶行+未标记桶（model_stats 实盘 v2 兼容读实证）+建议空态宁少勿扰；蒸馏=Candidates {candidates:[],available:false} 诚实空态（journal 实盘每工作区 1 会话）+建议 tab distill-section 渲染+首拉完成；顺带意图导航三例真机全通。**坑**=中断重跑步首清场（残留终态撞状态机）/insertText 叠加注入须 Ctrl+A 清/SearchModal 回车触发非防抖/ml-space 按钮视口外须 scrollIntoView 后重取坐标（真实类 .ml-space-btn.is-play，ml-space-play 只是注释概念名）/ModelCenter 页签=.mc-rail-item 非 antd 且 mc-attribution-kpi 挂容器/MemoryPanel 在办公工作台 chatTab=memory 非记忆中枢 board。**观察池**=蒸馏一条龙（×3 同型会话播种→结晶→命中）需播种设计+真模型调用另班；palette/微信入口 UI 走查；journal 实盘薄建议真实使用积累后再清。详见 CHANGELOG 同日条目+截图 .tmp/walk-v4318-*.png。
-  **最新发布：v4.332.0（2026-09-17）「7.3-2 板块降级为任务视图（阶段七『层跃升』刀：任务优先首页+能力视图+回退开关）」**——用户指令「开始吧」提前拍板解锁（原零功能周窗口 ≈09-23）；契约先行（规格书随刀入库 进度计划/gaea-tasks-first-home-20260917.md）；身位=平台调研 §1.1 空白（任务持久化红海、收件箱第一界面+板块降级无人发布）。论点=首页从「用哪个工具」翻转为「什么在等我」。**裁决**=homeLayout 开关（classic/tasks）入 appStore 持久化，**缺省 classic=现有体验零变化**；TaskInboxPanel 抽内联 TaskInboxBoard（Modal 壳薄包装，9 用例零改动）；回退开关双位（设置页 HomeLayoutPanel+首页 SpaceSwitch 条快捷钮互切）；零新绑定 707；manifest/pageRegistry 零改动；三语 +12 键。**落地**=TasksFirstHome（SpaceSwitch+轻 masthead→收件箱大区 TaskInboxBoard 直嵌→最近会话→能力视图 deriveLauncherModules 全量 chips 点击直达〔**藏≠删**〕→纯同步脚注）；ModuleLauncher homeLayout 分支（classic 走既有 Desk/Garden 零变化）。**测试**=前端 +10；**零回归实证=TaskInboxPanel 9/9+ModuleLauncher 13/13+SettingsPage/appStore 既有全绿零改动**；vitest 3180/3180 一次全绿。**坑**=测试文件尾 rfind('})') 追加吞原 describe 闭合（EOF 报错）；useT 组件测试须 LocaleProvider 包裹；ESM 无 require。门禁=ci.ps1 全绿；版本三处 4.332.0；产物=exe 50831872B SHA256=80dacda4f818deeb47827006e944293bb045b479087611c275345ec29d9dd7eb（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=规格书+releases/v4.332.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（四十七迁）+progress/todos+阶段七规划 7.3-2 状态更新（已落+提前解锁记）。**出口对照**=收件箱首屏✅/板块全量无损（chips 直达测试钉死）✅/回退开关双位✅/classic 零回归✅。**观察池**=最近任务独立区；能力分组/搜索；拖拽排序；晨报脉息在 tasks 形态取舍；默认形态翻转候拍板。**未做（下刀）**=阶段七出口判据复核对账（7.1-7.3 三门收口）；刀8 余项；绘梦阶段二提案候拍板。
- **最新发布：v4.331.0（2026-09-17）「自动门可见化 + CI race 扩面（刀8 race 项收口）」**——用户指令「继续」。小刀单线主代理直做；规格书随刀入库 进度计划/gaea-gate-notice-race-20260917.md。两件收口：①chapter-gate 事件零前端消费（v4.326 观察池头名）——useChapterGateNotice 钩子（EventsOn/EventsOff 通道模式）把自动门结果轻通知作者（契约/质量/AI 味/分析同步四维拼装，key 防叠 6s，空体检=完成，分支章带标记），CreatePage 挂载，**零新绑定 707 不动**；②CI race job 扩面六包（chapter/analysis/promptstore/novelgate/rewrite/characterstate——自动门/覆盖缓存/状态机并发路径），internal/app 注释不进（race 下 TempDir 清理竞争 flaky 先例候评估），revolution 刀8 行补注 race 项收口（余=跨模块验收+回退演练候排）。**坑=vi.stubGlobal('window') 整窗替换炸 react-dom 的 document 依赖——测试只换 window.runtime 属性**。门禁=ci.ps1 全绿（vitest 3172/3172 一次全绿；六包本地普通模式全绿）；版本三处 4.331.0；产物=exe 50824704B SHA256=a5e239f24897a858b628dcd3c8a18ccbafbd073f3831172300a3cfa6b8a63198（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=规格书+releases/v4.331.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（四十六迁）+progress/todos+revolution 对账。**未做（下刀）**=7.3-2 板块降视图（≈09-23 解锁=阶段七层跃升刀）；刀8 余项候排。
- **最新发布：v4.330.0（2026-09-17）「刀7续收官：POV 视图（场景圣经消费面）」**——用户指令「继续」。小刀单线主代理直做；契约先行（规格书随刀入库 进度计划/gaea-pov-view-20260917.md）。前置核对=场景生成按钮/全文脑图/文风指纹均已落，刀7续仅剩 POV 视图。论点=POV 视角掩码（POVView=已知/HiddenFacts=不知情且不得泄露）只在生成链内部消费，视角纪律不可审视。**落地**=①+1 绑定 NovelSceneBibleView(chapterNum, sceneID)（**706→707** NovelB）：sceneID 非空=该场景编译/空=整章合成（v3 与纯 blob 章可用）；SceneBibleView camelCase 切片恒非 nil②SceneBibleDrawer（POV 头「通过谁的眼睛」+已知绿/不知情红对照+角色卡含 t5 状态回灌+伏笔约束+时间锚点主线）③ChapterEditor 场景操作行「视角」按钮挂抽屉。**revolution 勾选对账**：GenerationGate（v4.326）与刀7续补记勾选——文档只剩刀8（CI 侧 race 门禁候排）。锁 529→530；drift OK@707。**测试**=Go +3+前端 +3；ChapterEditor 7/7 零破坏；vitest 3169/3169 一次全绿；版本三处 4.330.0；产物=exe 50823680B SHA256=4ea486520055b3ca160c7fe5336414efbc8e5408535020544974e83528494eeb（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=规格书+releases/v4.330.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（四十五迁）+progress/todos+revolution 对账。**观察池**=Render 全文预览；POV 切换沙盒；多场景并排；隐藏事实溯源。**未做（下刀）**=7.3-2 板块降视图（≈09-23）；刀8 race 门禁（CI 侧）。
- **最新发布：v4.329.0（2026-09-17）「绘梦阶段一刀 E：画室消耗（月度聚合+折叠面板）——**绘梦阶段一（A/B/C/D/E）全清**」**——用户指令「继续」。小刀单线主代理直做；契约先行（规格书随刀入库 进度计划/gaea-studio-usage-20260917.md）。论点=台账已逐条记 Cost+CreatedAt 但没有聚合视图。**裁决**=+1 绑定 ImageHubMonthlyUsage(space)（705→706 ImageB）；当月前缀过滤×model+backend 分组；**单价以台账记录为事实源**（缺价回落目录表）；「X CNY/张」可解析才估算、裸"0"="0 CNY/张"=免费、"未定价"/空=unpriced 诚实不猜；全免费→「0 CNY（本地免费）」；文案画室消耗不用积分话术；面板 space 固定 play。**落地**=imagehub_usage.go（绑定入口 gaeaCwd 同构+cwd 参数化内函数供测试+parseUnitCostCNY）；StudioUsagePanel（Collapse 默认收起标题带总数合计/展开按模型行+口径脚注/失败静默）挂 ImageGenPage 顶栏下方；bridge/mock/spaceBindings（锁 528→529）/bindingNames 706。**测试**=Go +4+前端 +4。**坑**=①裸 "0" 单价初版没解析成免费（正则只认「X CNY/张」）②gaeaCwd 全局态不可注入——cwd 参数化内函数③mock 尾部 rfind 锚点吞前方法闭合（插后必 tsc 即炸即修）。**门禁**=ci.ps1 全绿（vitest 3166/3166 一次全绿）；版本三处 4.329.0；产物=exe 50809856B SHA256=90e9ec5627b7c7304a11da30194971d528d87cb06cb15f563e3bbb25db7aad78（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=规格书+releases/v4.329.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（四十四迁）+progress/todos。**观察池**=来源板块细分；单价动态化；趋势图；work 并入成本归因。**未做（下刀）**=7.3-2 板块降视图（≈09-23 解锁）；绘梦阶段二规划拍板（模板市场/资产复用/一致性进阶）。
- **最新发布：v4.328.0（2026-09-17）「绘梦阶段一刀 D 核心片：章节配图管线 v2（角色参考图+风格槽）」**——用户指令「继续」。小刀单线主代理直做；契约先行（规格书随刀入库 进度计划/gaea-scene-illustration-v2-20260917.md）。论点=场景插图纯文生图（角色一致性只靠外貌文字、刀 B 参考槽没接到配图链、风格句写死）。**裁决**=签名扩展 GenerateSceneIllustration(chapterNum, optsJSON)（v4.139 Save 先例空串零变化，**绑定面 705 不变**）；参考路由按后端能力（comfyui/herdsman 附 RefImages img2img+SceneRefDenoise=0.6；其它后端 refNote 诚实降级提示不静默）；参考图=角色 PortraitURL（路径读盘转 dataURL 8MB 上限/无立绘跳过说明）；风格槽替换风格描述 16:9 构图固定；返回恒带 refNote。**落地**=chapter.Agent +GenerateSceneIllustrationV2（旧签名委托零变化）；chapter_handler opts 解析+sceneIllustrationRefs+readImageFileAsDataURL；前端弹窗风格输入+角色勾选+refNote 行，bridge/mock 双参。**修复挂载效应 bug：run 依赖选项后改选项自动重跑（每次键入触发生成）——didMountRun ref 守卫恢复打开即一次**。**测试**=Go +7（路由三态/零变化/坏 opts/路径转 dataURL）+前端 3 改 5。坑=fixture 须 a.ctx=context.Background（agent 持 a.ctx 直透后端，nil 在 fake ctx.Err() 解引用 panic）；fakeImageBackend +lastReq。**门禁**=ci.ps1 全绿（vitest 3162/3162 一次全绿；app 包首跑并行环境 flaky 复跑两次绿先例+1）；版本三处 4.328.0；产物=exe 50796032B SHA256=070f39f84f964b7d129b59e09ba68023d11a7c892d8d8932c4e736377a656c39（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=规格书+releases/v4.328.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（四十三迁）+progress/todos。**观察池**=书封参考与风格槽；素材库变体/替换/设为书封；灯箱共用；denoise 可调；多参考权重。**未做（下刀）**=绘梦阶段一收尾（刀 E 画室消耗）或 7.3-2 板块降视图（≈09-23 解锁）。
- **最新发布：v4.327.0（2026-09-17）「绘梦阶段一刀 C：指令编辑『改图』MVP（云端先行）」**——用户指令「继续」。小刀单线主代理直做；契约先行（规格书随刀入库 进度计划/gaea-instruct-edit-20260917.md）。前置核对=刀 A 资产面板（AssetStudio）/刀 B 参考槽（RefImages img2img）/刀 E 模型目录分层均已落，**刀 C 指令编辑是真缺口**（现状「改图」=结果填回图生图整幅重绘，无「原图+人话指令」语义编辑）。**裁决**=复用 ImageGenerationRequest（Mode="edit"+InitImage+Prompt 零新字段）；OpenAI 兼容后端 multipart POST /images/edits（Qwen-Image-Edit 系云端网关标准暴露面）；GLM/ComfyUI 诚实拒绝（本地档 B 计划；不静默降级为图生图——编辑语义≠整幅重绘）；app 层不加后端门透传；**零新绑定 705 不动**（GenerateMedia paramsJSON 加 mode）。**落地**=①image_openai.go：editImage 分支+parseImageResponse 三分支共用提取（行为零变化）+decodeDataURLBytes；glm/comfyui 拒绝②GenerateMedia edit 原图必填③前端 InstructionEditModal（指令+原图|新图对照+用到画布）+ResultStage「指令编辑」Action（单图/网格）+ImageGenPage 接线（onApply 前插 results/history 镜像 queue 成功路径，后端已落盘+台账）。**测试**=Go +5（multipart 形状/缺原图/两拒绝/app 校验+透传落盘）+前端 +4；ResultStage 5/5 零破坏。**门禁**=ci.ps1 全绿（vitest 3160 例，FilePreviewModal 1 例环境 flaky 隔离 15/15 绿——**同例两日两现可判常驻 flaky 候选**）；版本三处 4.327.0；产物=exe 50785280B SHA256=855b56f1ee1dc0f05959e6f004d40a828569c9d2ee33d0dcbd155e78a0499ae0（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**坑**=JSX 三元内首匹配 `<AssetLibrary` 插挂点破坏单父结构（挂点找弹窗区锚）；antd Modal open 父控——组件测试不断言 onClose 后卸载。**文档**=规格书+releases/v4.327.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（四十二迁）+progress/todos。**观察池**=mask/保留区域；ComfyUI 本地档；多图输入；edit-of-edit 谱系；刀 D 章节配图 v2/刀 E 画室消耗。**未做（下刀）**=绘梦阶段一余项（刀 D/刀 E 轻量收尾）或 7.3-2 板块降视图（≈09-23 解锁）。
- **最新发布：v4.326.0（2026-09-16）「GenerationGate 闭环收口：生成后自动分析门 + 全书体检」**——用户指令「继续」。小刀单线主代理直做；契约先行（规格书随刀入库 进度计划/gaea-gen-gate-closure-20260916.md）；阶段七 §4 在册项，7.3-2 仍等零功能周窗口（≈09-23）。论点=生成 done 只挂去味+AI 味分+角色提取，**分析路从不自动发生**——t1-P2 伏笔自动回收/t3-P1 记忆回填/t4 V2 落盘三条已建成管道的水源只能手动点，revolution「GenerationGate 完整闭环」未勾项即此。**裁决**=自动门异步非阻断默认武装（extractCharactersAfterChapter 同款 go 位；分析是加法数据幂等带审计）；只跑确定性三路+分析路一次 LLM（review/consistency 留单章门手动=成本纪律）；**分支章跳分析路**（主线口径防污染）；emit chapter-gate 事件 V1 零消费（t7 面板天然消费面）；全书体检纯确定性零 LLM 秒级。**落地**=①novel_book_health.go：buildAutoGateReport（同步可测：契约/质量/AI 味白名单后必出+分析路主线章跑失败 warn 降级）+runAutoGateAfterGeneration（go 位+recover 兜底+emit）；RunBookHealthCheck（逐章三路+字数+伏笔 Lint 复用+V2 覆盖；BookHealthReport camelCase，S1/S2 记阻断级）②create_chapter_handler done 后挂 go 位③NovelB +RunBookHealthCheck（**704→705**）④BookHealthPanel（CreatePage rail「全书体检」）：聚合卡+最差 AI 味≥60 告警指引去味复检+逐章表红标+伏笔 findings+零 LLM 脚注；锁 527→528；drift OK@705。**测试**=Go +5（自动门三例+体检两例含超长段落 S3 非阻断/契约 S2+S3+S4 计数/无大纲节点不计）；前端 +5。**门禁**=go build/vet 全过、app 全绿 147s -count=1、vitest 全量、版本三处 4.326.0；产物=exe 50774528B SHA256=0581c0be3ea4a61f33989eecf4ebd666a287cd648a10ec2a21e5da304aa5f83b（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**坑**=①analysis.New(nil client) Analyze 内 nil 解引用 panic——测试用无引擎真 client 走 error 返回②JSX 泛型不认索引访问须抽 type 别名③gateOutlineIssues 无大纲节点=无契约可违不计问题章。**文档**=规格书+releases/v4.326.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（四十一迁）+progress/todos。**出口对照**=生成后 V2/伏笔同步/记忆回填自动发生✅/全书体检聚合报告零 LLM✅/revolution 未勾项勾销✅。**观察池**=chapter-gate 事件 UI 消费；auto 分析 kill-switch；review/consistency 自动化成本拍板；体检 LLM 深检档。**未做（下刀）**=7.3-2 板块降视图（≈09-23）；闲庭在册清欠沿列车。
- **最新发布：v4.325.0（2026-09-16）「t7 前端统一接线收官：分析 V2 消费面板 + 标注高亮视图」**——用户指令「继续」。小刀单线主代理直做；契约先行（规格书随刀入库 进度计划/gaea-analysis-v2-panel-t7-20260916.md）。**本刀合入=小说·MuMu 蒸馏六域前端接线全清（t7 收官）**——伏笔面板 v4.299/重写建议 v4.305 已消费，本刀清掉最后两块零消费资产。论点=分析 V2（v4.301 九维落盘）与标注层（v4.306 keyword→rune 偏移）后端在位 UI 零消费；AnalyzeChapter 困在 drift.ts LegacySurfaceNames 零入口。**裁决**=NovelChapterAnalysisV2 回 types.ChapterAnalysisResult **直连**（顶层 snake 如实透传，不为只读面板复制九维子类型树）；缺章诚实 error「尚未分析」（面板空态接分析按钮闭环）；AnalyzeChapter 出 Legacy 转正（V1 返回忽略真相源=V2 落盘）；标注高亮 V1=**面板内只读高亮视图不动编辑器**（overlay 对 antd 样式同步脆弱入池）；rune→code-unit 换算（EditorPanel toRune 逆函数）+交叠裁剪+越界钳制。**落地**=①analysis_handler.go +NovelChapterAnalysisV2（703→704，NovelB 123→124）②bridge：AnalyzeChapter 出 Legacy+NovelChapterAnalysisV2+ChapterAnalysisV2View 视图（嵌套 snake 同落盘契约全字段缺省防御）+mock +2 桩③ChapterAnalysisPanel：头部综合分+三维+评分理由+chips+meta；分节=钩子/伏笔（埋·收徽标+长线+预计回收章）/冲突/情感/角色（存活异常 Tag）/组织（稀疏）/情节/场景/建议/小结空节隐藏；标注区 Segmented 列表|高亮视图（分类型软底 mark+悬停 title+列表行点击 scrollIntoView 锚点）④CreatePage rail「章节分析」+挂载。锁 525→527；drift OK@704。**测试**=Go +3（命中直连/缺章/无 agent）+前端 +8（九维渲染/分析闭环/交叠裁剪断言第二段起点钳 5/锚点滚动/无章不拉取/契约 3）；CreatePage 13/13 零破坏；tsc/eslint 零错。**门禁**=go build/vet 全过、app 全绿 146s、vitest 全量 3151 例（FilePreviewModal 1 例环境 flaky 隔离 15/15 绿先例+1）、版本三处 4.325.0；产物=exe 50756096B SHA256=6604f8e06b3f27cd586053794bfe22d8b881851e72210a7e7b0e2aeb22d89528（releases/gaea-v4.325.0.exe+SHA256SUMS-v4.325.0.txt；桌面副本同哈希；冒烟 /api/health 200 过）**文档**=规格书+releases/v4.325.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（四十迁）+progress/todos。**出口对照**=分析按钮→V2 落盘→九维可见✅/标注列表+只读高亮+锚点✅/AnalyzeChapter 出 Legacy✅/既有面零回归✅。**观察池**=编辑器 overlay 持久高亮；标注定位编辑器光标（需 ref 联动）；多章对比；情感曲线图形化。**未做（下刀）**=7.3-2 板块降视图（等 v4.318 零功能周≈09-23）；闲庭在册清欠沿既有列车。
- **最新发布：v4.324.0（2026-09-16）「t6-C2 提示词工坊第二刀：模板包导入导出（content_hash 三态）」**——用户指令「继续优化迭代 gaea」。小刀单线主代理直做；契约先行（规格书随刀入库 进度计划/gaea-prompt-bundle-t6c2-20260916.md；蒸馏依据 docs/distill/06-prompt-workshop.md §6.4「本域最有借鉴价值的一段算法」+§11.4）。论点=首刀覆盖表是只有一份的本地状态——换机/重装没有搬运手段、内置升级后没有对账工具；本刀补全量快照 JSON 包+三态导入（false+同基线→删覆盖行回落内置 kept_system_default/false+基线不同→转自定义 converted_to_custom/true→直接写行 created_or_updated）。**对 MuMu 升级**=导入行过 promptstore.Validate 真校验（error 级跳行不阻断整包——MuMu 导入零校验云端审核当唯一闸门，单机无审核链坏模板直接毒化生成链）+重复键跳过首见生效；**裁剪**=未知键不建行（工坊 V1 不支持自建键，与 Save 拒未知键同口径）。**裁决**=导出全量含内置行（备份语义）/覆盖行存在（无论启停）取覆盖行 Content 保真备份/导入不信包内 version 防倒退（本地 Upsert 自增）/哈希 sha256(TrimSpace)[:16] 只是导出侧冗余诊断对账用 canonical JSON 逐字比对（MuMu 同口径）/导出落盘走 saveExportBlob 双门（壳内 GaeaSaveFileAs/浏览器 a[download]，v4.162 先例）绑定只回 JSON 字符串/导入选文件壳内 pickFileAsFile(['json']) 浏览器动态 input 回退（SkillModal 刀C-3 同款）。**落地**=①线A internal/promptstore/bundle.go 零 IO 纯函数：ContentHash+SameTemplate（canonical JSON 稳定 map 键序不干扰）+BuildBundle（统计 total/customized/systemDefault）+ImportBundle 三态决策合并（入参不改写恒非 nil，写行路径统一过 Validate 闸）②线B gaea_prompt_store.go +2：PromptBundleExport（BuildBundle→MarshalIndent）/PromptBundleImport（坏 JSON·version!=1 报错；Applied 才原子落盘+invalidatePromptOverrides；空包不落盘不算错）；NovelB 门面 +2 ③线C 面板顶栏两钮（空态也可见——导入正是空环境恢复路径）：导出=Blob→saveExportBlob('gaea-prompt-bundle.json') 取消静默；导入=双门选文件→结果 Modal（统计一行+逐行 action 中文 Tag skipped_* 红/橙+原因）→applied 后 refreshList+定向刷新当前键；api/prompt.ts +2+mock/novel +2 桩+契约 +2。**绑定面 701→703**（NovelB 121→123；PromptBundle* 挂 *App 被默认路由 CoreB——gen_bindings 显式覆盖表 +2 点名归 novel，**v4.323 同款坑当日复现即修：跑 gen_bindings 后 bindings_core.go 出现非预期 diff 须查覆盖表而非还原文件**）；bindingNames 再生；play 锁 523→525。**测试**=Go +4 函数（三态矩阵 10 分支+round-trip 内核+canonical 稳定+统计与停用行保真；导出→清状态→导入覆盖逐字节回魂引擎生效+kept 删覆盖行+防御四例）+前端 +4（导出 Blob 断言/结果弹窗逐行+applied 刷新/取消不触发/契约 2）；tsc -b 零错、eslint 足迹零告警。**门禁**=go build/vet 全过、promptstore+app 全绿、vitest 全量 3143 例（首跑 PptxEditPanel 1 例环境 flaky 复跑绿——隔离复跑 8/8）、drift OK@703、版本三处 4.324.0；产物=exe 50734592B SHA256=5c1b3916518cd268f84ec9dfc6b61a3b3746c7d12f778151c1076736380d0abc（releases/gaea-v4.324.0.exe+SHA256SUMS-v4.324.0.txt；桌面副本同哈希；冒烟 /api/health 200 过）。**文档**=规格书+releases/v4.324.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（三十九迁；三十八迁条目 v4.323 已迁 v4.320 唯案行漏记本次不追改）+progress/todos。**出口对照**=干净环境导入覆盖逐字节回魂✅/内置升级三态分支钉死✅/坏模板行不落盘整包其余正常✅/绑定面 703 三处同步✅/壳内双门✅。**观察池**=项目级覆盖 scope；自建新模板键；系统模板升级合并交互；按书切换配方；Skill triggers；模板包签名/加密。**未做（下刀）**=t7 前端统一接线（小说线最后一域）；7.3-2 板块降视图（等 v4.318 稳定一个零功能周）。
- **最新发布：v4.323.0（2026-09-16）「t6 提示词工坊首刀：模板可编辑覆盖层（{{name}} 渲染+三级解析+工坊面板）」**——用户指令「继续优化迭代 gaea，记得使用子代理」。三线并行子代理（A 引擎纯函数 internal/prompt+promptstore+prompts / B handler gaea_prompt_store+装配接线 / C 前端面板三件，足迹互斥）→ 主代理收口；契约先行（规格书 进度计划/gaea-prompt-workshop-t6-20260916.md；蒸馏依据 docs/distill/06-prompt-workshop.md §5/§6/§9.3/§11）。论点=20 个 prompts/*.json 是「磁盘+embed」只读两层用户改不了、占位符只有 {word_count} 单点硬编码、保存零校验（MuMu §9.3 同型缺陷）。落地=①线A：Template +Version/Category/Description/Parameters（omitempty 零迁移）+RenderPlaceholders（{{name}} 缺失保留原文+记名不抛错）+Engine.SetOverride/Get 三级解析/Names 字典序；新包 promptstore 零 IO 六规则校验（empty-system/empty-task/brace-unbalanced/too-long=error；undeclared-var/legacy-brace=warn）+Upsert Version 自增；prompts ×20 元数据补齐+2 文件 {word_count}→{{word_count}}（引擎语义零变化）②线B：<DataRoot>/prompt_overrides.json（taskinbox 同款容错读+原子写）+覆盖缓存互斥+applyPromptOverrides 两装配点挂钩（SetPromptFS 重建必重挂）+懒构造基线引擎（Base 对照）+五 App 方法（List 零正文/Get 含 Base/Save 校验闸+未知键拒绝/Reset 幂等/Preview 草稿渲染）+substituteWordCount 双语法③线C：PromptWorkshopPanel 三区（九类分组列表+来源徽标/基线对照编辑+Issues error红·warn橙+恢复内置 Popconfirm/参数动态预览）+api/prompt.ts+CreatePage rail 入口+mock/novel 五档+契约测试 6 用例。**绑定面 696→701**（NovelB 116→121；PromptTemplate* 挂 *App 被默认路由 CoreB——gen_bindings 显式覆盖表 +5 点名归 novel，v4.291 先例；play 锁 518→523；bindingNames 再生）。**测试**=Go +22 测试函数（线A 15 含 20000·20001/65536·65537 rune 边界与 JSON 形状钉死；线B 7 含坏文件容错与缓存失效）+前端 +12（面板 6+契约 6；CreatePage 13/13、RewriteHistory 5/5 零破坏）；tsc -b 零错。**门禁**=ci.ps1 全绿 exit 0（go 130 包+vitest 367 文件 3138 例）、drift OK@701、版本三处 4.323.0；产物=exe 50754048B SHA256=1a712949e53414c308ae8a14f85de914d95e021b47fc9711f3ae3e880fdcf4d6（releases+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=规格书+releases/v4.323.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（三十八迁）+progress/todos。**出口对照**=20 模板可看可改可恢复（来源版本可见）/覆盖即时生效（eng.Get 三级解析全链共享）/保存真校验/{{name}} 统一旧语法兼容——全过。**观察池**=模板包导入导出（content_hash 三态，t6-C2）；项目级覆盖 scope；自建新模板键；Skill triggers；系统模板升级合并交互；风格注入与 novelstyle 打通。**未做（下刀）**=t6-C2 模板包导入导出 / t7 前端统一接线（小说线最后两域）；7.3-2 板块降视图（等 v4.318 稳定一个零功能周）。
- **最新发布：v4.322.0（2026-09-16）「t4-C3 收官：场景工程整章重写（单场景替换）」**——用户指令「继续」。小刀单线主代理直做；契约先行（规格书随刀入库 进度计划/gaea-scene-rewrite-20260916.md）。**产品裁决（单场景替换）**=整章新全文与原场景边界无法自动对齐，重写整章本就意味着重划结构——应用=新全文写回该章唯一场景，Restore 同语义对称；LLM 分场景回写/场景粒度重写入观察池。论点=此前对 v4 场景章直接拒绝不可达；根因=版本库 Apply/Restore 只写 blob 而 v4 真源 scenes/（单向同步）。落地=①Go 四处：移除 whole v4 拒绝+original 改 ReadChapterAsStitch（v3 fallback 零变化）；Apply/Restore 各 +rebuildScenesFromBlob（**复用 CreateChapter 整章重写完成点同款原语**，v3 no-op 零新机制）；partial 加 v4 守卫②前端：EditChrome +canRewrite 等可选 props+双按钮（仅 sceneBacked 页）；ChapterPage 挂 RewriteModal+RewriteHistoryPanel（onApplied→loadChapterIntoTab 重载）。**零新绑定 696 不动**。**测试**=Go +2（v4 两场景全链：重写→快照=stitch→Apply 收敛单场景+blob 同步→Restore 对称；partial 拒绝）+前端 +2（双按钮/时序等 V4 探测；v3 不渲染）11/11；tsc/eslint/gofmt 零错。**门禁**=ci.ps1 全绿 exit 0（go 129 包+vitest 365 文件）、版本三处 4.322.0、drift OK@696；产物=exe 50638848B SHA256=5b1b105ad81bff7b5dd391cc445aeda8cb77aed575a516c996e10441c38ea29e（releases/gaea-v4.322.0.exe+SUMS；桌面副本同哈希；冒烟 /api/health 200 过）。**文档**=规格书+releases/v4.322.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（三十七迁）+progress/todos。**出口对照**=v4 场景章重写全链可达 ✅；**t4-C3 余项全清**（whole v4.304/partial v4.321/历史面板 v4.320/场景 v4.322——三通道×两存储矩阵仅剩 partial×场景一格=守卫+观察池）。**观察池**=LLM 分场景回写；场景粒度重写（对齐去味逐场景先例）；partial 选段→场景映射。**未做（下刀）**=t6 提示词工坊/t7 前端统一接线（小说线最后两域）；7.3-2 板块降视图（等 v4.318 稳定一个零功能周）。
- **最新发布：v4.321.0（2026-09-16）「t4-C3 余项：partial 选段局部重写（版本库升级版）」**——用户指令「可继续」。三线并行子代理（A 引擎纯函数/B handler/C 前端三件，足迹互斥全部一次绿）→ 主代理收口；契约先行（规格书随刀入库 进度计划/gaea-partial-rewrite-20260916.md；蒸馏依据 docs/distill/04-plot-analysis.md §5.3）。论点=整章重写对「改一段」太重；partial=选区+指令+长度模式只重写选中片段前后文原样拼接。**对 MuMu 升级**=partial 也走版本库（全文快照可回滚——MuMu 局部重写无快照无 undo 系其 F5 缺陷）；全链 rune 口径。落地=①internal/rewrite/partial.go：ResolveSelection（rune 边界+±50 模糊重锚，顺手修 MuMu 两原缺陷：重锚负下界/start<0 纵深）+PartialLengthSpec 四档（similar/expand/condense/custom±20% 钳[50,10000]）+PartialMaxTokens（max(500,min(Max×3,8000))）+BuildPartialInstruction 四段固定序+NormalizeRequest partial 五规则（whole 零字节变化；类型名 PartialSpec 规避与构造函数同名）②novel_rewrite_handler.go：分叉抽 novelChapterRewritePartial 独立方法——重锚→±500 rune 上下文→同一 rewrite-chapter 模板（chapter_content 只给选段/systemPrompt 代区间上限）→MaxTokens=PartialMaxTokens→拼接（测试钉死前后文零变化）→版本落盘（Mode=partial+选区字段+全文快照+选段口径相似度）；RewriteRequest +SelectedText③前端：EditorPanel 选区读取（code-unit→rune 换算代理对钉死）+「局部重写」按钮；PartialRewriteModal 三态（应用走版本库 Apply/放弃 Discard）；CreatePage 挂载。**零新绑定**（reqJSON 契约早已先行）绑定面 696 不动。**测试**=rewrite 9 函数+app +3（含 partial 版本 Apply/Restore 走既有链路）+前端新增 6（合并定向 34 全绿）；tsc/eslint 零错。**门禁**=ci.ps1 全绿 exit 0（go 129 包+vitest 365 文件）、drift OK@696、版本三处 4.321.0；产物=exe 50638336B SHA256=c0f1abd770b4b4a2253c17e9c92d912f06f7992fbcbc62fe155e1e456a97fa7f（releases/gaea-v4.321.0.exe+SUMS；桌面副本同哈希；冒烟 /api/health 200 过）。**文档**=规格书+releases/v4.321.0.md（含线间对账）+CHANGELOG/README+AGENTS 迁 1 插 1（三十六迁）+progress/todos。**观察池**=选段高亮回写编辑器；流式输出（V1 同步）；deslop 入口（类型已留）。**未做（下刀）**=t4-C3 余项剩场景工程整章重写；t6 提示词工坊/t7 前端统一接线；7.3-2 板块降视图（等 v4.318 稳定一个零功能周）。
- **最新发布：v4.319.0（2026-09-16）「7.2-2 判据②收口：结晶技能调用计数（skill_stats）」**——用户指令「继续」。小刀单线主代理直做（体量一轮未拆子代理）；契约先行（规格书随刀入库 进度计划/gaea-skill-usage-stats-7-2-2-20260916.md）。论点=v4.317 出口判据②欠账「结晶技能调用 ≥5 次且成功率可见」：现状核实=技能计数是前端会话级（useToolStats 只算当前会话 run_skill，不持久、无成功率、漏 read_skill 主消费通道——boot 按需加载器才是结晶技能被「翻开来用」的时刻）；本刀补**工具级调用计数**：read_skill+run_skill 双钩子 → <DataRoot>/skill_stats.json 持久化 → GaeaSkillStats 绑定 → 能力面板技能行「N 次 · 成功率 X%」。诚实口径（V1）=成功率工具级（read_skill 交付正文/run_skill 管线无错=ok；读不到名也计 fail——技能名漂移如实计数不静默）；回合级成功率留观察池勿虚构；「≥5 次」使用事实门槛不做硬闸。落地=①新纯包 internal/skillstats（零 IO 表驱动先例 routesuggest/taskinbox）：Record（空名忽略/MaxSkills=500 新名拒收防漂移堆积/零值 File 自动建表）+View（calls 降序→name 升序稳定）+JSON camelCase 钉死②boot 双钩子：Options.OnSkillUse（缺省 nil 零行为变化，EmitSubagentText 先例）+sysprompt resolver 包装+run_skill 装饰器 skillUseCountTool（args.name 解析失败不计宁少勿扰；CompactDescriptor 回退语义同注册表缺省）③App：skill_stats.json route_suggestions 同款容错读（缺失/损坏/version≠1 回空表）+temp+rename 原子写+skillStatsMu 串行；recordSkillUse 包级回调（引擎 goroutine 零 App 状态依赖）；绑定 GaeaSkillStats（**OfficeB +1，695→696**）只读现算④前端：CapabilitiesPanel open 态拉 app.SkillStats 一次零轮询（reload 随引擎热加载刷新）→SkillsSection 可选 usage prop→SkillRow 徽标行灰字「N 次 · 成功率 X%」（data-testid=skill-usage-stat；缺省/零调用不渲染，会话计数 chip 语义不变）+SkillStatView（types/memory）+三语 +2 键（zh=en=zh-TW）+mock 桩+spaceBindings work+1（**锁 517→518**）。**测试**=skillstats 5 函数+app 3 例+前端 2 例；tsc -b 零错、eslint 零告警。**门禁**=ci.ps1 全绿 exit 0（go 129 包+vitest 363 文件全过）、drift OK@696、版本三处 4.319.0；产物=exe 50606592B SHA256=43739c69ad424a8356a0994525d3d4d93c4dc367e6037e00802bf249b0641de1（releases/gaea-v4.319.0.exe+SHA256SUMS-v4.319.0.txt；桌面副本同哈希；冒烟 /api/health 200 过）。**文档**=规格书入库+releases/v4.319.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（三十四迁）+progress/todos。**观察池**=回合级成功率（点赞点踩/重生成信号另刀）；蒸馏建议 tab 内联已结晶技能计数；两周后真机清池核「≥5 次」。**未做（下刀）**=7.3-2 板块降视图（等 v4.318 稳定一个零功能周）；闲庭在册清欠沿既有列车。
- **最新发布：v4.318.0（2026-09-16）「阶段七第五刀：多入口统一任务收件箱（任务持久实体+四入口存为任务+状态机追踪，7.3-1）」**——用户指令「继续推进」。契约先行（规格书随刀入库 进度计划/gaea-task-inbox-7-3-1-20260915.md：A/B/C 三线足迹互斥+出口对照）→ 三线并行子代理（三线一次绿无卡死接管）→ 主代理收口。论点=四入口（意图中枢/微信/语音/Ctrl+K）v4.5 已汇同一内核（intent.Parse→routeIntent），本刀补「任务」为**持久实体**+统一收件箱：指令除即时执行外可「存为任务」→ 状态机（待处理/进行中/已完成/已放弃）→ 跳回来源板块。**收件箱是清单不是调度器**（零轮询零定时器零后台事件，读写均用户动作触发=关闭即停拍板）；space 必带 work/play 隔离（跨空间仅显式，不做移动/复制）；不加新板块（挂既有双空间首页）。落地=①新纯包 internal/taskinbox（零 IO 表驱动，先例 skilldistill）：CanTransition 四条合法迁移（pending→doing→done、pending|doing→abandoned；终态拒迁同值恒 false）+NormalizeTitle（哨兵 ErrEmptyTitle、120 rune 截断）+ValidSource 五来源（ctrlk|palette|voice|weixin|inbox）+ParseTaskID（ti-+12hex 残渣防御）+FilterBySpace（''=全部）+Sort（状态组序→组内 UpdatedAt 降序→ID 稳定=行动优先）；9 测试函数 ~104 断言（JSON camelCase 形状逐字钉死）②intent 新动作 **save_task**（存为任务X/记个任务X/帮我添加一个任务X/任务：X/待办：X 首尾锚定两式，排提醒后让位；空标题不命中坠回聊天宁漏勿误；+9 表用例）+状态文件 <DataRoot>/task_inbox.json（{version:1,tasks:[]} camelCase，route_suggestions 同款容错读+temp+rename 原子写）+四绑定（OfficeB +4）：List（FilterBySpace+Sort 损坏回空表）/Save（id 空=新建 pending+ti-+12hex crypto/rand+超 500 拒；id 非空只改 title/note——**Source/Action/Target/Session/CreatedAt 不可变=来源审计链**；source 缺省兜底 inbox）/SetStatus（ParseStatus+CanTransition 同值短路零落盘）/Delete；执行层 execSaveTask：语音/微信走 routeIntent→space=gaeaEffectiveSpace() 归一回退 work、assistantID 判 weixin/voice、reply「已存入任务收件箱：<title>」（TTS/回推天然可用）；**Ctrl+K/面板不走后端执行**——dry-run 预览照常命中，前端直调 Save（带 shell 空间更准，两路来源可区分）；app 9 测试函数（camelCase 钉死禁 created_at 泄漏/500 上限/"WORK" 大写不泄漏/voice·weixin 双例/空间回退/dry-run 零落盘）③前端：TaskInboxPanel（antd Modal 四档 tab 计数、CanTransition 前端镜像非法组合按钮不渲染、action=navigate→去板块/session→回会话 V1 板块粒度、V3Empty 两分空态；9 用例）+双空间首页挂点（书斋 w-vitals 第五节 desk-task-inbox 待处理计数；闲庭 p-foot 第五节 garden-task-inbox 内联 gridColumn '1 / -1' 跨全列——固定四列网格零 CSS 改动，既有四节 testid 零变化）+四入口（Ctrl+K=SearchModal 指令卡〔存为任务〕次按钮+save_task「执行」短路直调 Save+intentReply 回执；意图中枢=命令面板 query 非空动态项「存为任务『query』」捕获期 input 监听镜像面板输入——组件契约不动，观察池列清退方案；语音/微信零前端改动）+lib/types 本地重述 TaskInboxView（herdsman 防环先例）+三语 +28 键（zh=en=zh-TW=1518 逐键相等，zh-TW 台湾惯用词）；ModuleLauncher「脉息四节」断言按规格更新五节（其余原样）④收口：bridge/core +4（同名前缀无需映射，GetProgrammingWebStatus 先例）+mock/chat 四桩（两空间样本内存态）+spaceBindings 四名 shared（隔离由 space 参数承担，UnifiedSearch 口径）+bindingNames 再生；gen_bindings 附带 bindings_novel.go 多行委托规整单行（+101/−101 零语义）。**绑定面 691→695**（OfficeB +4）；锁数 513→517（shared +4）；drift OK@695。**出口对账**=①四入口来源可区分 ✅（测试钉死）③空间隔离零泄漏 ✅④零常驻 ✅；②板块级 ✅、**会话级欠账**——按路径恢复 seam 存在（palette sessionItems→onResumeSession(path)）但活在 gaea App 树内首页拿不到，Session 字段已落库数据就绪后续刀接。**测试**=taskinbox 9+app 9+intent +9；前端 33/33（Panel 9+ModuleLauncher 12+SearchModal 8+锁数 4）+App palette/export 源级锁 6/6；tsc -b 零错、eslint 零告警。**门禁**=ci.ps1 全绿 exit 0 一次过、drift OK@695、版本四处 4.318.0；产物=exe 50592256B SHA256=63be1263d9077006a5b312f552abb2984787e9f4d3553ecaeb31bfdf3aaeb311（releases/gaea-v4.318.0.exe+SHA256SUMS；桌面副本同哈希；冒烟 /api/health 200 过）。**文档**=规格书入库+releases/v4.318.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（三十三迁）+progress/todos。**观察池**=命令面板 query DOM 捕获→CommandPalette 可选 prop 清退；精确回源会话接 seam；任务模板联动（GaeaTaskTemplates 从模板建任务）；LLM 兜底分类器对 save_task 覆盖；releases exe 留版数待用户拍板（沿 v4.315 观察项）。**未做（下刀）**=7.3-2 板块降视图（依赖本刀稳定一个零功能周）或 7.2-2 判据②调用计数小刀（statsFile 先例）；闲庭在册清欠沿既有列车。
- **最新发布：v4.317.0（2026-09-15）「阶段七第四刀：journal 历史蒸馏（重复模式挖掘+结晶审阅+审计链，7.2-2）」**——用户指令「继续并行使用子代理，优化迭代 gaea」。契约先行（规格书随刀入库 进度计划/gaea-journal-distill-7-2-2-20260915.md）→ A/B/C 三线并行 → 主代理收口；**A 线子代理跑满上下文零落盘——主代理接管代写**（卡死判据先例再+1：v4.316 B 线同款）。论点=journal 证据链（.gaea/work/journal/*.jsonl）是书斋审批链既有沉淀，把它变成程序性记忆矿床：确定性挖掘跨会话重复 ≥3 次的工具应用模式 → 建议卡只提示不打扰 → 点「结晶为技能」→ LLM 从多次执行回放蒸馏草稿 → 复用 7.2-1 审阅弹窗编辑落盘 → 决定与结晶全程审计——**7.2 技能结晶双入口齐装**（演示式录制 v4.313+历史蒸馏本刀）。落地=①新纯包 internal/skilldistill（零 IO 表驱动，先例 routesuggest）：MineFlows（会话聚合确定性排序）+Distill（连续同 (Tool,Shape) 折叠→会话级序列**精确匹配**分组→Repeat=不同会话数≥3→步数∈[2,12]→ignored 静默→截 3 宁少勿扰）+BuildPatternID（jd-+sha256 前 8hex 幂等）+ParsePatternID 残渣防御；V1 裁决=滑窗/子序列不进（观察池）②App 三绑定（OfficeB +3）：Candidates（journal 现算只读零 LLM，ignored∪crystallized 双静默）/Draft（buildJournalReplay ≤3 最近会话分段+AfterSummary 200 rune+整段 600 rune 防护→prompts/skill-from-journal.json（RTCO：**多次执行共性进步骤、差异进 cautions**、文件名通用化占位）→RetryJSON 2→复用 SkillRecordResult 只回不落盘）/Decide（ignore|crystallized；crystallized 必带技能名，审计条目=sessions+skill+decidedAt「哪次历史/谁确认/哪版」）；状态 <DataRoot>/skill_distill_state.json route_suggestions 同款容错读+原子写③前端：SkillDistillSection（PatternLine 步骤序+重复徽章+证据折叠+结晶/不再提示同卡互斥）挂 MemoryPanel 建议 tab「流程蒸馏」分区（props 全可选缺省隐藏）；SkillRecordModal 加 preload/onSaved（preload 直接回填不调内部蒸馏，缺省与 7.2-1 逐字节一致）；建议 tab 首开自动拉候选（收口补：C 线 distillView 初值 null 使 undefined 判据失效，主代理改 ref 守卫）；三语 memory.distill.* 11 键相等④收口：bridge/core +3（SkillDistillView 局部重述 herdsman 防环先例）+mappings+mock 三桩+spaceBindings work+3+bindingNames 再生。**绑定面 688→691**（OfficeB +3）；work 锁 510→513。**出口对账**=①只提示不打扰拒绝即静默 ✅③审计链完整 ✅；②结晶技能调用 ≥5 次且成功率可见=**欠账**（需调用计数机制 statsFile 先例另刀）。**测试**=skilldistill 15 例+app 10 例+前端 18 例（含收口补 preload 2 例）；tsc -b 零错、eslint 零告警。**门禁**=ci.ps1 全绿 exit 0（复跑：首跑 exit 1 无 FAIL——flaky 先例再+1）；产物=exe 50576384B SHA256=e5577402da81afbf0b0135631db066494aa7e415455da67eee2dbe9b0d5e3d2d（releases/gaea-v4.317.0.exe+SUMS；桌面副本同哈希；冒烟 200 过）。**文档**=规格书入库+releases/CHANGELOG/README+AGENTS 迁 1 插 1（三十二迁）。**观察池**=滑窗/子序列挖掘 V2 等真实数据；journal 回放纳入 verdicts 过滤；真机走查（同型任务×3→建议卡→结晶→新会话命中一条龙）挂闲置窗口。**未做（下刀）**=7.3-1 任务收件箱或 7.2-2 判据②调用计数小刀；闲庭在册清欠沿既有列车。
...
- **最新发布：v4.313.0（2026-09-15）「阶段七第二刀：会话录制技能（演示式录制，7.2-1）」**——平台调研验证形态（Anthropic Record a Skill 2026-07-21/OpenAI Record & Replay 2026-06-18 均已发布，SKILL.md 成事实标准 40+ 产品）。改造前已有单轮沉淀（GaeaCaptureSkill）与 procedural 记忆聚类候选两条通道，缺「会话级多轮回放→结构化草稿→审阅入库」。**落地**=①prompts/skill-from-session.json（RTCO 蒸馏纪律：只依据回放不虚构/步骤祈使句/通用化措辞；output=JSON 草稿）②internal/app/office_skill_record.go：buildSkillReplay 纯函数（GaeaHistory 多轮含工具事件→末段 60 条回放，600/200 rune 截断）+parseSkillDraft（kebab-case 归一/15 步上限/空步骤断拒）+renderSkillDraftBody（场景/步骤编号/注意事项）③绑定 GaeaSkillDraftFromSession（routeOfficeLocal 本地优先+RetryJSON，**只回不落盘**）+GaeaSkillDraftSave（审阅后落盘）④GaeaCaptureSkill 写盘段抽出共享 saveSkillFile（工作区+全局镜像+热加载同一落点同名覆盖）⑤前端 SkillRecordModal（打开即蒸馏→可编辑草稿+预览+回放折叠→保存）+Composer 工具栏 Wand2 入口（三语言键）+桥面 +2；绑定面 682→684（OfficeB 197→199，work 锁 506）。**纪律**=LLM 只产草稿落盘必经用户审阅。**测试**=Go 6 例+vitest 4 例；既有零改动。**坑**=①heredoc 内 Python 补丁 \n 双层解释变真换行破坏 TS 字符串——含转义补丁用 Edit 工具；②新绑定三件套勿忘 spaceBindings.test 锁总数 504→506；③go test 首跑 flaky 复跑全绿先例再+1；④gen_bindings 再生重排 novel 门面噪音 git checkout 还原。**门禁**=ci.ps1 全绿 exit 0（复跑）、drift OK@684、版本四处 4.313.0；产物=exe 50439168B SHA256=1e1b86665434241e9ced0801fb6d977e7aeb27a0883a3da48ee9d07698f90c6d（releases/gaea-v4.313.0.exe+SHA256SUMS-v4.313.0.txt；桌面副本同哈希；冒烟 200 过）。**未做（下刀）**=7.1-2 路由学习或 7.2-2 journal 历史蒸馏；闲庭在册清欠沿既有列车。
- **最新发布：v4.312.0（2026-09-15）「阶段七首刀：记忆质量受控评测（三脑四域零依赖基线+经验习得题集，7.1-1）」**——阶段七规划（docs/gaea-stage7-plan-2026-09.md，2026-09-15 拍板启动）首刀，闭合在册开放增量「记忆质量可评测」（对齐物升级为 BEAM/LongMemEval-V2）。改造前三脑记忆域检索质量零量化——记忆不可信则 7.2 技能结晶的复用成功率不可测。**落地**=①新包 internal/memoryeval（纯函数+种子语料零外部依赖）：Evaluate（recall@10 门槛 0.8 沿 T5-6 口径+precision 均值）+ParseSet/ResolveSetPath；②三域 runner 全走生产检索路径：story=internal/memory 纯 Go BM25、work=internal/gaea/bm25 Ranker、persona=whisper SQLite FTS（含中文 2-gram LIKE 降级——评测即生产真实能力）；③**经验习得题集 22 题**（≥20 达标，LongMemEval-V2「习得未来任务所需经验」方向）：查询为未来任务口吻，期望命中=承载经验的记忆条目——7.2 技能结晶评测基建预置（whisper procedural_habits 表是远期接口）；④种子语料 needle-in-haystack：story 12 目标+40 陪衬/work 12+28/persona 10+20/experience 22；题集与种子 ID 漂移由测试硬断言兜住。**测试**=memoryeval 4 例（解析/数学/结构硬断言/基线软告警——低于门槛只 [WARN] 不阻断）；既有零改动。**基线**=四域 recall@10 全 1.000（precision 均值 0.433/0.478/0.661/0.727）落档 docs/memory-eval-set.md；**评测产出真实发现**：persona 泛主语查询淹没（「用户」二字组 LIKE 命中全部事实、top-10 灌满、单条 precision 0.1）——生产弱点记录在档不动引擎（候选改进：2-gram IDF 加权或跳过通用主语词）。**门禁**=ci.ps1 全绿（vitest 首跑 ContextView 类 flaky 28 例、全量复跑 356 文件/3064 测试全过——flaky 复跑先例再+1）、零绑定面 drift OK@682、版本四处 4.312.0；产物=exe 50414080B SHA256=c41c22f447b1a86d3f4db6464a1c9202b016de1a4a66250694a9f2f1ebbbdb8e（releases/gaea-v4.312.0.exe+SHA256SUMS-v4.312.0.txt；桌面副本同哈希；冒烟 /api/health 200 过）。**文档**=docs/memory-eval-set.md+docs/README.md 三档登记（含 stage7 规划/平台调研）+releases/CHANGELOG/README+AGENTS 速览（迁 1 插 1）。**未做（下刀）**=7.1-2 路由学习（任务级成本归因+建议制改绑）或 7.2-1 演示式录制（无依赖可先行）；闲庭在册清欠（t4-C3 余项/t6/t7/GenerationGate 收口）沿既有列车。
...
## 速览迁入（2026-09-16，v4.320.0 水位分流·三十八迁）
- **最新发布：v4.320.0（2026-09-16）「t4-C3 余项：重写版本历史面板（版本库前端消费）」**——用户指令「继续」。小刀单线主代理直做（纯前端后端零改动）；契约先行（规格书随刀入库 进度计划/gaea-rewrite-history-panel-20260916.md）。论点=v4.304 版本库只有「刚重写完那一刻」的 RewriteModal 能操作，NovelListRewriteVersions/NovelGetRewriteVersion 两绑定**零 UI 消费**——关弹窗/换会话后历史版本不可看不可用（v4.305「用户到不了的功能等于没有」同型）。落地=①RewriteHistoryPanel（components/novel，antd Modal 硬编码中文=小说域口径）：open 拉一次零轮询；行=时间+模式 Tag（整章/局部/去味）+状态 Tag+相似度%；**多行可同时展开**（Set 态版本对比友好）；详情懒拉 Get（缓存）=指标行（字数/相似度/AI 味分 before→after）+新文预览+原文快照 Collapse②动作镜像后端状态机门控（前端只禁用不裁决）：completed→应用（Popconfirm 显式 okText）+放弃；discarded→应用（后端升级语义可再应用）；applied→恢复原文；pending/running/failed 只读；成功 message+重拉+onApplied 刷新正文（RewriteModal 同口）③CreatePage rail「整章重写」后加「重写历史」（无徽标打开才拉）④mock List 两样本+Get 配套全文，Apply/Discard/Restore 保持抛错（诚实）。**零后端改动**：绑定面 696 不动锁数不动 gen_bindings 不跑（drift OK@696）。**测试**=RewriteHistoryPanel 5 用例（列表/空态/懒拉/门控镜像/应用闭环）+CreatePage 既有 13/13 零破坏；tsc -b 零错 eslint 零告警。**门禁**=ci.ps1 全绿 exit 0（go 129 包+vitest 364 文件全过）、drift OK@696、版本三处 4.320.0；产物=exe 50613248B SHA256=4bc1d56d44a5f97a92fde68d1fb8b18026dec5d0c4a8c6fec19731fca8dca837（releases/gaea-v4.320.0.exe+SHA256SUMS-v4.320.0.txt；桌面副本同哈希；冒烟 /api/health 200 过）。**文档**=规格书入库+releases/v4.320.0.md+CHANGELOG/README+AGENTS 迁 1 插 1（三十五迁）+progress/todos。**出口对照**=版本库五绑定全部有 UI 消费 ✅ 跨会话找回历史版本可达 ✅。**观察池**=双栏 diff 视图（V1 单侧预览）；partial 入口随 partial 刀；按模式/状态过滤。**未做（下刀）**=t4-C3 余项剩 partial 局部重写+场景工程；t6 提示词工坊/t7 前端接线；7.3-2 板块降视图（等 v4.318 稳定一个零功能周）。

- **最新发布：v4.387.0（2026-09-22）「ComfyUI 未运行自动拉起：原罪插图/绘梦生成连接被拒自愈」**——用户报障「原罪插图失败：ComfyUI 提交失败…connectex 拒连」。两层根因：环境层=ComfyUI 没跑且 standalone-env 落后于仓库 requirements（comfy-aimdo/kitchen 等一族过期，起都起不来）；产品层=生成链只对「孤儿实例 [Errno 22]」自动恢复，服务压根没跑直接 connectex 原始错误失败——原罪页无恢复入口（绘梦页才有启动按钮）。Go 1 文件+测试，绑定面 712 零变更。**落地**：①ensureComfyUIRunning 助手（未运行→StartComfyUI→/system_stats 就绪轮询有界 120s；未配置路径/启动失败/超时=返回 false 原始错误如实上抛不吞错）接线 generateImageInternal 重试分支（错误含「连接 ComfyUI 失败」dial 层文案才触发——服务在但卡死不进防误杀；comfyBooted 闸一轮一次；并发竞态由 StartComfyUI 端口占用守卫兜底转就绪等待）；原罪插图与绘梦共用本链一处接线双板块受益②环境修复（用户本机随刀处置）：按 requirements 钉版精确补 comfy-aimdo==0.5.5/kitchen 0.2.35/embedded-docs 0.5.11/frontend-package 1.52.7/workflow-templates 0.11.62（刻意不 pip install -r——torch 无钉版行会重解析，ROCm 特制 torch 可能被顶掉）；修后 gaea 同配方拉起 ~30s 就绪（ComfyUI 0.36.0）用户当前会话重试即恢复。**测试**=Go +3（零真进程：连接被拒→假就绪端点→重试恰一次〔计数=2〕/未配置路径不重试原始错误上抛/ensure 三分支契约）。**门禁**=internal/app 全量绿+全量 ci 绿 EXIT=0+版本漂移闸 OK@4.387.0。**坑**=①ComfyUI 仓库更新不自动升级 python 环境——comfy-* 过期是一族的（先爆 aimdo storage 缺失修完又爆 kitchen int8_attention），逐包补不如按钉版一次补齐②修 python 环境别 pip install -r③错误文案是重试路由的锚——新增分支先确认文案唯一锚定目标场景④测试成功路径必设 ImageSaveDir 指临时目录（否则 saveToNovelImages 撞装配态 nil）。**产物**=exe 51163136B SHA256=f7ec8eb3…e17b（SUMS-v4.387.0.txt，仅本地；冒烟 200 过；桌面副本因用户会话在跑未覆盖，关闭后替换）；保留策略删 v4.382.exe。**文档**=releases/v4.387.0.md（含升级说明）+CHANGELOG/README+releases/README（计数 408→409+34 席插 v4.387 裁 v4.353）+AGENTS 迁 1 插 1（一百零二迁：v4.384 入 archive）+progress/todos。

- **最新发布：v4.388.0（2026-09-22）「原罪插图独立生图绑定：功能绑定卡新增『原罪插图』后端/模型选择」**——用户反馈「原罪的功能绑定卡增加生图模型选择，这么多模型为什么没有候选，只能 comfyui？」。两层根因：原罪生图无独立绑定跟随全局生图设置（本机全局=comfyui）、模型中心原罪卡只绑故事文本模型；生图候选一直在（剧照卡同款）只是原罪没入口。镜像「角色库剧照」先例补上。Go 6 文件+前端 9 文件，绑定面 712→714（+2）。**落地**：①GetSinImageConfig/SetSinImageConfig（sin_image_backend/model，空=跟随全局任一项可单独回退）+shelf 热更新②buildImageClientFor 从剧照客户端通用化（五后端独立客户端不动绘梦全局）+generateImageInternal override 通道（进度回调/size 裁剪/ComfyUI 自动恢复与拉起分支统一按生效后端判定）+SinIllustrate 级联 sinImageBinding（绑定>全局）与 sinRefPlan 用生效值，sin_illustrate 工具同入口受益③模型中心新增「原罪插图」卡（后端下拉含 GLM 六选项+模型下拉跨引擎候选）。**测试**=Go +4 组（级联四态/Get 回读/构建分支/override 通道〔override=1 全局零触碰〕）+前端 +1（卡渲染+保存+已绑定态）。**门禁**=全量 ci 绿 EXIT=0+漂移闸 OK@4.388.0+spaceBindings 535→537+bindingNames 714。**坑**=①config.Save 直写真实 ~/.gaea_config.json 无隔离钩子——Set roundtrip 不能真调，测读映射与纯函数级联②种子引擎目录恒 Enabled——测未启用分支先 SaveEngine 禁用③override 客户端后端语义要跟到底（进度回调/size/自动拉起原读 a.cfg.ImageBackend，漏一处=换客户端没换行为）。**产物**=exe 51171328B SHA256=48f1a288…141e1（SUMS-v4.388.0.txt，仅本地；冒烟 200 过；桌面副本同哈希）；保留策略删 v4.383.exe。**文档**=releases/v4.388.0.md（含升级说明）+CHANGELOG/README+releases/README（计数 409→410+34 席插 v4.388 裁 v4.354）+AGENTS 迁 1 插 1（一百零三迁：v4.385 入 archive）+progress/todos。
...
- **最新发布：v4.394.0（2026-09-23）「绘梦·扩图（outpaint）：画布加边，模型补全新区域」**——图像域长期规划 T3「扩图」；v4.393 观察池销号。经济路线：扩图 ≡ 合成大画布（原图锚定+新区域填中性灰）+灰度蒙版（扩边环白）= v4.393 已打通的 edit+mask 请求形态，两后端零引擎改动。Go 3 文件+前端 3 文件，绑定面 714 零变更。**落地**：①internal/ai image_outpaint.go（新）ComposeOutpaint 纯函数（四边百分比 0-200 钳制/画布 orig×(1+(L+R)/100)/锚点按扩展量/新区域中性灰 128/蒙版原图区黑+扩边环白/>4096² 拒）+OutpaintToSquare 补正方②app：mode=outpaint+expand →ComposeOutpaint 转 edit 请求下发（fail-closed 天然满足/mode 回显 outpaint/清空 size 画布即输出）；三门（缺原图/用户 mask 互斥先于通用门/合成失败如实上抛）③前端 Modal 三态（全图/局部/扩图）+6 预设 chips+四边 InputNumber+虚线扩边框预览；零扩展 warning。**测试**=ai +3+app +1+前端 +1；全量 396 文件 3354 例绿+tsc 0+eslint 0。**门禁**=全量 ci 绿 EXIT=0+漂移闸 OK@4.394.0。**坑**=夹具 RGBA 忘 A:255 是透明色贴图必挂/补正方百分比基数是短边原长（总=(长-短)/短×100）/gate 顺序互斥门要在通用 mask 门之前/测试期望先口算。**产物**=exe 见 SUMS-v4.394.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.389.exe。**文档**=规格 进度计划/gaea-outpaint-20260923.md+releases/v4.394.0.md+CHANGELOG/README+releases/README（415→416+34 席插 v4.394 裁 v4.360）+AGENTS 迁 1 插 1（一百零九迁：v4.389 入 archive）+progress/todos。

- **最新发布：v4.404.0（2026-09-23）「角色一致性评分 v1（文字锚点，T2 一致性收口刀）」**——用户拍板解锁挂池项。绑定面 716→717（+CharacterScoreConsistency，play；spaceBindings 540）。**落地**：①视觉 LLM 拿图对照 Appearance/Figure 打分（0-100+总评+issues），复用 vision.RecognizeImage 单图链路零改动；无外观降级可用②data URL 经临时文件走既有链（scoreImageToLocalPath 助手独立测）；解析围栏容错+钳位+坏回复带原文报错；seam 可注入③编辑器参考图「评分」钮→Modal 分数+issues；<60 提示补参考；单飞。**测试**=Go 纯函数+解析七态+seam 全链；前端两态；全量 ci 绿 399 文件 3374 例。**坑**=antd Modal.info 标题父子双匹配断言走 .ant-modal-title 取最后（imperative Modal 不随 cleanup 卸载）/seam 测试断言规整前输入——转换抽助手独立测。**产物**=exe 见 SUMS-v4.404.0.txt（冒烟 200 过；桌面同哈希）；保留策略删 v4.399.exe。**文档**=规格 进度计划/gaea-consistency-score-20260923.md+releases/v4.404.0.md+CHANGELOG/README+releases/README（425→426+34 席插 v4.404 裁 v4.370）+AGENTS 迁 1 插 1（一百一十九迁：v4.399 入 archive）+progress/todos（观察池=图vs图评分/sin 入口/评分写回/自动重生成）。
- **最新发布：v4.403.0（2026-09-23）「sin 侧设定卡入口（T2 角色资产 v2 收尾刀）」**——观察池在册项，纯前端编排绑定面 716 零变更。**落地**：右栏角色 chip 新增设定卡钮（单击=triptych 快路径，全矩阵留角色库）→getCharacter 取全量→qedit 三视图→追加 referenceImages→saveCharacter 自动存回→reloadLibrary；chip 级单飞；面板吞错页面层 message（契约）；prop 可选未传不渲染。**测试**=SinCastPanel 3 例+SidePanel 夹具补 prop；全量 ci 绿 399 文件 3372 例（首轮 ProgrammingPage 负载 flaky 隔离绿）。**坑**=面板可选回调 runSheet 只 finally 会漏 unhandled rejection 须 catch（vitest 报 Errors 但 pass）/toBeDisabled 非本项目断言面用 hasAttribute。**产物**=exe 见 SUMS-v4.403.0.txt（冒烟 200 过；桌面同哈希）；保留策略删 v4.398.exe。**文档**=规格 进度计划/gaea-sin-sheet-entry-20260923.md+releases/v4.403.0.md+CHANGELOG/README+releases/README（424→425+34 席插 v4.403 裁 v4.369）+AGENTS 迁 1 插 1（一百一十八迁：v4.398 入 archive）+progress/todos。
- **最新发布：v4.402.0（2026-09-23）「设定卡分张连发（T2 角色资产 v2 第三刀）」**——v4.401 观察池头名。纯前端编排，绑定面 716 零变更。**落地**：①菜单「三视图分张（连发）」正/侧/背串行排队逐张追加（产物即到即见+N/3 进度）②失败语义：首张失败即中止（系统性故障不三连报错），中途失败继续+结束 warning 点名可单张重试（无自动 retry）③sheetGuard 收敛共用。**测试**=前端 3 例（全成功/首张中止/中途继续）；全量 ci 绿 398 文件 3369 例。**产物**=exe 见 SUMS-v4.402.0.txt（冒烟 200 过；桌面同哈希）；保留策略删 v4.397.exe。**文档**=规格 进度计划/gaea-char-sheet-split3-20260923.md+releases/v4.402.0.md+CHANGELOG/README+releases/README（423→424+34 席插 v4.402 裁 v4.368）+AGENTS 迁 1 插 1（一百一十七迁：v4.397 入 archive）+progress/todos。
- **最新发布：v4.401.0（2026-09-23）「设定卡模板矩阵 + 多参考锚定（T2 角色资产 v2 第二刀）」**——v4.400 观察池头名（多姿势/分张）+qedit 三图槽自然消费。签名扩展 (chJSON, variant)，绑定面 716 零变更。**落地**：①六模板（triptych 默认/front·side·back 单视图分张·sitting·action），非法 variant 如实报错②多参考锚定：参考图逐张收≤3 填满 image1..3，剧照兜底，单张失败跳过③前端 Dropdown.Button 主按钮三视图+箭头菜单④**顺手根修 v4.400 按钮同点位重叠**（两按钮同用 .cd-hero-gen absolute 定位）——.cd-hero-gens 堆叠容器。**测试**=纯函数矩阵+假 ComfyUI（2 可用 1 缺失→上传恰 2 次/variant 透传/非法报错）+前端菜单两态；全量 ci 绿 398 文件 3367 例。**坑**=NodeList 解构 tsc -b 报 TS2488 须 Array.from（CI 首轮抓出）/Dropdown.Button 的 testid 挂 wrapper 须 querySelector 取真按钮/新按钮抄旧 class 先核对是否承担布局定位。**产物**=exe 见 SUMS-v4.401.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.396.exe。**文档**=规格 进度计划/gaea-char-sheet-v2-20260923.md+releases/v4.401.0.md+CHANGELOG/README+releases/README（422→423+34 席插 v4.401 裁 v4.367）+AGENTS 迁 1 插 1（一百一十六迁：v4.396 入 archive，头部迁入记录行补 105~115 漏登案）+progress/todos。
- **最新发布：v4.400.0（2026-09-23）「角色设定卡生成（三视图，qedit 通道 · T2 角色资产 v2 首刀）」**——复用 v4.398 qedit+characterlib 参考图画廊（零 schema）。绑定面 715→716（+CharacterGenerateSheet，play；spaceBindings 538→539）。**落地**：①buildCharacterSheetPrompt 纯函数（三视图并排+外观锚点 160 rune）②CharacterGenerateSheet：首张参考图（其次剧照）→qedit→data URL 不自动保存；非 comfyui/无参考如实报错③前端 Editor 剧照按钮旁「生成设定卡」——产物追加进参考图列表（保存时后端落盘同手动上传管线）。**测试**=Go prompt 纯函数+httptest 假 ComfyUI 全链+两态报错；前端按钮两态；全量 ci 绿+tsc 0+eslint 0。**坑**=buildPortraitClient 独立建客户端注入 core.client 不生效须假 ComfyUI 全链/renderEditor 助手吃 {character} 包装传裸角色静默不命中/prompt 文案与断言用词先对齐。**产物**=exe 见 SUMS-v4.400.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.395.exe。**文档**=规格 进度计划/gaea-char-sheet-20260923.md+releases/v4.400.0.md+CHANGELOG/README+releases/README（421→422+34 席插 v4.400 裁 v4.366）+AGENTS 迁 1 插 1（一百一十五迁：v4.395 入 archive）+progress/todos。
- **最新发布：v4.399.0（2026-09-23）「原罪插图参考升级 qedit（T2 第二消费方）」**——v4.398 观察池头名小刀：sinRefPlan 单点升级——原罪插图角色一致性从 img2img 整幅重绘近似升到 Qwen 参考编辑（参考图进编辑引擎三图槽，prompt 即场景描述，构图不再被参考锁死）。纯 Go 2 文件，绑定面 715 零变更。**落地**：comfyui 分支→(txt2img,qedit)（编辑引擎独立于生图模型不再判型，flux 等也可用）；herdsman 维持 img2img；权重缺失由既有 refFallback 链兜底（退纯文本+标注）；v4.258 纪律（文本锚点/角色选择/互串防护）不动。**测试**=矩阵更新+refMethod 断言补强+透传期望+TestSin 全量回归；全量 398 文件 3365 例绿。**门禁**=全量 ci 绿 EXIT=0+漂移闸 OK@4.399.0。**产物**=exe 见 SUMS-v4.399.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.394.exe。**文档**=规格 进度计划/gaea-sin-qedit-20260923.md+releases/v4.399.0.md+CHANGELOG/README+releases/README（420→421+34 席插 v4.399 裁 v4.365）+AGENTS 迁 1 插 1（一百一十四迁：v4.394 入 archive）+progress/todos。
- **最新发布：v4.398.0（2026-09-23）「绘梦·参考槽 Qwen-Edit 通道（T2 一致性首刀）」**——路线修订：krea2/z-image（Qwen-Image 架构）无 IP-Adapter 生态，一致性正路=Qwen-Image-Edit 2511 原生 3 图参考槽。病根两层：参考槽 v0 是 img2img 整幅重绘（构图被参考锁死）+队列 txt2img 丢参考（「新场景+角色一致」无通道）。Go 3 文件+前端 5 文件，绑定面 715 零变更。**落地**：①comfyResolveRefMode +qedit（ipadapter/pulid 改口指向 qedit）②builder images[] 签名——参考 1..3 各自 LoadImage+FluxKontextImageScale 进正/负 TextEncode 的 image1/2/3（官方口径）；蒙版不与 qedit 组合 fail-closed；>3 拒③app：txt2img+qedit 元数据如实记 qwen-image-edit；txt2img 透传 refs/refMethod④前端：ControlPanel 一致性方法 Radio（图生图近似=默认保持/**Qwen 参考编辑**=新）；applyRefCharacter 分流（qedit 保持 txt2img 不切图生图）；queue 打通 txt2img+qedit 带参考。**测试**=ai +2（路由矩阵/qedit 工作流形状）+edit/蒙版回归绿+app +1+前端 +2；全量 398 文件 3365 例绿+tsc 0+eslint 0。**门禁**=全量 ci 绿 EXIT=0+漂移闸 OK@4.398.0。**坑**=代码块搬家用块尾注释找边界（含糊边界两块一起切走 panic 才暴露）/regex 中插截断泛型尾巴插完必 tsc/既有缺省行为是契约（新方法并列露出不顺手改）。**产物**=exe 见 SUMS-v4.398.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.393.exe。**文档**=规格 进度计划/gaea-qedit-ref-20260923.md+releases/v4.398.0.md+CHANGELOG/README+releases/README（419→420+34 席插 v4.398 裁 v4.364）+AGENTS 迁 1 插 1（一百一十三迁：v4.393 入 archive）+progress/todos（T2 首刀落，余=角色资产 v2/LoRA 向导/导演 Agent）。
- **最新发布：v4.397.0（2026-09-23）「绘梦·抠图/透明底导出（T3 编辑力收官）」**——长期规划 T3 四件（局部重绘/扩图/变体簇/抠图）全部落地。零新模型：蒙版即 alpha（ComposeCutout 纯函数，**抠图蒙版语义白=保留主体黑=透明**——与编辑白=重绘相反，两原语各自契约文档化）。Go 3 文件+前端 5 文件，绑定面 714→715（+ImageCutout，play；spaceBindings 锁 537→538）。**落地**：①image_cutout.go 逐像素合成硬边+边界如实报错②mediaState.ImageCutout：落盘 ImageSaveDir→台账登记（v4.396 修复后闸正常）→{path, asset_id}③CutoutModal（复用 MaskBrushEditor「涂抹要保留的主体」）+ResultStage「抠图」动作+接线④wailsjs/bindingNames 再生（**真实消费文件是 src/gaea/lib/bindingNames.ts，根级 src/bindingNames.ts 系无人引用陈旧副本顺手删**）。**测试**=ai +2+app +1+前端 +3；全量 398 文件 3363 例绿+tsc 0+eslint 0。**门禁**=全量 ci 绿 EXIT=0+漂移闸 OK@4.397.0+绑定面 715。**坑**=bindingNames 两份先找 import 链（drift.ts 用 ../bindingNames=gaea/lib 那份）/bindings_image.go 历史单行风格 gofmt -w 整文件重排 80 行噪音须手工单行/字符串 replace 插 JSX 嵌进条件块插完必 tsc。**产物**=exe 见 SUMS-v4.397.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.392.exe。**文档**=releases/v4.397.0.md+CHANGELOG/README+releases/README（418→419+34 席插 v4.397 裁 v4.363）+AGENTS 迁 1 插 1（一百一十二迁：v4.392 入 archive）+progress/todos（T3 收官，画室线转 T2 一致性：ipadapter/pulid、角色资产 v2、LoRA 向导、导演 Agent）。
- **最新发布：v4.396.0（2026-09-23）「纯绘梦会话台账登记根修（真机走查抓出）+ 编辑四件套真机验收班」**——用户拍板「可行」的真机验收班战果：编辑四件套（v4.392~395）真机一条龙，变体徽标未现顺藤抓出 v4.98 起潜伏真缺陷：imageHubLedgerRuntimeCheck=armed&&gaeaCfgSnapshot()!=nil，而 ga.cfg 只在办公引擎 GaeaInit 赋值——纯绘梦会话恒 nil→闸误判非运行态→台账静默跳过（素材库恒空/变体簇断/asset_id 恒空）。Go 1 文件+1 测试，绑定面 714 零变更。**落地**：闸判据只留 armed 位+回归测试（armed+cfg==nil→登记落盘）。**验收班全过**：krea2 源图生成（WS 节点进度）/弹窗三态/涂抹交互（2 笔+像素实测）/扩图面板（6 预设+预览+读数）/缺权重错误即安装指引（三件文件+HF 链接）/权重就位后本地档真图编辑成功（ComfyUI mtime 缓存自动重扫免重启；20B fp8mixed 首载 ~400s，Radeon 8060S）。**坑**=权重下载三源对比（HF/镜像 2-5MB/s 限速 vs **ModelScope 单连接 33MB/s**——国内大模型文件首选 ModelScope）/分段脚本坑三连（curl -C - 与 -r 互斥/重试追加超长单段重下/du 混不存在路径整体错）。**产物**=exe 见 SUMS-v4.396.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.391.exe。**文档**=releases/v4.396.0.md+CHANGELOG/README+releases/README（417→418+34 席插 v4.396 裁 v4.362）+AGENTS 迁 1 插 1（一百一十一迁：v4.391 入 archive）+progress/todos。**走查班挂池**=变体徽标/溯源链修复后重验、蒙版局部真图（圈外保持）、扩图真图、走查产物清场。
- **最新发布：v4.395.0（2026-09-23）「绘梦·编辑历史变体簇：ParentID 链 + 溯源，回到任一变体继续改」**——长期规划 T3「编辑历史形成变体簇」；T0 契约 AssetMeta ParentID 预留位激活。病根：编辑三件落地后编辑链 A→A'→A'' 天然成链但不可见——台账无关系字段、前端无变体标识，改三轮无法回到第 2 版分叉。Go 7 文件+前端 5 文件，绑定面 714 零变更（读走既有 ImageHubAssets 只读绑定）。**落地**：①关系键=台账 parent_id——编辑/扩图带 sourcePath（源图 file_path），imageHubAssetIDByPath 同空间倒序查 id 作 ParentID，查不到留空=诚实断链；旧 JSONL 零值空兼容②登记链路 +parentID 参数（chapter/portrait/bookcover/sin 调用点传空）；meta/view 双侧加字段③imageItem 回传 asset_id/parent_id（登记后 byPath 反查；闸关空零影响）④前端 GenResult/MediaParams 透传+变体徽标+溯源按钮⑤新 VariantChainModal：拉台账建链（parent_id 上溯防环 64 代）根→当前正序+缩略图懒加载+第 N 代标记+「用到画布」回到任一祖先继续改+断链 Alert。**测试**=Go +2（往返+byPath 边界/GenerateMedia sourcePath 闸关态）+前端 +4+2；全量 397 文件 3360 例绿+tsc 0+eslint 0。**门禁**=全量 ci 绿 EXIT=0+漂移闸 OK@4.395.0。**坑**=批量 replace 命中同名 meta 构造块（diagram 也中招编译炸）——机械改签名先数命中数/测试用例放错文件按包依赖挪文件而非加 import/gofmt 漂移只 -w 触碰文件（存量不动）。**产物**=exe 见 SUMS-v4.395.0.txt（仅本地；冒烟 200 过）；保留策略删 v4.390.exe。**文档**=规格 进度计划/gaea-variant-chain-20260923.md+releases/v4.395.0.md+CHANGELOG/README+releases/README（416→417+34 席插 v4.395 裁 v4.361）+AGENTS 迁 1 插 1（一百一十迁：v4.390 入 archive）+progress/todos。
...
- **最新发布：v4.408.0（2026-09-25）「sin 设定卡 chip 进度行+取消钮」**——图像等待体验线程 sin 侧收尾（v4.407 观察池头名+v4.406「sin 进度行」）。纯前端，绑定面 717 零变更。**落地**：①SinCastPanel 生成期 1s 轮询 getComfyUITaskProgress（与编辑器同源快照），chips 下方进度行「当前节点中文名 · 已用时」/「排队中（前有任务）」（复用 COMFY_NODE_LABELS，后端 class_type 契约不变）+行尾「取消」钮→cancelImageGeneration()（设定卡链 v4.407 起全局可取消，sin 侧复用同一 Go 链自动获得；读失败按无进度处理不阻断）②handleCastSheet 的 context canceled 语义化「已取消生成」info（对齐编辑器先例）。**测试**=SinCastPanel 3→6 例（进度行出现+取消调用+结束消失/排队文案/读取失败不渲染不阻断+既有回归补默认空快照防瞬时轮询拿 undefined）；全量 ci 绿（首轮 vitest ProgrammingPage 1 例负载 flaky 隔离单跑 12/12 绿+全量复跑 CI OK 在案，与本刀零交集）。**产物**=exe 51312640B SHA256=7ca44f8370baa6520b9faff73fd2bcab83053ca44677721f0e16a198c8487af3（SUMS-v4.408.0.txt；冒烟 200 过；桌面副本同哈希）；保留策略删 v4.401.0.exe。**文档**=规格 进度计划/gaea-sin-cast-progress-cancel-20260925.md+releases/v4.408.0.md+CHANGELOG/README+releases/README（431→432+裁 v4.376）+AGENTS 迁 1 插 1（一百二十五迁：v4.404.1 入 archive）+progress/todos（观察池=评分 LLM 流式/iGPU 压力预检/sin 评分入口）。
- **最新发布：v4.409.0（2026-09-25）「图像生成内存压力预检（iGPU 冷载预期管理）」**——观察池在册项（v4.404.1 起四版）。Go 1 文件+3 挂点+前端 1 util+App 全局订阅，绑定面 717 零变更。**落地**：①imageGenPressureNote 纯函数（可用 < 总量 15% 或 < 4GB 命中，文案如实设预期）+readSystemMemoryMB 复用既有 getMemoryStats 原生采集+noteImageGenMemoryPressure（命中→WARN+emit imagegen:pressure；读不到静默跳过；只提示不拦截）②挂点仅 comfyui：绘梦两口+attachComfyProgress（剧照/设定卡共用）③前端 2 分钟节流+App 全局订阅一次（subscribeWailsEvent 纪律），绘梦/角色库/sin 全覆盖不刷屏。**测试**=Go 阈值六态+真机读数合理性+接线三态（seam+httpbridge SSE 捕获）；前端 3 例；全量 ci 绿（首轮 ci vitest 偶发挂，独立全前端 397 文件全绿+全量复跑 CI OK 在案，负载 flaky 家族与本刀零交集）。**坑**=x/sys/windows 未导出 GlobalMemoryStatusEx——image_handler 既有原生采集直接复用，勿另起 build-tag 文件重声明（procGlobalMemoryStatusEx 重 declaration 编译炸才现形）；httpbridge SSE 帧首行只有 {"id":...}，payload 在后续 data: 行——断言须累积读帧。**产物**=exe 51314688B SHA256=78d92741b5b34a83b416384e323588baf0aa668ba9643d29e6c523ad7dd2d803（SUMS-v4.409.0.txt；冒烟 200 过；桌面副本同哈希）；保留策略删 v4.404.1.exe。**文档**=规格 进度计划/gaea-imagegen-pressure-20260925.md+releases/v4.409.0.md+CHANGELOG/README+releases/README（432→433+裁 v4.377）+AGENTS 迁 1 插 1（一百二十六迁：v4.405.0 入 archive）+progress/todos（观察池=评分 LLM 流式/sin 评分入口）。
- **最新发布：v4.410.0（2026-09-25）「sin 评分入口 v1（快路径）+ 评分流式辨伪关账」**——观察池末两项收官，等待体验/一致性线程池清账。纯前端，绑定面 717 零变更。**落地**：①chip「评分」钮（AimOutlined）评角色最新参考图（handleCastScore：getCharacter→末张→scoreCharacterConsistency→编辑器同款 Modal；无参考图如实指路；逐张评分留编辑器）②scoreId 与 genId 单飞互斥（视觉模型与 ComfyUI 同 GPU），未传 prop 不渲染③评分流式辨伪缓办（JSON 契约流式无增益/spinner+90s 上限已覆盖等待语义/churn 大，重开条件=图vs图 V2 长评）。**测试**=SinCastPanel 9→12 例（互斥双向在案）；全量 ci 绿。**产物**=exe 51315712B SHA256=f7f08a2ff3adeaeb4bd9e34a65da7be82f825df8750b1c7b5d57898732204140（SUMS-v4.410.0.txt；冒烟 200 过；桌面副本同哈希）；保留策略删 v4.405.1.exe。**文档**=规格 进度计划/gaea-sin-score-entry-20260925.md+releases/v4.410.0.md+CHANGELOG/README+releases/README（433→434+裁 v4.378）+AGENTS 迁 1 插 1（一百二十七迁：v4.405.1 入 archive）+progress/todos（线程观察池全部关账）。
