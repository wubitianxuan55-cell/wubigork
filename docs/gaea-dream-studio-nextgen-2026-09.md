...
> 状态（2026-09-08 核对）：**外部材料汇编 + 下一代草案**，供图像域/绘梦刀路取用；
> 本文不承诺版本，落地以 `docs/gaea-image-domain-longterm-plan-2026.md` T 系与
> `releases/` 为准（其 T0 契约已随 v4.98.0 落地；§0.5 定位修订已被 longterm-plan
> 吸收为 v1.1）。
