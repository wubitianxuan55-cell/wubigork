...
| 冷启动/常驻内存 | 未采 | Go 同步链 43–110ms（09-24/25 十二次自然启动样本，中位 ~62ms；大头 charlib+stores 40–47ms）；**前端 gaea:interactive=497ms**（v4.413.0 壳 CDP 实测，gaea:boot 91ms→interactive 588ms，DCL 139ms）；**常驻内存（闲置态）WS=223MB/Private=235MB**（v4.413.0 壳 2026-09-26 实测） | — | 全采齐；季度复测时按同口径重测 |
