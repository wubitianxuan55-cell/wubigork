...
为词汇表唯一真源，引擎实现 `measurable` 子集）。T2 内核消费已落（v4.286.0）；T4 篇幅路由与骨架聚合已落（v4.288.0，三档：短篇章级/中篇 10 章聚合/长篇 30 章聚合，阈值常量在 internal/bookimport/skeleton.go）。下刀候选：T5 子代理角色卡资产 / T6 风格档案协议。
