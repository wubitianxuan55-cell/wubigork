...
> 最后更新: 2026-09-19（v4.344.0 t7 最终形态：编辑器持久标注高亮——annotations 驱动全量 mark 常驻，dirty 编辑退场，分段工具收敛 annotationMarks.ts；零新绑定 705。前次：真机走查班全绿；v4.343.0 定位镜像轻量版。本表只留**仍开放**项）
