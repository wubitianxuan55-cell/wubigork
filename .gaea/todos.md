...
> 最后更新: 2026-09-16（v4.322.0 t4-C3 收官：场景工程整章重写——单场景替换+复用 rebuildScenesFromBlob，t4-C3 余项全清，零新绑定 696。本表只留**仍开放**项；已完成历史见 .gaea/AGENTS.md 版本速览与 progress.md）
