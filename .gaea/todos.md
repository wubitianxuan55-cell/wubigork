...
> 最后更新: 2026-09-21（v4.367.0 编辑输入性能：ChapterEditor memo+上报防抖+设定页预览/字数防抖——性能八项再消两目余四项见「前端·性能」行。前次：v4.366.0 性能轮收官。本表只留**仍开放**项）
