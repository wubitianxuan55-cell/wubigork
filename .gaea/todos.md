...
> 最后更新: 2026-09-16（v4.324.0 t6-C2 模板包导入导出——content_hash 三态+导入真校验+双门落盘，绑定面 701→703。本表只留**仍开放**项；已完成历史见 .gaea/AGENTS.md 版本速览与 progress.md）
