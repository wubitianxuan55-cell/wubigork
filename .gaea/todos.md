...
> 最后更新: 2026-09-16（v4.323.0 t6 提示词工坊首刀：模板可编辑覆盖层——promptstore+{{name}} 渲染+三级解析+五绑定+工坊面板，绑定面 696→701。本表只留**仍开放**项；已完成历史见 .gaea/AGENTS.md 版本速览与 progress.md）
