...
> 最后更新: 2026-09-19（v4.347.0 GLM-5.3-FlashX 接入模型中心 GLM 静态目录〔1M/128K·caps 同 Flash·国内绝对价 2/7 元/M·coding 套餐暂未开放不配积分别名〕+Flash 补官方绝对价 0.8/2.8 元/M〔估算 USD 近似口径作废〕。前次：v4.346.0 UI 健壮性双修。本表只留**仍开放**项）
