...
> 最后更新: 2026-09-21（v4.366.0 性能轮收官：聊天组件 memo 化专项+StoryStream 行级 memo——性能八项消两项余六项见「前端·性能」行。前次：v4.365.0 前端性能轮。本表只留**仍开放**项）
