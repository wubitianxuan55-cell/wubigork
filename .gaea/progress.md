...
> 最后更新: 2026-09-05（v4.82.0「上下文趋势跳转浏览器：brief 行锚点 ·
...
- **蒸馏规划滚动中**：1a（v4.78）、2.5a（v4.79）、2.5b 前半（v4.80）、
  2.5c（v4.81）、2.5d（v4.82）已完成；1b 勘误销账。**下一刀候选**：
  2.5b 后半（图片缩略卡 + 图片 token 估算——Anthropic 官方公式
  ⌈w/28⌉×⌈h/28⌉ 已核实，见 docs/research-2026-09-05/context-observability.md）、
  1c（HTML 沙箱预览 + 外链协议分流）、2b/2c Git 面板与统一 diff（需拍板）。
