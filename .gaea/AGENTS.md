...
- **近期三版一行账**：v4.153.0 双工期刀4（mspdi DurationFormat 8 互通，真机池待走查）· v4.152.0 双工期刀3（板块 UI：单位 chip+拖拽自然日回写+等效透明）· v4.151.0 双工期刀2（agent 通道，golden 61 例对拍）——**双工期四刀全收官，拍板池三项全部收官**；观察池=刀4 真机 Project/WPS/斑马走查、E1 负数对称（动逆推才收口）、list_projects 真机。
