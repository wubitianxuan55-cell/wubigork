...
- **下会话待办（2026-09-05 收档，详见 progress.md「下会话续做」）**：
  **蒸馏规划阶段一、二.5 与二 2a 全部收口**（1a/1c/2.5a/2.5b 前后半/2.5c/
  2.5d/2a = v4.78~v4.85），下一刀候选：2b/2c Git 面板（拍板）、2.5e
  /context 弹层（拍板，可与「剩余上下文 % 常驻徽标」合并）；中期候选
  （成本费率 hover/终止级联/失败子代理可恢复）见
  docs/market-research-2026-09-05.md。本会话另落 GitHub 市场调研三路
...
- **最新发布：v4.85.0（2026-09-05）「本轮文件三态折叠：写入/编辑/读取
