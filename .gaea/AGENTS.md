...
- **近期三版一行账**：v4.151.0 双工期刀2（agent 通道：ops durationUnit+cdTasks+技能条款，golden 61 例对拍）· v4.150.0 双工期口径刀1（durationUnit 模型+引擎，TS↔Go 镜像）· v4.149.0 ops 投影+Go/TS 对拍收官（刀D）——拍板池三项全部启动或收官，余欠账=双工期刀3 板块 UI 与刀4 mspdi。
